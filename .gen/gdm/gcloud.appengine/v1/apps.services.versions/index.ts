...
export class AppsServicesVersions
	extends GdmResource<AppsServicesVersionsComponentInputs>
	implements AppsServicesVersionsComponentOutputs
{
	constructor(entity: ADKEntity, options: AppsServicesVersionsComponentInputs) {
		super(entity, options.name, "appengine.v1.AppsServicesVersions", options);
	}
}
export interface AppsServicesVersionsComponentOutputs {}
export interface AppsServicesVersionsComponentInputs {
...
export default {
	AppsServicesVersions: AppsServicesVersions,
};
