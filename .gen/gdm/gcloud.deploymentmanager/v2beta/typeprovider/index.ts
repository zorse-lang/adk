...
export class TypeProvider extends GdmResource<TypeProviderComponentInputs> implements TypeProviderComponentOutputs {
	constructor(entity: ADKEntity, options: TypeProviderComponentInputs) {
		super(entity, options.name, "deploymentmanager.v2beta.typeProvider", options);
	}
...
export interface TypeProviderComponentOutputs {
	readonly id?: string;
	readonly insertTime?: string;
	readonly operation?: Operation;
	readonly selfLink?: string;
}
export interface TypeProviderComponentInputs {
