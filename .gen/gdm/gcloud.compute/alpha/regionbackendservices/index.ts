...
export class RegionBackendServices
	extends GdmResource<RegionBackendServicesComponentInputs>
	implements RegionBackendServicesComponentOutputs
{
	constructor(entity: ADKEntity, options: RegionBackendServicesComponentInputs) {
		super(entity, options.name, "compute.alpha.RegionBackendServices", options);
	}
