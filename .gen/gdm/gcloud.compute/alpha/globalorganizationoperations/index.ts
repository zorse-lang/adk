...
export class GlobalOrganizationOperations
	extends GdmResource<GlobalOrganizationOperationsComponentInputs>
	implements GlobalOrganizationOperationsComponentOutputs
{
	constructor(entity: ADKEntity, options: GlobalOrganizationOperationsComponentInputs) {
		super(entity, options.name, "compute.alpha.GlobalOrganizationOperations", options);
	}
...
export interface GlobalOrganizationOperationsComponentOutputs {
...
export interface GlobalOrganizationOperationsComponentInputs {
