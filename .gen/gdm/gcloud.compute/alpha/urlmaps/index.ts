...
export class UrlMaps extends GdmResource<UrlMapsComponentInputs> implements UrlMapsComponentOutputs {
	constructor(entity: ADKEntity, options: UrlMapsComponentInputs) {
		super(entity, options.name, "compute.alpha.UrlMaps", options);
	}
...
export interface UrlMapsComponentOutputs {
...
export interface UrlMapsComponentInputs {
	readonly defaultCustomErrorResponsePolicy?: CustomErrorResponsePolicy | undefined;
...
export interface CustomErrorResponsePolicy {
	readonly errorResponseRules?: CustomErrorResponsePolicyCustomErrorResponseRule[] | undefined;
	readonly errorService?: string | undefined;
}
export interface CustomErrorResponsePolicyCustomErrorResponseRule {
	readonly matchResponseCodes?: string[] | undefined;
	readonly overrideResponseCode?: number | undefined;
...
export interface HttpFilterConfig {
	...
	readonly configTypeUrl?: string | undefined;
...
export interface HttpRouteRule {
	readonly customErrorResponsePolicy?: CustomErrorResponsePolicy | undefined;
	readonly description?: string | undefined;
	readonly headerAction?: HttpHeaderAction | undefined;
	readonly httpFilterConfigs?: HttpFilterConfig[] | undefined;
	readonly httpFilterMetadata?: HttpFilterConfig[] | undefined;
...
export interface HttpRouteRuleMatch {
	...
	readonly pathTemplateMatch?: string | undefined;
	readonly prefixMatch?: string | undefined;
...
export interface UrlRewrite {
	...
	readonly pathTemplateRewrite?: string | undefined;
}
