...
export interface UrlMapsComponentInputs {
	readonly defaultCustomErrorResponsePolicy?: CustomErrorResponsePolicy;
...
export interface CustomErrorResponsePolicy {
	readonly errorResponseRules?: CustomErrorResponsePolicyCustomErrorResponseRule[];
...
export interface HttpRouteRule {
	readonly customErrorResponsePolicy?: CustomErrorResponsePolicy;
	readonly description?: string;
	readonly headerAction?: HttpHeaderAction;
