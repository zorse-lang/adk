...
export class RegionInstanceGroupManagers
	extends GdmResource<RegionInstanceGroupManagersComponentInputs>
	implements RegionInstanceGroupManagersComponentOutputs
{
	constructor(entity: ADKEntity, options: RegionInstanceGroupManagersComponentInputs) {
		super(entity, options.name, "compute.alpha.RegionInstanceGroupManagers", options);
	}
...
export interface RegionInstanceGroupManagersComponentOutputs {
...
export interface RegionInstanceGroupManagersComponentInputs {
