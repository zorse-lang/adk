...
export class BackendService extends GdmResource<BackendServiceComponentInputs> implements BackendServiceComponentOutputs {
	constructor(entity: ADKEntity, options: BackendServiceComponentInputs) {
		super(entity, options.name, "compute.alpha.backendService", options);
	}
...
export interface BackendServiceComponentOutputs {
...
export interface BackendServiceComponentInputs {
