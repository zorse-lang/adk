...
export class RegionOperations
	extends GdmResource<RegionOperationsComponentInputs>
	implements RegionOperationsComponentOutputs
{
	constructor(entity: ADKEntity, options: RegionOperationsComponentInputs) {
		super(entity, options.name, "compute.alpha.RegionOperations", options);
	}
...
export interface RegionOperationsComponentOutputs {
...
export interface RegionOperationsComponentInputs {
