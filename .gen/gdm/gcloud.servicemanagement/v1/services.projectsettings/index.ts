...
export class ServicesProjectSettings
	extends GdmResource<ServicesProjectSettingsComponentInputs>
	implements ServicesProjectSettingsComponentOutputs
{
	constructor(entity: ADKEntity, options: ServicesProjectSettingsComponentInputs) {
		super(entity, options.name, "servicemanagement.v1.ServicesProjectSettings", options);
	}
}
export interface ServicesProjectSettingsComponentOutputs {}
export interface ServicesProjectSettingsComponentInputs {
...
export default {
	ServicesProjectSettings: ServicesProjectSettings,
};
