...
export class ProjectsSinks extends GdmResource<ProjectsSinksComponentInputs> implements ProjectsSinksComponentOutputs {
	constructor(entity: ADKEntity, options: ProjectsSinksComponentInputs) {
		super(entity, options.name, "logging.v2.ProjectsSinks", options);
	}
...
export interface ProjectsSinksComponentOutputs {
	readonly createTime?: string;
	readonly deleteTime?: string;
	readonly updateTime?: string;
	readonly writerIdentity?: string;
}
export interface ProjectsSinksComponentInputs {
