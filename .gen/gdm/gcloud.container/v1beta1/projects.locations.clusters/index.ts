...
export class ProjectsLocationsClusters
	extends GdmResource<ProjectsLocationsClustersComponentInputs>
	implements ProjectsLocationsClustersComponentOutputs
{
	constructor(entity: ADKEntity, options: ProjectsLocationsClustersComponentInputs) {
		super(entity, options.name, "container.v1beta1.ProjectsLocationsClusters", options);
	}
...
export interface ProjectsLocationsClustersComponentOutputs {
...
export interface ProjectsLocationsClustersComponentInputs {
...
export default {
	ProjectsLocationsClusters: ProjectsLocationsClusters,
};
