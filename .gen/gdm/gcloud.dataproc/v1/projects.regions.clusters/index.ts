...
export class ProjectsRegionsClusters
	extends GdmResource<ProjectsRegionsClustersComponentInputs>
	implements ProjectsRegionsClustersComponentOutputs
{
	constructor(entity: ADKEntity, options: ProjectsRegionsClustersComponentInputs) {
		super(entity, options.name, "dataproc.v1.ProjectsRegionsClusters", options);
	}
...
export interface ProjectsRegionsClustersComponentOutputs {
...
export interface ProjectsRegionsClustersComponentInputs {
	readonly actionOnFailedPrimaryWorkers?: string | undefined;
...
export default {
	ProjectsRegionsClusters: ProjectsRegionsClusters,
};
