...
export class labs extends ArmResource<labsComponentInputs> implements labsComponentOutputs {
	constructor(entity: ADKEntity, options: labsComponentInputs) {
		super(entity, options.name, "Microsoft.DevTestLab/labs", "2018-09-15", options);
	}
	public readonly apiVersion: "2018-09-15";
	public readonly id: string;
	public readonly type: "Microsoft.DevTestLab/labs";
}
export interface labsComponentOutputs {
	readonly apiVersion: "2018-09-15";
	readonly id: string;
	...
	implements labs_artifactsourcesComponentOutputs
{
	constructor(entity: ADKEntity, options: labs_artifactsourcesComponentInputs) {
		super(entity, options.name, "Microsoft.DevTestLab/labs/artifactsources", "2018-09-15", options);
	}
	public readonly apiVersion: "2018-09-15";
	public readonly id: string;
	...
	implements labs_artifactsources_armtemplatesComponentOutputs
{
	constructor(entity: ADKEntity, options: labs_artifactsources_armtemplatesComponentInputs) {
		super(entity, options.name, "Microsoft.DevTestLab/labs/artifactsources/armtemplates", "2018-09-15", options);
	}
	public readonly apiVersion: "2018-09-15";
	public readonly id: string;
	...
	implements labs_artifactsources_artifactsComponentOutputs
{
	constructor(entity: ADKEntity, options: labs_artifactsources_artifactsComponentInputs) {
		super(entity, options.name, "Microsoft.DevTestLab/labs/artifactsources/artifacts", "2018-09-15", options);
	}
	public readonly apiVersion: "2018-09-15";
	public readonly id: string;
...
export class labs_costs extends ArmResource<labs_costsComponentInputs> implements labs_costsComponentOutputs {
	constructor(entity: ADKEntity, options: labs_costsComponentInputs) {
		super(entity, options.name, "Microsoft.DevTestLab/labs/costs", "2018-09-15", options);
	}
	public readonly apiVersion: "2018-09-15";
	public readonly id: string;
	...
	implements labs_customimagesComponentOutputs
{
	constructor(entity: ADKEntity, options: labs_customimagesComponentInputs) {
		super(entity, options.name, "Microsoft.DevTestLab/labs/customimages", "2018-09-15", options);
	}
	public readonly apiVersion: "2018-09-15";
	public readonly id: string;
...
export class labs_formulas extends ArmResource<labs_formulasComponentInputs> implements labs_formulasComponentOutputs {
	constructor(entity: ADKEntity, options: labs_formulasComponentInputs) {
		super(entity, options.name, "Microsoft.DevTestLab/labs/formulas", "2018-09-15", options);
	}
	public readonly apiVersion: "2018-09-15";
	public readonly id: string;
	...
	implements labs_notificationchannelsComponentOutputs
{
	constructor(entity: ADKEntity, options: labs_notificationchannelsComponentInputs) {
		super(entity, options.name, "Microsoft.DevTestLab/labs/notificationchannels", "2018-09-15", options);
	}
	public readonly apiVersion: "2018-09-15";
	public readonly id: string;
	...
	implements labs_policysets_policiesComponentOutputs
{
	constructor(entity: ADKEntity, options: labs_policysets_policiesComponentInputs) {
		super(entity, options.name, "Microsoft.DevTestLab/labs/policysets/policies", "2018-09-15", options);
	}
	public readonly apiVersion: "2018-09-15";
	public readonly id: string;
...
export class labs_schedules extends ArmResource<labs_schedulesComponentInputs> implements labs_schedulesComponentOutputs {
	constructor(entity: ADKEntity, options: labs_schedulesComponentInputs) {
		super(entity, options.name, "Microsoft.DevTestLab/labs/schedules", "2018-09-15", options);
	}
	public readonly apiVersion: "2018-09-15";
	public readonly id: string;
	...
	implements labs_servicerunnersComponentOutputs
{
	constructor(entity: ADKEntity, options: labs_servicerunnersComponentInputs) {
		super(entity, options.name, "Microsoft.DevTestLab/labs/servicerunners", "2018-09-15", options);
	}
	public readonly apiVersion: "2018-09-15";
	public readonly id: string;
...
export class labs_users extends ArmResource<labs_usersComponentInputs> implements labs_usersComponentOutputs {
	constructor(entity: ADKEntity, options: labs_usersComponentInputs) {
		super(entity, options.name, "Microsoft.DevTestLab/labs/users", "2018-09-15", options);
	}
	public readonly apiVersion: "2018-09-15";
	public readonly id: string;
	...
	implements labs_users_disksComponentOutputs
{
	constructor(entity: ADKEntity, options: labs_users_disksComponentInputs) {
		super(entity, options.name, "Microsoft.DevTestLab/labs/users/disks", "2018-09-15", options);
	}
	public readonly apiVersion: "2018-09-15";
	public readonly id: string;
	...
	implements labs_users_environmentsComponentOutputs
{
	constructor(entity: ADKEntity, options: labs_users_environmentsComponentInputs) {
		super(entity, options.name, "Microsoft.DevTestLab/labs/users/environments", "2018-09-15", options);
	}
	public readonly apiVersion: "2018-09-15";
	public readonly id: string;
	...
	implements labs_users_secretsComponentOutputs
{
	constructor(entity: ADKEntity, options: labs_users_secretsComponentInputs) {
		super(entity, options.name, "Microsoft.DevTestLab/labs/users/secrets", "2018-09-15", options);
	}
	public readonly apiVersion: "2018-09-15";
	public readonly id: string;
...
export class labs_users_servicefabrics
	extends ArmResource<labs_users_servicefabricsComponentInputs>
	implements labs_users_servicefabricsComponentOutputs
{
	constructor(entity: ADKEntity, options: labs_users_servicefabricsComponentInputs) {
		super(entity, options.name, "Microsoft.DevTestLab/labs/users/servicefabrics", "2018-09-15", options);
	}
	public readonly apiVersion: "2018-09-15";
	public readonly id: string;
	public readonly type: "Microsoft.DevTestLab/labs/users/servicefabrics";
}
export interface labs_users_servicefabricsComponentOutputs {
	readonly apiVersion: "2018-09-15";
	readonly id: string;
	readonly type: "Microsoft.DevTestLab/labs/users/servicefabrics";
}
export interface labs_users_servicefabricsComponentInputs {
	readonly location?: string | undefined;
	readonly name: string;
	readonly properties: ServiceFabricProperties;
	readonly tags?: ResourceTags | undefined;
}
export class labs_users_servicefabrics_schedules
	extends ArmResource<labs_users_servicefabrics_schedulesComponentInputs>
	implements labs_users_servicefabrics_schedulesComponentOutputs
{
	constructor(entity: ADKEntity, options: labs_users_servicefabrics_schedulesComponentInputs) {
		super(entity, options.name, "Microsoft.DevTestLab/labs/users/servicefabrics/schedules", "2018-09-15", options);
	}
	public readonly apiVersion: "2018-09-15";
	public readonly id: string;
	public readonly type: "Microsoft.DevTestLab/labs/users/servicefabrics/schedules";
}
export interface labs_users_servicefabrics_schedulesComponentOutputs {
	readonly apiVersion: "2018-09-15";
	readonly id: string;
	readonly type: "Microsoft.DevTestLab/labs/users/servicefabrics/schedules";
}
export interface labs_users_servicefabrics_schedulesComponentInputs {
	readonly location?: string | undefined;
	readonly name: string;
	readonly properties: ScheduleProperties;
	readonly tags?: ResourceTags | undefined;
	...
	implements labs_virtualmachinesComponentOutputs
{
	constructor(entity: ADKEntity, options: labs_virtualmachinesComponentInputs) {
		super(entity, options.name, "Microsoft.DevTestLab/labs/virtualmachines", "2018-09-15", options);
	}
	public readonly apiVersion: "2018-09-15";
	public readonly id: string;
	...
	implements labs_virtualmachines_schedulesComponentOutputs
{
	constructor(entity: ADKEntity, options: labs_virtualmachines_schedulesComponentInputs) {
		super(entity, options.name, "Microsoft.DevTestLab/labs/virtualmachines/schedules", "2018-09-15", options);
	}
	public readonly apiVersion: "2018-09-15";
	public readonly id: string;
	...
	implements labs_virtualnetworksComponentOutputs
{
	constructor(entity: ADKEntity, options: labs_virtualnetworksComponentInputs) {
		super(entity, options.name, "Microsoft.DevTestLab/labs/virtualnetworks", "2018-09-15", options);
	}
	public readonly apiVersion: "2018-09-15";
	public readonly id: string;
...
export class schedules extends ArmResource<schedulesComponentInputs> implements schedulesComponentOutputs {
	constructor(entity: ADKEntity, options: schedulesComponentInputs) {
		super(entity, options.name, "Microsoft.DevTestLab/schedules", "2018-09-15", options);
	}
	public readonly apiVersion: "2018-09-15";
	public readonly id: string;
...
export function listApplicable(resource: labs_schedules): ScheduleList {
	if (resource.apiVersion !== "2018-09-15") {
...
export function listApplicableSchedules(resource: labs_users_servicefabrics): ApplicableSchedule {
	if (resource.apiVersion !== "2018-09-15") {
		throw new Error(`listApplicableSchedules is not available for api version ${resource.apiVersion}`);
	}
	if (resource.type !== "Microsoft.DevTestLab/labs/users/servicefabrics") {
		throw new Error(`listApplicableSchedules is not available for resource type ${resource.type}`);
	}
	throw new Error("not implemented");
}
export function listVhds(resource: labs): LabVhdList {
	if (resource.apiVersion !== "2018-09-15") {
...
export interface ArtifactInstallProperties {
	...
	readonly artifactTitle?: string | undefined;
...
export interface ArtifactSourceProperties {
	...
	readonly sourceType?: ("GitHub" | "StorageAccount" | "VsoGit") | undefined;
...
export interface AttachNewDataDiskOptions {
	...
	readonly diskType?: ("Premium" | "Standard" | "StandardSSD") | undefined;
}
...
export interface CustomImageProperties {
	...
	readonly customImagePlan?: CustomImagePropertiesFromPlan | undefined;
	readonly dataDiskStorageInfo?: DataDiskStorageTypeInfo[] | undefined;
	readonly description?: string | undefined;
	readonly isPlanAuthorized?: boolean | undefined;
	readonly managedImageId?: string | undefined;
	readonly managedSnapshotId?: string | undefined;
	readonly provisioningState?: string | undefined;
	readonly uniqueIdentifier?: string | undefined;
...
export interface DataDiskProperties {
	readonly attachNewDataDiskOptions?: AttachNewDataDiskOptions | undefined;
	readonly existingLabDiskId?: string | undefined;
	readonly hostCaching?: ("None" | "ReadOnly" | "ReadWrite") | undefined;
}
export interface DataDiskStorageTypeInfo {
	readonly lun?: string | undefined;
	readonly storageType?: ("Premium" | "Standard" | "StandardSSD") | undefined;
}
...
export interface LabProperties {
	readonly announcement?: LabAnnouncementProperties | undefined;
	...
	readonly environmentPermission?: ("Contributor" | "Reader") | undefined;
	readonly extendedProperties?: LabPropertiesExtendedProperties | undefined;
	readonly labStorageType?: ("Premium" | "Standard" | "StandardSSD") | undefined;
	readonly loadBalancerId?: string | undefined;
	readonly mandatoryArtifactsResourceIdsLinux?: string[] | undefined;
	readonly mandatoryArtifactsResourceIdsWindows?: string[] | undefined;
	...
	readonly support?: LabSupportProperties | undefined;
	readonly uniqueIdentifier?: string | undefined;
	readonly vaultName?: string | undefined;
	readonly vmCreationResourceGroup?: string | undefined;
}
...
export interface LabVirtualMachineCreationParameterProperties {
	...
	readonly dataDiskParameters?: DataDiskProperties[] | undefined;
	...
	readonly scheduleParameters?: ScheduleCreationParameter[] | undefined;
...
export interface LabVirtualMachineProperties {
	...
	readonly uniqueIdentifier?: string | undefined;
	readonly userName?: string | undefined;
	readonly virtualMachineCreationSource?:
...
export interface NotificationChannelProperties {
	readonly createdDate?: string | undefined;
	readonly description?: string | undefined;
	readonly emailRecipient?: string | undefined;
	readonly events?: Event[] | undefined;
	readonly notificationLocale?: string | undefined;
	readonly provisioningState?: string | undefined;
	readonly uniqueIdentifier?: string | undefined;
...
export interface ScheduleCreationParameter {
	readonly location?: string | undefined;
	readonly name?: string | undefined;
	readonly properties?: ScheduleCreationParameterProperties | undefined;
	readonly tags?: ScheduleCreationParameterTags | undefined;
}
...
export interface ServiceFabricProperties {
	readonly applicableSchedule?: ApplicableSchedule | undefined;
	readonly environmentId?: string | undefined;
	readonly externalServiceFabricId?: string | undefined;
	readonly provisioningState?: string | undefined;
	readonly uniqueIdentifier?: string | undefined;
}
...
export default {
	...
	"labs/users/servicefabrics": labs_users_servicefabrics,
	"labs/users/servicefabrics/schedules": labs_users_servicefabrics_schedules,
