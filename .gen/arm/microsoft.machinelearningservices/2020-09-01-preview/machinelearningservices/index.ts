...
export interface workspaces_linkedServicesComponentInputs {
	...
	readonly location?: string | undefined;
	readonly name: string;
	readonly properties?: LinkedServiceProps | undefined;
}
...
export interface LabelingDatasetConfiguration {
	...
	readonly enableIncrementalDatasetRefresh?: boolean | undefined;
}
export interface LabelingJobImageProperties {
	readonly annotationType?: ("BoundingBox" | "Classification" | "InstanceSegmentation") | undefined;
...
export interface LabelingJobProperties {
	...
	readonly tags?: LabelingJobPropertiesTags | undefined;
}
...
export interface LinkedServiceProps {
	...
	readonly linkType?: "Synapse" | undefined;
...
export interface MLAssistConfiguration {
	...
	readonly prelabelAccuracyThreshold?: number | undefined;
