	...
	implements accessReviewScheduleSettingsComponentOutputs
{
	constructor(entity: ADKEntity, options: accessReviewScheduleSettingsComponentInputs) {
		super(entity, options.name, "Microsoft.Authorization/accessReviewScheduleSettings", "2018-05-01-preview", options);
	}
	public readonly apiVersion: "2018-05-01-preview";
	public readonly id: string;
...
export interface AccessReviewDecisionProperties {
	...
	readonly target?: AccessReviewDecisionTarget | undefined;
}
