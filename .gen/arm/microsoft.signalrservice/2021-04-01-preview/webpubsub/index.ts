...
export class webPubSub extends ArmResource<webPubSubComponentInputs> implements webPubSubComponentOutputs {
	constructor(entity: ADKEntity, options: webPubSubComponentInputs) {
		super(entity, options.name, "Microsoft.SignalRService/webPubSub", "2021-04-01-preview", options);
	}
...
export interface WebPubSubFeature {
	readonly flag: "EnableConnectivityLogs" | "EnableLiveTrace" | "EnableMessagingLogs";
}
export interface WebPubSubFeatureProperties {
	readonly "[ key: string ]"?: string | undefined;
}
...
export interface WebPubSubProperties {
	...
	readonly features?: WebPubSubFeature[] | undefined;
}
