...
export interface DiagnosticConfiguration {
	readonly enableConnectivityLogs?: string;
	readonly enableLiveTrace?: string;
	readonly enableMessagingLogs?: string;
}
...
export interface WebPubSubProperties {
	readonly diagnosticConfiguration?: DiagnosticConfiguration;
