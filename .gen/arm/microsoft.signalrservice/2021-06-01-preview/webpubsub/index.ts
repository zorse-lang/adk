...
export class webPubSub extends ArmResource<webPubSubComponentInputs> implements webPubSubComponentOutputs {
	constructor(entity: ADKEntity, options: webPubSubComponentInputs) {
		super(entity, options.name, "Microsoft.SignalRService/webPubSub", "2021-06-01-preview", options);
	}
...
export interface DiagnosticConfiguration {
	readonly enableConnectivityLogs?: string | undefined;
	readonly enableLiveTrace?: string | undefined;
	readonly enableMessagingLogs?: string | undefined;
}
...
export interface WebPubSubProperties {
	readonly diagnosticConfiguration?: DiagnosticConfiguration | undefined;
