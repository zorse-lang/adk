	...
	implements sqlVirtualMachineGroupsComponentOutputs
{
	constructor(entity: ADKEntity, options: sqlVirtualMachineGroupsComponentInputs) {
		super(entity, options.name, "Microsoft.SqlVirtualMachine/sqlVirtualMachineGroups", "2022-02-01-preview", options);
	}
	...
	implements sqlVirtualMachinesComponentOutputs
{
	constructor(entity: ADKEntity, options: sqlVirtualMachinesComponentInputs) {
		super(entity, options.name, "Microsoft.SqlVirtualMachine/sqlVirtualMachines", "2022-02-01-preview", options);
	}
	public readonly apiVersion: "2022-02-01-preview";
	public readonly id: string;
