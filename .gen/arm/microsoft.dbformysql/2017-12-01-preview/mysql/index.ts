...
export class servers extends ArmResource<serversComponentInputs> implements serversComponentOutputs {
	constructor(entity: ADKEntity, options: serversComponentInputs) {
		super(entity, options.name, "Microsoft.DBforMySQL/servers", "2017-12-01-preview", options);
	}
	public readonly apiVersion: "2017-12-01-preview";
	public readonly id: string;
	public readonly type: "Microsoft.DBforMySQL/servers";
}
export interface serversComponentOutputs {
	readonly apiVersion: "2017-12-01-preview";
	readonly id: string;
	readonly type: "Microsoft.DBforMySQL/servers";
}
	...
	implements servers_administratorsComponentOutputs
{
	constructor(entity: ADKEntity, options: servers_administratorsComponentInputs) {
		super(entity, options.name, "Microsoft.DBforMySQL/servers/administrators", "2017-12-01-preview", options);
	}
	public readonly apiVersion: "2017-12-01-preview";
	public readonly id: string;
	public readonly type: "Microsoft.DBforMySQL/servers/administrators";
}
export interface servers_administratorsComponentOutputs {
	readonly apiVersion: "2017-12-01-preview";
	readonly id: string;
	readonly type: "Microsoft.DBforMySQL/servers/administrators";
}
	...
	implements servers_configurationsComponentOutputs
{
	constructor(entity: ADKEntity, options: servers_configurationsComponentInputs) {
		super(entity, options.name, "Microsoft.DBforMySQL/servers/configurations", "2017-12-01-preview", options);
	}
	public readonly apiVersion: "2017-12-01-preview";
	public readonly id: string;
	public readonly type: "Microsoft.DBforMySQL/servers/configurations";
}
export interface servers_configurationsComponentOutputs {
	readonly apiVersion: "2017-12-01-preview";
	readonly id: string;
	readonly type: "Microsoft.DBforMySQL/servers/configurations";
}
	...
	implements servers_databasesComponentOutputs
{
	constructor(entity: ADKEntity, options: servers_databasesComponentInputs) {
		super(entity, options.name, "Microsoft.DBforMySQL/servers/databases", "2017-12-01-preview", options);
	}
	public readonly apiVersion: "2017-12-01-preview";
	public readonly id: string;
	public readonly type: "Microsoft.DBforMySQL/servers/databases";
}
export interface servers_databasesComponentOutputs {
	readonly apiVersion: "2017-12-01-preview";
	readonly id: string;
	readonly type: "Microsoft.DBforMySQL/servers/databases";
}
	...
	implements servers_firewallRulesComponentOutputs
{
	constructor(entity: ADKEntity, options: servers_firewallRulesComponentInputs) {
		super(entity, options.name, "Microsoft.DBforMySQL/servers/firewallRules", "2017-12-01-preview", options);
	}
	public readonly apiVersion: "2017-12-01-preview";
	public readonly id: string;
	public readonly type: "Microsoft.DBforMySQL/servers/firewallRules";
}
export interface servers_firewallRulesComponentOutputs {
	readonly apiVersion: "2017-12-01-preview";
	readonly id: string;
	readonly type: "Microsoft.DBforMySQL/servers/firewallRules";
}
	...
	implements servers_securityAlertPoliciesComponentOutputs
{
	constructor(entity: ADKEntity, options: servers_securityAlertPoliciesComponentInputs) {
		super(entity, options.name, "Microsoft.DBforMySQL/servers/securityAlertPolicies", "2017-12-01-preview", options);
	}
	public readonly apiVersion: "2017-12-01-preview";
	public readonly id: string;
	public readonly type: "Microsoft.DBforMySQL/servers/securityAlertPolicies";
}
export interface servers_securityAlertPoliciesComponentOutputs {
	readonly apiVersion: "2017-12-01-preview";
	readonly id: string;
	readonly type: "Microsoft.DBforMySQL/servers/securityAlertPolicies";
}
	...
	implements servers_virtualNetworkRulesComponentOutputs
{
	constructor(entity: ADKEntity, options: servers_virtualNetworkRulesComponentInputs) {
		super(entity, options.name, "Microsoft.DBforMySQL/servers/virtualNetworkRules", "2017-12-01-preview", options);
	}
	public readonly apiVersion: "2017-12-01-preview";
	public readonly id: string;
	public readonly type: "Microsoft.DBforMySQL/servers/virtualNetworkRules";
}
export interface servers_virtualNetworkRulesComponentOutputs {
	readonly apiVersion: "2017-12-01-preview";
	readonly id: string;
	readonly type: "Microsoft.DBforMySQL/servers/virtualNetworkRules";
}
...
export interface ServerPropertiesForCreateOrServerProperties {
	...
	readonly version?: ("5.6" | "5.7" | "8.0") | undefined;
}
