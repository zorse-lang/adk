...
export class accessConnectors
	extends ArmResource<accessConnectorsComponentInputs>
	implements accessConnectorsComponentOutputs
{
	constructor(entity: ADKEntity, options: accessConnectorsComponentInputs) {
		super(entity, options.name, "Microsoft.Databricks/accessConnectors", "2022-04-01-preview", options);
	}
	public readonly apiVersion: "2022-04-01-preview";
	public readonly id: string;
	public readonly type: "Microsoft.Databricks/accessConnectors";
}
export interface accessConnectorsComponentOutputs {
	readonly apiVersion: "2022-04-01-preview";
	readonly id: string;
	readonly type: "Microsoft.Databricks/accessConnectors";
}
export interface accessConnectorsComponentInputs {
	readonly identity?: IdentityData | undefined;
	readonly location: string;
	readonly name: string;
	readonly properties?: AccessConnectorProperties | undefined;
...
export class workspaces extends ArmResource<workspacesComponentInputs> implements workspacesComponentOutputs {
	constructor(entity: ADKEntity, options: workspacesComponentInputs) {
		super(entity, options.name, "Microsoft.Databricks/workspaces", "2022-04-01-preview", options);
	}
	public readonly apiVersion: "2022-04-01-preview";
	public readonly id: string;
	...
	implements workspaces_privateLinkResourcesComponentOutputs
{
	constructor(entity: ADKEntity, options: workspaces_privateLinkResourcesComponentInputs) {
		super(entity, options.name, "Microsoft.Databricks/workspaces/privateLinkResources", "2022-04-01-preview", options);
	}
	public readonly apiVersion: "2022-04-01-preview";
	public readonly id: string;
...
export interface EncryptionEntitiesDefinition {
	readonly managedDisk?: ManagedDiskEncryption | undefined;
...
export interface WorkspaceProperties {
	...
	readonly managedDiskIdentity?: ManagedIdentityConfiguration | undefined;
