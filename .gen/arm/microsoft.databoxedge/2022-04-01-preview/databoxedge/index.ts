...
export interface CniConfig {
	readonly componentType?: "CNI" | "Cluster" | "Etcd" | "Invalid" | "LoadBalancer" | "Node";
...
export interface ComputeVersionInformation {
	readonly azureArcVersion?: string;
	readonly iotEdgeVersion?: string;
...
export interface DataBoxEdgeDeviceProperties {
	readonly computeVersionInformation?: ComputeVersionInformation;
...
export interface NodeInfo {
	...
	readonly name?: string;
	readonly type?: "ControlPlane" | "Invalid" | "ManagementCluster" | "Master" | "NodePool" | "Worker";
}
