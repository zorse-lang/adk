	...
	implements dataBoxEdgeDevicesComponentOutputs
{
	constructor(entity: ADKEntity, options: dataBoxEdgeDevicesComponentInputs) {
		super(entity, options.name, "Microsoft.DataBoxEdge/dataBoxEdgeDevices", "2022-03-01", options);
	}
	...
	implements dataBoxEdgeDevices_alertsComponentOutputs
{
	constructor(entity: ADKEntity, options: dataBoxEdgeDevices_alertsComponentInputs) {
		super(entity, options.name, "Microsoft.DataBoxEdge/dataBoxEdgeDevices/alerts", "2022-03-01", options);
	}
	public readonly apiVersion: "2022-03-01";
	public readonly id: string;
	...
	implements dataBoxEdgeDevices_bandwidthSchedulesComponentOutputs
{
	constructor(entity: ADKEntity, options: dataBoxEdgeDevices_bandwidthSchedulesComponentInputs) {
		super(entity, options.name, "Microsoft.DataBoxEdge/dataBoxEdgeDevices/bandwidthSchedules", "2022-03-01", options);
	}
	public readonly apiVersion: "2022-03-01";
	public readonly id: string;
	...
	implements dataBoxEdgeDevices_deviceCapacityInfoComponentOutputs
{
	constructor(entity: ADKEntity, options: dataBoxEdgeDevices_deviceCapacityInfoComponentInputs) {
		super(entity, options.name, "Microsoft.DataBoxEdge/dataBoxEdgeDevices/deviceCapacityInfo", "2022-03-01", options);
	}
	public readonly apiVersion: "2022-03-01";
	public readonly id: string;
...
export interface dataBoxEdgeDevices_deviceCapacityInfoComponentInputs {
	readonly name: string;
	readonly properties?: DeviceCapacityInfoProperties;
	readonly systemData?: SystemData;
}
	...
	implements dataBoxEdgeDevices_networkSettingsComponentOutputs
{
	constructor(entity: ADKEntity, options: dataBoxEdgeDevices_networkSettingsComponentInputs) {
		super(entity, options.name, "Microsoft.DataBoxEdge/dataBoxEdgeDevices/networkSettings", "2022-03-01", options);
	}
	public readonly apiVersion: "2022-03-01";
	public readonly id: string;
	...
	implements dataBoxEdgeDevices_ordersComponentOutputs
{
	constructor(entity: ADKEntity, options: dataBoxEdgeDevices_ordersComponentInputs) {
		super(entity, options.name, "Microsoft.DataBoxEdge/dataBoxEdgeDevices/orders", "2022-03-01", options);
	}
	public readonly apiVersion: "2022-03-01";
	public readonly id: string;
	...
	implements dataBoxEdgeDevices_roles_CloudEdgeManagementComponentOutputs
{
	constructor(entity: ADKEntity, options: dataBoxEdgeDevices_roles_CloudEdgeManagementComponentInputs) {
		super(entity, options.name, "Microsoft.DataBoxEdge/dataBoxEdgeDevices/roles", "2022-03-01", options);
	}
	public readonly apiVersion: "2022-03-01";
	public readonly id: string;
	...
	implements dataBoxEdgeDevices_roles_addons_ArcForKubernetesComponentOutputs
{
	constructor(entity: ADKEntity, options: dataBoxEdgeDevices_roles_addons_ArcForKubernetesComponentInputs) {
		super(entity, options.name, "Microsoft.DataBoxEdge/dataBoxEdgeDevices/roles/addons", "2022-03-01", options);
	}
	public readonly apiVersion: "2022-03-01";
	public readonly id: string;
	...
	implements dataBoxEdgeDevices_sharesComponentOutputs
{
	constructor(entity: ADKEntity, options: dataBoxEdgeDevices_sharesComponentInputs) {
		super(entity, options.name, "Microsoft.DataBoxEdge/dataBoxEdgeDevices/shares", "2022-03-01", options);
	}
	public readonly apiVersion: "2022-03-01";
	public readonly id: string;
	...
	implements dataBoxEdgeDevices_storageAccountsComponentOutputs
{
	constructor(entity: ADKEntity, options: dataBoxEdgeDevices_storageAccountsComponentInputs) {
		super(entity, options.name, "Microsoft.DataBoxEdge/dataBoxEdgeDevices/storageAccounts", "2022-03-01", options);
	}
	public readonly apiVersion: "2022-03-01";
	public readonly id: string;
	...
	implements dataBoxEdgeDevices_triggers_FileEventComponentOutputs
{
	constructor(entity: ADKEntity, options: dataBoxEdgeDevices_triggers_FileEventComponentInputs) {
		super(entity, options.name, "Microsoft.DataBoxEdge/dataBoxEdgeDevices/triggers", "2022-03-01", options);
	}
	public readonly apiVersion: "2022-03-01";
	public readonly id: string;
	...
	implements dataBoxEdgeDevices_updateSummaryComponentOutputs
{
	constructor(entity: ADKEntity, options: dataBoxEdgeDevices_updateSummaryComponentInputs) {
		super(entity, options.name, "Microsoft.DataBoxEdge/dataBoxEdgeDevices/updateSummary", "2022-03-01", options);
	}
	public readonly apiVersion: "2022-03-01";
	public readonly id: string;
	...
	implements dataBoxEdgeDevices_usersComponentOutputs
{
	constructor(entity: ADKEntity, options: dataBoxEdgeDevices_usersComponentInputs) {
		super(entity, options.name, "Microsoft.DataBoxEdge/dataBoxEdgeDevices/users", "2022-03-01", options);
	}
	public readonly apiVersion: "2022-03-01";
	public readonly id: string;
...
export interface ClusterCapacityViewData {
	...
	readonly gpuCapacity?: ClusterGpuCapacity;
	readonly lastRefreshedTime?: string;
	readonly memoryCapacity?: ClusterMemoryCapacity;
	readonly totalProvisionedNonHpnCores?: number;
}
export interface ClusterGpuCapacity {
	readonly gpuFreeUnitsCount?: number;
	readonly gpuReservedForFailoverUnitsCount?: number;
	readonly gpuTotalUnitsCount?: number;
	readonly gpuType?: string;
	readonly gpuUsedUnitsCount?: number;
}
export interface ClusterMemoryCapacity {
	readonly clusterFailoverMemoryMb?: number;
	readonly clusterFragmentationMemoryMb?: number;
	readonly clusterFreeMemoryMb?: number;
	readonly clusterHypervReserveMemoryMb?: number;
	readonly clusterInfraVmMemoryMb?: number;
	readonly clusterMemoryUsedByVmsMb?: number;
	readonly clusterNonFailoverVmMb?: number;
	readonly clusterTotalMemoryMb?: number;
	readonly clusterUsedMemoryMb?: number;
}
export interface ClusterStorageViewData {
	readonly clusterFreeStorageMb?: number;
	readonly clusterTotalStorageMb?: number;
}
...
export interface DeviceCapacityInfoProperties {
	readonly clusterComputeCapacityInfo?: ClusterCapacityViewData;
	readonly clusterStorageCapacityInfo?: ClusterStorageViewData;
	readonly nodeCapacityInfos?: DeviceCapacityInfoPropertiesNodeCapacityInfos;
	readonly timeStamp?: string;
}
export interface DeviceCapacityInfoPropertiesNodeCapacityInfos {
	readonly [key: string]: HostCapacity;
}
...
export interface HostCapacity {
	...
	readonly effectiveAvailableMemoryMbOnHost?: number;
	readonly gpuType?: string;
	readonly hostName?: string;
	readonly numaNodesData?: NumaNodeData[];
	readonly vmUsedMemory?: HostCapacityVmUsedMemory;
}
export interface HostCapacityVmUsedMemory {
	readonly [key: string]: VmMemory;
}
...
export interface NumaNodeData {
	readonly effectiveAvailableMemoryInMb?: number;
	readonly freeVCpuIndexesForHpn?: number[];
	readonly logicalCoreCountPerCore?: number;
	readonly numaNodeIndex?: number;
	readonly totalMemoryInMb?: number;
	readonly vCpuIndexesForHpn?: number[];
	readonly vCpuIndexesForRoot?: number[];
}
...
export interface UpdateDetails {
	readonly estimatedInstallTimeInMins?: number;
	readonly friendlyVersionNumber?: string;
	readonly installationImpact?: "DeviceRebooted" | "KubernetesWorkloadsDown" | "None";
	readonly rebootBehavior?: "NeverReboots" | "RequestReboot" | "RequiresReboot";
	readonly status?: "DownloadCompleted" | "DownloadPending" | "DownloadStarted" | "InstallCompleted" | "InstallStarted";
	readonly targetVersion?: string;
	readonly updateSize?: number;
	readonly updateTitle?: string;
	readonly updateType?: "Firmware" | "Kubernetes" | "Software";
}
export interface UpdateSummaryProperties {
	...
	readonly lastDownloadJobStatus?: "Canceled" | "Failed" | "Invalid" | "Paused" | "Running" | "Scheduled" | "Succeeded";
	readonly lastInstallJobStatus?: "Canceled" | "Failed" | "Invalid" | "Paused" | "Running" | "Scheduled" | "Succeeded";
	readonly lastSuccessfulInstallJobDateTime?: string;
	readonly lastSuccessfulScanJobTime?: string;
...
export interface VmMemory {
	readonly currentMemoryUsageMB?: number;
	readonly startupMemoryMB?: number;
}
