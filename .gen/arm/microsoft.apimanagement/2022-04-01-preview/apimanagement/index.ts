	...
	implements locations_deletedservicesComponentOutputs
{
	constructor(entity: ADKEntity, options: locations_deletedservicesComponentInputs) {
		super(entity, options.name, "Microsoft.ApiManagement/locations/deletedservices", "2022-04-01-preview", options);
	}
...
export class service extends ArmResource<serviceComponentInputs> implements serviceComponentOutputs {
	constructor(entity: ADKEntity, options: serviceComponentInputs) {
		super(entity, options.name, "Microsoft.ApiManagement/service", "2022-04-01-preview", options);
	}
	public readonly apiVersion: "2022-04-01-preview";
	public readonly id: string;
...
export class service_apis extends ArmResource<service_apisComponentInputs> implements service_apisComponentOutputs {
	constructor(entity: ADKEntity, options: service_apisComponentInputs) {
		super(entity, options.name, "Microsoft.ApiManagement/service/apis", "2022-04-01-preview", options);
	}
	public readonly apiVersion: "2022-04-01-preview";
	public readonly id: string;
	...
	implements service_apis_diagnosticsComponentOutputs
{
	constructor(entity: ADKEntity, options: service_apis_diagnosticsComponentInputs) {
		super(entity, options.name, "Microsoft.ApiManagement/service/apis/diagnostics", "2022-04-01-preview", options);
	}
	public readonly apiVersion: "2022-04-01-preview";
	public readonly id: string;
	...
	implements service_apis_issuesComponentOutputs
{
	constructor(entity: ADKEntity, options: service_apis_issuesComponentInputs) {
		super(entity, options.name, "Microsoft.ApiManagement/service/apis/issues", "2022-04-01-preview", options);
	}
	public readonly apiVersion: "2022-04-01-preview";
	public readonly id: string;
	...
	implements service_apis_issues_commentsComponentOutputs
{
	constructor(entity: ADKEntity, options: service_apis_issues_commentsComponentInputs) {
		super(entity, options.name, "Microsoft.ApiManagement/service/apis/issues/comments", "2022-04-01-preview", options);
	}
	public readonly apiVersion: "2022-04-01-preview";
	public readonly id: string;
	...
	implements service_apis_operationsComponentOutputs
{
	constructor(entity: ADKEntity, options: service_apis_operationsComponentInputs) {
		super(entity, options.name, "Microsoft.ApiManagement/service/apis/operations", "2022-04-01-preview", options);
	}
	public readonly apiVersion: "2022-04-01-preview";
	public readonly id: string;
	...
	implements service_apis_operations_tagsComponentOutputs
{
	constructor(entity: ADKEntity, options: service_apis_operations_tagsComponentInputs) {
		super(entity, options.name, "Microsoft.ApiManagement/service/apis/operations/tags", "2022-04-01-preview", options);
	}
	public readonly apiVersion: "2022-04-01-preview";
	public readonly id: string;
	...
	implements service_apis_policiesComponentOutputs
{
	constructor(entity: ADKEntity, options: service_apis_policiesComponentInputs) {
		super(entity, options.name, "Microsoft.ApiManagement/service/apis/policies", "2022-04-01-preview", options);
	}
	public readonly apiVersion: "2022-04-01-preview";
	public readonly id: string;
	...
	implements service_apis_releasesComponentOutputs
{
	constructor(entity: ADKEntity, options: service_apis_releasesComponentInputs) {
		super(entity, options.name, "Microsoft.ApiManagement/service/apis/releases", "2022-04-01-preview", options);
	}
	public readonly apiVersion: "2022-04-01-preview";
	public readonly id: string;
	...
	implements service_apis_schemasComponentOutputs
{
	constructor(entity: ADKEntity, options: service_apis_schemasComponentInputs) {
		super(entity, options.name, "Microsoft.ApiManagement/service/apis/schemas", "2022-04-01-preview", options);
	}
	public readonly apiVersion: "2022-04-01-preview";
	public readonly id: string;
	...
	implements service_apis_tagDescriptionsComponentOutputs
{
	constructor(entity: ADKEntity, options: service_apis_tagDescriptionsComponentInputs) {
		super(entity, options.name, "Microsoft.ApiManagement/service/apis/tagDescriptions", "2022-04-01-preview", options);
	}
	public readonly apiVersion: "2022-04-01-preview";
	public readonly id: string;
	...
	implements service_apis_tagsComponentOutputs
{
	constructor(entity: ADKEntity, options: service_apis_tagsComponentInputs) {
		super(entity, options.name, "Microsoft.ApiManagement/service/apis/tags", "2022-04-01-preview", options);
	}
	public readonly apiVersion: "2022-04-01-preview";
	public readonly id: string;
	...
	implements service_apiVersionSetsComponentOutputs
{
	constructor(entity: ADKEntity, options: service_apiVersionSetsComponentInputs) {
		super(entity, options.name, "Microsoft.ApiManagement/service/apiVersionSets", "2022-04-01-preview", options);
	}
	public readonly apiVersion: "2022-04-01-preview";
	public readonly id: string;
...
export class service_authorizationProviders
	extends ArmResource<service_authorizationProvidersComponentInputs>
	implements service_authorizationProvidersComponentOutputs
{
	constructor(entity: ADKEntity, options: service_authorizationProvidersComponentInputs) {
		super(
			entity,
			options.name,
	...
	public readonly apiVersion: "2022-04-01-preview";
	public readonly id: string;
	public readonly type: "Microsoft.ApiManagement/service/authorizationProviders";
}
export interface service_authorizationProvidersComponentOutputs {
	readonly apiVersion: "2022-04-01-preview";
	readonly id: string;
	readonly type: "Microsoft.ApiManagement/service/authorizationProviders";
}
export interface service_authorizationProvidersComponentInputs {
	readonly name: string;
	readonly properties?: AuthorizationProviderContractProperties | undefined;
}
export class service_authorizationProviders_authorizations
	extends ArmResource<service_authorizationProviders_authorizationsComponentInputs>
	implements service_authorizationProviders_authorizationsComponentOutputs
{
	constructor(entity: ADKEntity, options: service_authorizationProviders_authorizationsComponentInputs) {
		super(
			entity,
			options.name,
	...
	public readonly apiVersion: "2022-04-01-preview";
	public readonly id: string;
	public readonly type: "Microsoft.ApiManagement/service/authorizationProviders/authorizations";
}
export interface service_authorizationProviders_authorizationsComponentOutputs {
	readonly apiVersion: "2022-04-01-preview";
	readonly id: string;
	readonly type: "Microsoft.ApiManagement/service/authorizationProviders/authorizations";
}
export interface service_authorizationProviders_authorizationsComponentInputs {
	readonly name: string;
	readonly properties?: AuthorizationContractProperties | undefined;
}
export class service_authorizationProviders_authorizations_accessPolicies
	extends ArmResource<service_authorizationProviders_authorizations_accessPoliciesComponentInputs>
	implements service_authorizationProviders_authorizations_accessPoliciesComponentOutputs
{
	constructor(entity: ADKEntity, options: service_authorizationProviders_authorizations_accessPoliciesComponentInputs) {
		super(
			entity,
			options.name,
	...
	public readonly apiVersion: "2022-04-01-preview";
	public readonly id: string;
	public readonly type: "Microsoft.ApiManagement/service/authorizationProviders/authorizations/accessPolicies";
}
export interface service_authorizationProviders_authorizations_accessPoliciesComponentOutputs {
	readonly apiVersion: "2022-04-01-preview";
	readonly id: string;
	readonly type: "Microsoft.ApiManagement/service/authorizationProviders/authorizations/accessPolicies";
}
export interface service_authorizationProviders_authorizations_accessPoliciesComponentInputs {
	readonly name: string;
	readonly properties?: AuthorizationAccessPolicyContractProperties | undefined;
}
	...
	implements service_authorizationServersComponentOutputs
{
	constructor(entity: ADKEntity, options: service_authorizationServersComponentInputs) {
		super(entity, options.name, "Microsoft.ApiManagement/service/authorizationServers", "2022-04-01-preview", options);
	}
	public readonly apiVersion: "2022-04-01-preview";
	public readonly id: string;
	...
	implements service_backendsComponentOutputs
{
	constructor(entity: ADKEntity, options: service_backendsComponentInputs) {
		super(entity, options.name, "Microsoft.ApiManagement/service/backends", "2022-04-01-preview", options);
	}
	public readonly apiVersion: "2022-04-01-preview";
	public readonly id: string;
...
export class service_caches extends ArmResource<service_cachesComponentInputs> implements service_cachesComponentOutputs {
	constructor(entity: ADKEntity, options: service_cachesComponentInputs) {
		super(entity, options.name, "Microsoft.ApiManagement/service/caches", "2022-04-01-preview", options);
	}
	public readonly apiVersion: "2022-04-01-preview";
	public readonly id: string;
	...
	implements service_certificatesComponentOutputs
{
	constructor(entity: ADKEntity, options: service_certificatesComponentInputs) {
		super(entity, options.name, "Microsoft.ApiManagement/service/certificates", "2022-04-01-preview", options);
	}
	public readonly apiVersion: "2022-04-01-preview";
	public readonly id: string;
	...
	implements service_contentTypesComponentOutputs
{
	constructor(entity: ADKEntity, options: service_contentTypesComponentInputs) {
		super(entity, options.name, "Microsoft.ApiManagement/service/contentTypes", "2022-04-01-preview", options);
	}
	public readonly apiVersion: "2022-04-01-preview";
	public readonly id: string;
	...
	implements service_diagnosticsComponentOutputs
{
	constructor(entity: ADKEntity, options: service_diagnosticsComponentInputs) {
		super(entity, options.name, "Microsoft.ApiManagement/service/diagnostics", "2022-04-01-preview", options);
	}
	public readonly apiVersion: "2022-04-01-preview";
	public readonly id: string;
	...
	implements service_gatewaysComponentOutputs
{
	constructor(entity: ADKEntity, options: service_gatewaysComponentInputs) {
		super(entity, options.name, "Microsoft.ApiManagement/service/gateways", "2022-04-01-preview", options);
	}
	public readonly apiVersion: "2022-04-01-preview";
	public readonly id: string;
	...
	implements service_gateways_apisComponentOutputs
{
	constructor(entity: ADKEntity, options: service_gateways_apisComponentInputs) {
		super(entity, options.name, "Microsoft.ApiManagement/service/gateways/apis", "2022-04-01-preview", options);
	}
	public readonly apiVersion: "2022-04-01-preview";
	public readonly id: string;
...
export class service_groups extends ArmResource<service_groupsComponentInputs> implements service_groupsComponentOutputs {
	constructor(entity: ADKEntity, options: service_groupsComponentInputs) {
		super(entity, options.name, "Microsoft.ApiManagement/service/groups", "2022-04-01-preview", options);
	}
	public readonly apiVersion: "2022-04-01-preview";
	public readonly id: string;
	...
	implements service_groups_usersComponentOutputs
{
	constructor(entity: ADKEntity, options: service_groups_usersComponentInputs) {
		super(entity, options.name, "Microsoft.ApiManagement/service/groups/users", "2022-04-01-preview", options);
	}
	public readonly apiVersion: "2022-04-01-preview";
	public readonly id: string;
	...
	implements service_identityProvidersComponentOutputs
{
	constructor(entity: ADKEntity, options: service_identityProvidersComponentInputs) {
		super(entity, options.name, "Microsoft.ApiManagement/service/identityProviders", "2022-04-01-preview", options);
	}
	public readonly apiVersion: "2022-04-01-preview";
	public readonly id: string;
...
export class service_issues extends ArmResource<service_issuesComponentInputs> implements service_issuesComponentOutputs {
	constructor(entity: ADKEntity, options: service_issuesComponentInputs) {
		super(entity, options.name, "Microsoft.ApiManagement/service/issues", "2022-04-01-preview", options);
	}
	public readonly apiVersion: "2022-04-01-preview";
	public readonly id: string;
	...
	implements service_loggersComponentOutputs
{
	constructor(entity: ADKEntity, options: service_loggersComponentInputs) {
		super(entity, options.name, "Microsoft.ApiManagement/service/loggers", "2022-04-01-preview", options);
	}
	public readonly apiVersion: "2022-04-01-preview";
	public readonly id: string;
	...
	implements service_namedValuesComponentOutputs
{
	constructor(entity: ADKEntity, options: service_namedValuesComponentInputs) {
		super(entity, options.name, "Microsoft.ApiManagement/service/namedValues", "2022-04-01-preview", options);
	}
	public readonly apiVersion: "2022-04-01-preview";
	public readonly id: string;
	...
	implements service_notificationsComponentOutputs
{
	constructor(entity: ADKEntity, options: service_notificationsComponentInputs) {
		super(entity, options.name, "Microsoft.ApiManagement/service/notifications", "2022-04-01-preview", options);
	}
	public readonly apiVersion: "2022-04-01-preview";
	public readonly id: string;
	...
	implements service_policiesComponentOutputs
{
	constructor(entity: ADKEntity, options: service_policiesComponentInputs) {
		super(entity, options.name, "Microsoft.ApiManagement/service/policies", "2022-04-01-preview", options);
	}
	public readonly apiVersion: "2022-04-01-preview";
	public readonly id: string;
...
export class service_policyFragments
	extends ArmResource<service_policyFragmentsComponentInputs>
	implements service_policyFragmentsComponentOutputs
{
	constructor(entity: ADKEntity, options: service_policyFragmentsComponentInputs) {
		super(entity, options.name, "Microsoft.ApiManagement/service/policyFragments", "2022-04-01-preview", options);
	}
	public readonly apiVersion: "2022-04-01-preview";
	public readonly id: string;
	public readonly type: "Microsoft.ApiManagement/service/policyFragments";
}
export interface service_policyFragmentsComponentOutputs {
	readonly apiVersion: "2022-04-01-preview";
	readonly id: string;
	readonly type: "Microsoft.ApiManagement/service/policyFragments";
}
export interface service_policyFragmentsComponentInputs {
	readonly name: string;
	readonly properties?: PolicyFragmentContractProperties | undefined;
}
export class service_portalconfigs
	extends ArmResource<service_portalconfigsComponentInputs>
	implements service_portalconfigsComponentOutputs
{
	constructor(entity: ADKEntity, options: service_portalconfigsComponentInputs) {
		super(entity, options.name, "Microsoft.ApiManagement/service/portalconfigs", "2022-04-01-preview", options);
	}
	public readonly apiVersion: "2022-04-01-preview";
	public readonly id: string;
	public readonly type: "Microsoft.ApiManagement/service/portalconfigs";
}
export interface service_portalconfigsComponentOutputs {
	readonly apiVersion: "2022-04-01-preview";
	readonly id: string;
	readonly type: "Microsoft.ApiManagement/service/portalconfigs";
}
export interface service_portalconfigsComponentInputs {
	readonly name: string;
	readonly properties?: PortalConfigProperties | undefined;
}
	...
	implements service_portalRevisionsComponentOutputs
{
	constructor(entity: ADKEntity, options: service_portalRevisionsComponentInputs) {
		super(entity, options.name, "Microsoft.ApiManagement/service/portalRevisions", "2022-04-01-preview", options);
	}
	public readonly apiVersion: "2022-04-01-preview";
	public readonly id: string;
	...
	implements service_portalsettings_delegationComponentOutputs
{
	constructor(entity: ADKEntity, options: service_portalsettings_delegationComponentInputs) {
		super(entity, options.name, "Microsoft.ApiManagement/service/portalsettings", "2022-04-01-preview", options);
	}
	public readonly apiVersion: "2022-04-01-preview";
	public readonly id: string;
...
export class service_privateEndpointConnections
	extends ArmResource<service_privateEndpointConnectionsComponentInputs>
	implements service_privateEndpointConnectionsComponentOutputs
{
	constructor(entity: ADKEntity, options: service_privateEndpointConnectionsComponentInputs) {
		super(
			entity,
			options.name,
	...
	public readonly apiVersion: "2022-04-01-preview";
	public readonly id: string;
	public readonly type: "Microsoft.ApiManagement/service/privateEndpointConnections";
}
export interface service_privateEndpointConnectionsComponentOutputs {
	readonly apiVersion: "2022-04-01-preview";
	readonly id: string;
	readonly type: "Microsoft.ApiManagement/service/privateEndpointConnections";
}
export interface service_privateEndpointConnectionsComponentInputs {
	readonly name: string;
	readonly properties?: PrivateEndpointConnectionRequestPropertiesOrPrivateEndpointConnectionProperties | undefined;
}
export class service_privateLinkResources
	extends ArmResource<service_privateLinkResourcesComponentInputs>
	implements service_privateLinkResourcesComponentOutputs
{
	constructor(entity: ADKEntity, options: service_privateLinkResourcesComponentInputs) {
		super(entity, options.name, "Microsoft.ApiManagement/service/privateLinkResources", "2022-04-01-preview", options);
	}
	public readonly apiVersion: "2022-04-01-preview";
	public readonly id: string;
	public readonly type: "Microsoft.ApiManagement/service/privateLinkResources";
}
export interface service_privateLinkResourcesComponentOutputs {
	readonly apiVersion: "2022-04-01-preview";
	readonly id: string;
	readonly type: "Microsoft.ApiManagement/service/privateLinkResources";
}
export interface service_privateLinkResourcesComponentInputs {
	readonly name: string;
	...
	implements service_productsComponentOutputs
{
	constructor(entity: ADKEntity, options: service_productsComponentInputs) {
		super(entity, options.name, "Microsoft.ApiManagement/service/products", "2022-04-01-preview", options);
	}
	public readonly apiVersion: "2022-04-01-preview";
	public readonly id: string;
	...
	implements service_products_apisComponentOutputs
{
	constructor(entity: ADKEntity, options: service_products_apisComponentInputs) {
		super(entity, options.name, "Microsoft.ApiManagement/service/products/apis", "2022-04-01-preview", options);
	}
	public readonly apiVersion: "2022-04-01-preview";
	public readonly id: string;
	...
	implements service_products_groupsComponentOutputs
{
	constructor(entity: ADKEntity, options: service_products_groupsComponentInputs) {
		super(entity, options.name, "Microsoft.ApiManagement/service/products/groups", "2022-04-01-preview", options);
	}
	public readonly apiVersion: "2022-04-01-preview";
	public readonly id: string;
	...
	implements service_products_policiesComponentOutputs
{
	constructor(entity: ADKEntity, options: service_products_policiesComponentInputs) {
		super(entity, options.name, "Microsoft.ApiManagement/service/products/policies", "2022-04-01-preview", options);
	}
	public readonly apiVersion: "2022-04-01-preview";
	public readonly id: string;
	...
	implements service_products_tagsComponentOutputs
{
	constructor(entity: ADKEntity, options: service_products_tagsComponentInputs) {
		super(entity, options.name, "Microsoft.ApiManagement/service/products/tags", "2022-04-01-preview", options);
	}
	public readonly apiVersion: "2022-04-01-preview";
	public readonly id: string;
...
export class service_schemas
	extends ArmResource<service_schemasComponentInputs>
	implements service_schemasComponentOutputs
{
	constructor(entity: ADKEntity, options: service_schemasComponentInputs) {
		super(entity, options.name, "Microsoft.ApiManagement/service/schemas", "2022-04-01-preview", options);
	}
	public readonly apiVersion: "2022-04-01-preview";
	public readonly id: string;
	public readonly type: "Microsoft.ApiManagement/service/schemas";
}
export interface service_schemasComponentOutputs {
	readonly apiVersion: "2022-04-01-preview";
	readonly id: string;
	readonly type: "Microsoft.ApiManagement/service/schemas";
}
export interface service_schemasComponentInputs {
	readonly name: string;
	readonly properties?: GlobalSchemaContractProperties | undefined;
}
	...
	implements service_settingsComponentOutputs
{
	constructor(entity: ADKEntity, options: service_settingsComponentInputs) {
		super(entity, options.name, "Microsoft.ApiManagement/service/settings", "2022-04-01-preview", options);
	}
	public readonly apiVersion: "2022-04-01-preview";
	public readonly id: string;
	...
	implements service_subscriptionsComponentOutputs
{
	constructor(entity: ADKEntity, options: service_subscriptionsComponentInputs) {
		super(entity, options.name, "Microsoft.ApiManagement/service/subscriptions", "2022-04-01-preview", options);
	}
	public readonly apiVersion: "2022-04-01-preview";
	public readonly id: string;
...
export class service_tags extends ArmResource<service_tagsComponentInputs> implements service_tagsComponentOutputs {
	constructor(entity: ADKEntity, options: service_tagsComponentInputs) {
		super(entity, options.name, "Microsoft.ApiManagement/service/tags", "2022-04-01-preview", options);
	}
	public readonly apiVersion: "2022-04-01-preview";
	public readonly id: string;
	...
	implements service_templatesComponentOutputs
{
	constructor(entity: ADKEntity, options: service_templatesComponentInputs) {
		super(entity, options.name, "Microsoft.ApiManagement/service/templates", "2022-04-01-preview", options);
	}
	public readonly apiVersion: "2022-04-01-preview";
	public readonly id: string;
...
export class service_tenant extends ArmResource<service_tenantComponentInputs> implements service_tenantComponentOutputs {
	constructor(entity: ADKEntity, options: service_tenantComponentInputs) {
		super(entity, options.name, "Microsoft.ApiManagement/service/tenant", "2022-04-01-preview", options);
	}
	public readonly apiVersion: "2022-04-01-preview";
	public readonly id: string;
...
export class service_users extends ArmResource<service_usersComponentInputs> implements service_usersComponentOutputs {
	constructor(entity: ADKEntity, options: service_usersComponentInputs) {
		super(entity, options.name, "Microsoft.ApiManagement/service/users", "2022-04-01-preview", options);
	}
	public readonly apiVersion: "2022-04-01-preview";
	public readonly id: string;
	...
	implements service_users_subscriptionsComponentOutputs
{
	constructor(entity: ADKEntity, options: service_users_subscriptionsComponentInputs) {
		super(entity, options.name, "Microsoft.ApiManagement/service/users/subscriptions", "2022-04-01-preview", options);
	}
	public readonly apiVersion: "2022-04-01-preview";
	public readonly id: string;
...
export function listReferences(resource: service_policyFragments): ResourceCollection {
	if (resource.apiVersion !== "2022-04-01-preview") {
		throw new Error(`listReferences is not available for api version ${resource.apiVersion}`);
	}
	if (resource.type !== "Microsoft.ApiManagement/service/policyFragments") {
		throw new Error(`listReferences is not available for resource type ${resource.type}`);
	}
	throw new Error("not implemented");
}
...
export interface AdditionalLocation {
	...
	readonly location: string;
	readonly natGatewayState?: ("Disabled" | "Enabled") | undefined;
	readonly outboundPublicIPAddresses?: string[] | undefined;
	readonly platformVersion?: ("mtv1" | "stv1" | "stv2" | "undetermined") | undefined;
...
export interface ApiCreateOrUpdatePropertiesOrApiContractProperties {
	...
	readonly apiType?: ("graphql" | "http" | "soap" | "websocket") | undefined;
	...
	readonly contact?: ApiContactInformation | undefined;
	...
	readonly license?: ApiLicenseInformation | undefined;
	readonly path: string;
	readonly protocols?: ("http" | "https" | "ws" | "wss"[]) | undefined;
	...
	readonly translateRequiredQueryParameters?: ("query" | "template") | undefined;
	readonly type?: ("graphql" | "http" | "soap" | "websocket") | undefined;
...
export interface ApiManagementServiceProperties {
	...
	readonly privateEndpointConnections?: RemotePrivateEndpointConnectionWrapper[] | undefined;
	readonly privateIPAddresses?: string[] | undefined;
...
export interface AuthenticationSettingsContract {
	...
	readonly oAuth2AuthenticationSettings?: OAuth2AuthenticationSettingsContract[] | undefined;
	readonly openid?: OpenIdAuthenticationSettingsContract | undefined;
	readonly openidAuthenticationSettings?: OpenIdAuthenticationSettingsContract[] | undefined;
}
...
export interface AuthorizationContractProperties {
	readonly authorizationType?: "OAuth2" | undefined;
	readonly error?: AuthorizationError | undefined;
	readonly oauth2grantType?: ("AuthorizationCode" | "ClientCredentials") | undefined;
	readonly parameters?: AuthorizationContractPropertiesParameters | undefined;
	readonly status?: string | undefined;
}
export interface AuthorizationContractPropertiesParameters {
	readonly "[ key: string ]"?: string | undefined;
}
...
export interface AuthorizationProviderContractProperties {
	...
	readonly oauth2?: AuthorizationProviderOAuth2Settings | undefined;
}
export interface AuthorizationProviderOAuth2GrantTypes {
	readonly authorizationCode?: AuthorizationProviderOAuth2GrantTypesAuthorizationCode | undefined;
	readonly clientCredentials?: AuthorizationProviderOAuth2GrantTypesClientCredentials | undefined;
}
export interface AuthorizationProviderOAuth2GrantTypesAuthorizationCode {
	readonly "[ key: string ]"?: string | undefined;
}
export interface AuthorizationProviderOAuth2GrantTypesClientCredentials {
	readonly "[ key: string ]"?: string | undefined;
}
export interface AuthorizationProviderOAuth2Settings {
	readonly grantTypes?: AuthorizationProviderOAuth2GrantTypes | undefined;
...
export interface AuthorizationServerContractProperties {
	...
	readonly useInApiDocumentation?: boolean | undefined;
	readonly useInTestConsole?: boolean | undefined;
}
...
export interface GlobalSchemaContractProperties {
	readonly description?: string | undefined;
	readonly document?: any | undefined;
...
export interface HostnameConfiguration {
	readonly certificate?: CertificateInformation | undefined;
	readonly certificatePassword?: string | undefined;
	readonly certificateSource?: ("BuiltIn" | "Custom" | "KeyVault" | "Managed") | undefined;
	readonly certificateStatus?: ("Completed" | "Failed" | "InProgress") | undefined;
...
export interface IdentityProviderCreateContractPropertiesOrIdentityProviderContractProperties {
	...
	readonly clientId: string;
	readonly clientLibrary?: string | undefined;
...
export interface ParameterContract {
	...
	readonly description?: string | undefined;
	readonly examples?: ParameterExamplesContract | undefined;
	readonly name: string;
...
export interface ParameterExamplesContract {
	readonly "[ key: string ]"?: ParameterExampleContract | undefined;
}
...
export interface PolicyFragmentContractProperties {
	readonly description?: string | undefined;
	readonly format?: ("rawxml" | "xml") | undefined;
	readonly value: string;
}
...
export interface PortalConfigCspProperties {
	readonly allowedSources?: string[] | undefined;
	readonly mode?: ("disabled" | "enabled" | "reportOnly") | undefined;
	readonly reportUri?: string[] | undefined;
}
export interface PortalConfigDelegationProperties {
	readonly delegateRegistration?: boolean | undefined;
	readonly delegateSubscription?: boolean | undefined;
	readonly delegationUrl?: string | undefined;
	readonly validationKey?: string | undefined;
}
export interface PortalConfigProperties {
	readonly cors?: PortalConfigCorsProperties | undefined;
	readonly csp?: PortalConfigCspProperties | undefined;
	readonly delegation?: PortalConfigDelegationProperties | undefined;
	readonly enableBasicAuth?: boolean | undefined;
	readonly signin?: PortalConfigPropertiesSignin | undefined;
	readonly signup?: PortalConfigPropertiesSignup | undefined;
}
export interface PortalConfigPropertiesSignin {
	readonly require?: boolean | undefined;
}
export interface PortalConfigPropertiesSignup {
	readonly termsOfService?: PortalConfigTermsOfServiceProperties | undefined;
}
export interface PortalConfigTermsOfServiceProperties {
	readonly requireConsent?: boolean | undefined;
...
export interface PrivateEndpointConnectionRequestPropertiesOrPrivateEndpointConnectionProperties {
...
export interface RemotePrivateEndpointConnectionWrapper {
	readonly id?: string | undefined;
	readonly name?: string | undefined;
	readonly properties?: PrivateEndpointConnectionWrapperProperties | undefined;
...
export interface ResourceCollection {
	...
	readonly value?: ResourceCollectionValueItem[] | undefined;
}
...
export default {
	...
	"service/authorizationProviders": service_authorizationProviders,
	"service/authorizationProviders/authorizations": service_authorizationProviders_authorizations,
	"service/authorizationProviders/authorizations/accessPolicies":
		service_authorizationProviders_authorizations_accessPolicies,
	...
	"service/policyFragments": service_policyFragments,
	"service/portalconfigs": service_portalconfigs,
	...
	"service/privateEndpointConnections": service_privateEndpointConnections,
	"service/privateLinkResources": service_privateLinkResources,
