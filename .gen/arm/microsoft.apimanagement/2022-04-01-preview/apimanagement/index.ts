...
export interface service_authorizationProvidersComponentInputs {
	readonly name: string;
	readonly properties?: AuthorizationProviderContractProperties;
}
...
export interface service_authorizationProviders_authorizationsComponentInputs {
	readonly name: string;
	readonly properties?: AuthorizationContractProperties;
}
...
export interface service_authorizationProviders_authorizations_accessPoliciesComponentInputs {
	readonly name: string;
	readonly properties?: AuthorizationAccessPolicyContractProperties;
}
...
export interface service_policyFragmentsComponentInputs {
	readonly name: string;
	readonly properties?: PolicyFragmentContractProperties;
}
...
export interface service_portalconfigsComponentInputs {
	readonly name: string;
	readonly properties?: PortalConfigProperties;
}
...
export interface service_privateEndpointConnectionsComponentInputs {
	readonly name: string;
	readonly properties?: PrivateEndpointConnectionRequestPropertiesOrPrivateEndpointConnectionProperties;
}
...
export interface service_schemasComponentInputs {
	readonly name: string;
	readonly properties?: GlobalSchemaContractProperties;
}
...
export interface AdditionalLocation {
	...
	readonly platformVersion?: "mtv1" | "stv1" | "stv2" | "undetermined";
...
export interface ApiCreateOrUpdatePropertiesOrApiContractProperties {
	...
	readonly apiType?: "graphql" | "http" | "soap" | "websocket";
	...
	readonly protocols?: "http" | "https" | "ws" | "wss"[];
	...
	readonly type?: "graphql" | "http" | "soap" | "websocket";
...
export interface AuthorizationProviderOAuth2GrantTypes {
	readonly authorizationCode?: AuthorizationProviderOAuth2GrantTypesAuthorizationCode;
	readonly clientCredentials?: AuthorizationProviderOAuth2GrantTypesClientCredentials;
}
...
export interface ParameterExamplesContract {
	readonly [key: string]: ParameterExampleContract;
}
...
export interface PortalConfigDelegationProperties {
	readonly delegateRegistration?: boolean;
	readonly delegateSubscription?: boolean;
...
export interface RemotePrivateEndpointConnectionWrapper {
	readonly id?: string;
	readonly name?: string;
	readonly properties?: PrivateEndpointConnectionWrapperProperties;
	readonly type?: string;
}
...
export interface ResourceCollection {
	...
	readonly value?: ResourceCollectionValueItem[];
}
