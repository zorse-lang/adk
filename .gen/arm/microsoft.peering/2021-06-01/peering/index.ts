...
export class peerAsns extends ArmResource<peerAsnsComponentInputs> implements peerAsnsComponentOutputs {
	constructor(entity: ADKEntity, options: peerAsnsComponentInputs) {
		super(entity, options.name, "Microsoft.Peering/peerAsns", "2021-06-01", options);
	}
...
export class peerings extends ArmResource<peeringsComponentInputs> implements peeringsComponentOutputs {
	constructor(entity: ADKEntity, options: peeringsComponentInputs) {
		super(entity, options.name, "Microsoft.Peering/peerings", "2021-06-01", options);
	}
	public readonly apiVersion: "2021-06-01";
	public readonly id: string;
	...
	implements peerings_registeredAsnsComponentOutputs
{
	constructor(entity: ADKEntity, options: peerings_registeredAsnsComponentInputs) {
		super(entity, options.name, "Microsoft.Peering/peerings/registeredAsns", "2021-06-01", options);
	}
	public readonly apiVersion: "2021-06-01";
	public readonly id: string;
	...
	implements peerings_registeredPrefixesComponentOutputs
{
	constructor(entity: ADKEntity, options: peerings_registeredPrefixesComponentInputs) {
		super(entity, options.name, "Microsoft.Peering/peerings/registeredPrefixes", "2021-06-01", options);
	}
	public readonly apiVersion: "2021-06-01";
	public readonly id: string;
	...
	implements peeringServicesComponentOutputs
{
	constructor(entity: ADKEntity, options: peeringServicesComponentInputs) {
		super(entity, options.name, "Microsoft.Peering/peeringServices", "2021-06-01", options);
	}
	public readonly apiVersion: "2021-06-01";
	public readonly id: string;
	...
	implements peeringServices_connectionMonitorTestsComponentOutputs
{
	constructor(entity: ADKEntity, options: peeringServices_connectionMonitorTestsComponentInputs) {
		super(entity, options.name, "Microsoft.Peering/peeringServices/connectionMonitorTests", "2021-06-01", options);
	}
	public readonly apiVersion: "2021-06-01";
	public readonly id: string;
...
export interface peeringServices_connectionMonitorTestsComponentInputs {
	readonly name: string;
	readonly properties?: ConnectionMonitorTestProperties | undefined;
}
	...
	implements peeringServices_prefixesComponentOutputs
{
	constructor(entity: ADKEntity, options: peeringServices_prefixesComponentInputs) {
		super(entity, options.name, "Microsoft.Peering/peeringServices/prefixes", "2021-06-01", options);
	}
	public readonly apiVersion: "2021-06-01";
	public readonly id: string;
...
export interface DirectConnection {
	...
	readonly microsoftTrackingId?: string | undefined;
...
export interface LogAnalyticsWorkspaceProperties {
	readonly connectedAgents?: string[] | undefined;
...
export interface PeeringPropertiesDirect {
	...
	readonly directPeeringType?: ("Cdn" | "Edge" | "Internal" | "Ix" | "IxRs" | "Transit" | "Voice") | undefined;
...
export interface PeeringServiceProperties {
	readonly logAnalyticsWorkspaceProperties?: LogAnalyticsWorkspaceProperties | undefined;
	readonly peeringServiceLocation?: string | undefined;
	readonly peeringServiceProvider?: string | undefined;
	readonly providerBackupPeeringLocation?: string | undefined;
	readonly providerPrimaryPeeringLocation?: string | undefined;
	readonly provisioningState?: ("Deleting" | "Failed" | "Succeeded" | "Updating") | undefined;
}
