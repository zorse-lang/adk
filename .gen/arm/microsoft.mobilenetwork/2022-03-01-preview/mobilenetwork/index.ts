...
export class mobileNetworks extends ArmResource<mobileNetworksComponentInputs> implements mobileNetworksComponentOutputs {
	constructor(entity: ADKEntity, options: mobileNetworksComponentInputs) {
		super(entity, options.name, "Microsoft.MobileNetwork/mobileNetworks", "2022-03-01-preview", options);
	}
	...
	implements mobileNetworks_dataNetworksComponentOutputs
{
	constructor(entity: ADKEntity, options: mobileNetworks_dataNetworksComponentInputs) {
		super(entity, options.name, "Microsoft.MobileNetwork/mobileNetworks/dataNetworks", "2022-03-01-preview", options);
	}
	public readonly apiVersion: "2022-03-01-preview";
	public readonly id: string;
	...
	implements mobileNetworks_servicesComponentOutputs
{
	constructor(entity: ADKEntity, options: mobileNetworks_servicesComponentInputs) {
		super(entity, options.name, "Microsoft.MobileNetwork/mobileNetworks/services", "2022-03-01-preview", options);
	}
	public readonly apiVersion: "2022-03-01-preview";
	public readonly id: string;
	...
	implements mobileNetworks_simPoliciesComponentOutputs
{
	constructor(entity: ADKEntity, options: mobileNetworks_simPoliciesComponentInputs) {
		super(entity, options.name, "Microsoft.MobileNetwork/mobileNetworks/simPolicies", "2022-03-01-preview", options);
	}
	public readonly apiVersion: "2022-03-01-preview";
	public readonly id: string;
	...
	implements mobileNetworks_sitesComponentOutputs
{
	constructor(entity: ADKEntity, options: mobileNetworks_sitesComponentInputs) {
		super(entity, options.name, "Microsoft.MobileNetwork/mobileNetworks/sites", "2022-03-01-preview", options);
	}
	public readonly apiVersion: "2022-03-01-preview";
	public readonly id: string;
	...
	implements mobileNetworks_slicesComponentOutputs
{
	constructor(entity: ADKEntity, options: mobileNetworks_slicesComponentInputs) {
		super(entity, options.name, "Microsoft.MobileNetwork/mobileNetworks/slices", "2022-03-01-preview", options);
	}
	public readonly apiVersion: "2022-03-01-preview";
	public readonly id: string;
	...
	implements packetCoreControlPlanesComponentOutputs
{
	constructor(entity: ADKEntity, options: packetCoreControlPlanesComponentInputs) {
		super(entity, options.name, "Microsoft.MobileNetwork/packetCoreControlPlanes", "2022-03-01-preview", options);
	}
	public readonly apiVersion: "2022-03-01-preview";
	public readonly id: string;
...
export class sims extends ArmResource<simsComponentInputs> implements simsComponentOutputs {
	constructor(entity: ADKEntity, options: simsComponentInputs) {
		super(entity, options.name, "Microsoft.MobileNetwork/sims", "2022-03-01-preview", options);
	}
	public readonly apiVersion: "2022-03-01-preview";
	public readonly id: string;
	public readonly type: "Microsoft.MobileNetwork/sims";
}
export interface simsComponentOutputs {
	readonly apiVersion: "2022-03-01-preview";
	readonly id: string;
	readonly type: "Microsoft.MobileNetwork/sims";
}
export interface simsComponentInputs {
	readonly location: string;
	readonly name: string;
