...
export interface EnableMigrationInputPropertiesOrMigrationItemProperties {
	readonly allowedOperations?: "DisableMigration" | "Migrate" | "TestMigrate" | "TestMigrateCleanup"[];
...
export interface IPConfig {
	readonly lBBackendAddressPoolIds?: string[];
...
export interface VMNicDetails {
	...
	readonly tfoIPConfigs?: IPConfig[];
	...
	readonly tfoVMSubnetName?: string;
