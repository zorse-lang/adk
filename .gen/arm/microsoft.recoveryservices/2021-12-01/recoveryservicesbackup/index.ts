...
export interface AzureIaaSVMProtectionPolicyTieringPolicy {
	readonly [key: string]: TieringPolicy;
}
...
export interface BackupResourceVaultConfig {
	...
	readonly isSoftDeleteFeatureStateEditable?: boolean;
...
export interface SubProtectionPolicy {
	...
	readonly tieringPolicy?: SubProtectionPolicyTieringPolicy;
}
...
export interface TieringPolicy {
	...
	readonly durationType?: "Days" | "Invalid" | "Months" | "Weeks" | "Years";
	readonly tieringMode?: "DoNotTier" | "Invalid" | "TierAfter" | "TierRecommended";
}
...
export interface WeeklySchedule {
	readonly scheduleRunDays?: "Friday" | "Monday" | "Saturday" | "Sunday" | "Thursday" | "Tuesday"[];
	readonly scheduleRunTimes?: string[];
}
