	...
	implements vaults_backupconfigComponentOutputs
{
	constructor(entity: ADKEntity, options: vaults_backupconfigComponentInputs) {
		super(entity, options.name, "Microsoft.RecoveryServices/vaults/backupconfig", "2021-12-01", options);
	}
	...
	implements vaults_backupEncryptionConfigsComponentOutputs
{
	constructor(entity: ADKEntity, options: vaults_backupEncryptionConfigsComponentInputs) {
		super(entity, options.name, "Microsoft.RecoveryServices/vaults/backupEncryptionConfigs", "2021-12-01", options);
	}
	public readonly apiVersion: "2021-12-01";
	public readonly id: string;
	...
	implements vaults_backupEnginesComponentOutputs
{
	constructor(entity: ADKEntity, options: vaults_backupEnginesComponentInputs) {
		super(entity, options.name, "Microsoft.RecoveryServices/vaults/backupEngines", "2021-12-01", options);
	}
	public readonly apiVersion: "2021-12-01";
	public readonly id: string;
	...
	implements vaults_backupJobsComponentOutputs
{
	constructor(entity: ADKEntity, options: vaults_backupJobsComponentInputs) {
		super(entity, options.name, "Microsoft.RecoveryServices/vaults/backupJobs", "2021-12-01", options);
	}
	public readonly apiVersion: "2021-12-01";
	public readonly id: string;
	...
	implements vaults_backupPoliciesComponentOutputs
{
	constructor(entity: ADKEntity, options: vaults_backupPoliciesComponentInputs) {
		super(entity, options.name, "Microsoft.RecoveryServices/vaults/backupPolicies", "2021-12-01", options);
	}
	public readonly apiVersion: "2021-12-01";
	public readonly id: string;
	...
	implements vaults_backupResourceGuardProxiesComponentOutputs
{
	constructor(entity: ADKEntity, options: vaults_backupResourceGuardProxiesComponentInputs) {
		super(entity, options.name, "Microsoft.RecoveryServices/vaults/backupResourceGuardProxies", "2021-12-01", options);
	}
	public readonly apiVersion: "2021-12-01";
	public readonly id: string;
	...
	implements vaults_backupstorageconfigComponentOutputs
{
	constructor(entity: ADKEntity, options: vaults_backupstorageconfigComponentInputs) {
		super(entity, options.name, "Microsoft.RecoveryServices/vaults/backupstorageconfig", "2021-12-01", options);
	}
	public readonly apiVersion: "2021-12-01";
	public readonly id: string;
	...
	implements vaults_privateEndpointConnectionsComponentOutputs
{
	constructor(entity: ADKEntity, options: vaults_privateEndpointConnectionsComponentInputs) {
		super(entity, options.name, "Microsoft.RecoveryServices/vaults/privateEndpointConnections", "2021-12-01", options);
	}
	public readonly apiVersion: "2021-12-01";
	public readonly id: string;
...
export interface AzureIaaSVMProtectedItemExtendedInfo {
	readonly newestRecoveryPointInArchive?: string | undefined;
	readonly oldestRecoveryPoint?: string | undefined;
	readonly oldestRecoveryPointInArchive?: string | undefined;
	readonly oldestRecoveryPointInVault?: string | undefined;
...
export interface AzureIaaSVMProtectionPolicyTieringPolicy {
	readonly "[ key: string ]"?: TieringPolicy | undefined;
}
...
export interface BackupResourceConfig {
	...
	readonly dedupState?: ("Disabled" | "Enabled" | "Invalid") | undefined;
	...
	readonly xcoolState?: ("Disabled" | "Enabled" | "Invalid") | undefined;
}
...
export interface BackupResourceVaultConfig {
	...
	readonly isSoftDeleteFeatureStateEditable?: boolean | undefined;
...
export interface DailySchedule {
	readonly scheduleRunTimes?: string[] | undefined;
}
...
export interface ExtendedProperties {
	...
	readonly linuxVmApplicationName?: string | undefined;
}
...
export interface HourlySchedule {
	...
	readonly scheduleWindowDuration?: number | undefined;
	readonly scheduleWindowStartTime?: string | undefined;
}
...
export interface ProtectionContainer {
	...
	readonly friendlyName?: string | undefined;
	readonly healthStatus?: string | undefined;
	readonly protectableObjectType?: string | undefined;
	readonly registrationStatus?: string | undefined;
}
...
export interface SubProtectionPolicy {
	...
	readonly tieringPolicy?: SubProtectionPolicyTieringPolicy | undefined;
}
export interface SubProtectionPolicyTieringPolicy {
	readonly "[ key: string ]"?: TieringPolicy | undefined;
}
export interface TieringPolicy {
	readonly duration?: number | undefined;
	readonly durationType?: ("Days" | "Invalid" | "Months" | "Weeks" | "Years") | undefined;
	readonly tieringMode?: ("DoNotTier" | "Invalid" | "TierAfter" | "TierRecommended") | undefined;
}
...
export interface WeeklySchedule {
	readonly scheduleRunDays?: ("Friday" | "Monday" | "Saturday" | "Sunday" | "Thursday" | "Tuesday"[]) | undefined;
	readonly scheduleRunTimes?: string[] | undefined;
}
