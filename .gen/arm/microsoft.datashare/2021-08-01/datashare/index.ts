...
export class accounts extends ArmResource<accountsComponentInputs> implements accountsComponentOutputs {
	constructor(entity: ADKEntity, options: accountsComponentInputs) {
		super(entity, options.name, "Microsoft.DataShare/accounts", "2021-08-01", options);
	}
	...
	implements accounts_sharesComponentOutputs
{
	constructor(entity: ADKEntity, options: accounts_sharesComponentInputs) {
		super(entity, options.name, "Microsoft.DataShare/accounts/shares", "2021-08-01", options);
	}
	public readonly apiVersion: "2021-08-01";
	public readonly id: string;
	...
	implements accounts_shares_dataSets_AdlsGen1FileComponentOutputs
{
	constructor(entity: ADKEntity, options: accounts_shares_dataSets_AdlsGen1FileComponentInputs) {
		super(entity, options.name, "Microsoft.DataShare/accounts/shares/dataSets", "2021-08-01", options);
	}
	public readonly apiVersion: "2021-08-01";
	public readonly id: string;
...
export class accounts_shares_dataSets_KustoTable
	extends ArmResource<accounts_shares_dataSets_KustoTableComponentInputs>
	implements accounts_shares_dataSets_KustoTableComponentOutputs
{
	constructor(entity: ADKEntity, options: accounts_shares_dataSets_KustoTableComponentInputs) {
		super(entity, options.name, "Microsoft.DataShare/accounts/shares/dataSets", "2021-08-01", options);
	}
	public readonly apiVersion: "2021-08-01";
	public readonly id: string;
...
export interface accounts_shares_dataSets_KustoTableComponentOutputs {
	readonly apiVersion: "2021-08-01";
	readonly id: string;
	readonly type: "Microsoft.DataShare/accounts/shares/dataSets";
}
export interface accounts_shares_dataSets_KustoTableComponentInputs {
	readonly name: string;
	readonly systemData?: SystemData;
	readonly kind: "KustoTable";
	readonly properties: KustoTableDataSetProperties;
}
	...
	implements accounts_shares_invitationsComponentOutputs
{
	constructor(entity: ADKEntity, options: accounts_shares_invitationsComponentInputs) {
		super(entity, options.name, "Microsoft.DataShare/accounts/shares/invitations", "2021-08-01", options);
	}
	public readonly apiVersion: "2021-08-01";
	public readonly id: string;
	...
	implements accounts_shares_synchronizationSettings_ScheduleBasedComponentOutputs
{
	constructor(entity: ADKEntity, options: accounts_shares_synchronizationSettings_ScheduleBasedComponentInputs) {
		super(entity, options.name, "Microsoft.DataShare/accounts/shares/synchronizationSettings", "2021-08-01", options);
	}
	public readonly apiVersion: "2021-08-01";
	public readonly id: string;
	...
	implements accounts_shareSubscriptionsComponentOutputs
{
	constructor(entity: ADKEntity, options: accounts_shareSubscriptionsComponentInputs) {
		super(entity, options.name, "Microsoft.DataShare/accounts/shareSubscriptions", "2021-08-01", options);
	}
	public readonly apiVersion: "2021-08-01";
	public readonly id: string;
...
export class accounts_shareSubscriptions_dataSetMappings_KustoTable
	extends ArmResource<accounts_shareSubscriptions_dataSetMappings_KustoTableComponentInputs>
	implements accounts_shareSubscriptions_dataSetMappings_KustoTableComponentOutputs
{
	constructor(entity: ADKEntity, options: accounts_shareSubscriptions_dataSetMappings_KustoTableComponentInputs) {
		super(
			entity,
			options.name,
			"Microsoft.DataShare/accounts/shareSubscriptions/dataSetMappings",
...
export interface accounts_shareSubscriptions_dataSetMappings_KustoTableComponentOutputs {
	readonly apiVersion: "2021-08-01";
	readonly id: string;
	readonly type: "Microsoft.DataShare/accounts/shareSubscriptions/dataSetMappings";
}
export interface accounts_shareSubscriptions_dataSetMappings_KustoTableComponentInputs {
	readonly name: string;
	readonly systemData?: SystemData;
	readonly kind: "KustoTable";
	readonly properties: KustoTableDataSetMappingProperties;
}
	...
	implements accounts_shareSubscriptions_triggers_ScheduleBasedComponentOutputs
{
	constructor(entity: ADKEntity, options: accounts_shareSubscriptions_triggers_ScheduleBasedComponentInputs) {
		super(entity, options.name, "Microsoft.DataShare/accounts/shareSubscriptions/triggers", "2021-08-01", options);
	}
	public readonly apiVersion: "2021-08-01";
	public readonly id: string;
	...
	implements locations_consumerInvitationsComponentOutputs
{
	constructor(entity: ADKEntity, options: locations_consumerInvitationsComponentInputs) {
		super(entity, options.name, "Microsoft.DataShare/locations/consumerInvitations", "2021-08-01", options);
	}
	public readonly apiVersion: "2021-08-01";
	public readonly id: string;
...
export interface KustoTableDataSetMappingProperties {
	readonly dataSetId: string;
	readonly dataSetMappingStatus?: "Broken" | "Ok";
	readonly kustoClusterResourceId: string;
	readonly location?: string;
...
export interface KustoTableDataSetProperties {
	readonly dataSetId?: string;
	readonly kustoDatabaseResourceId: string;
	readonly location?: string;
	readonly provisioningState?: "Creating" | "Deleting" | "Failed" | "Moving" | "Succeeded";
...
export type accounts_shares_dataSets =
	...
	| accounts_shares_dataSets_KustoTable
...
export type accounts_shareSubscriptions_dataSetMappings =
	...
	| accounts_shareSubscriptions_dataSetMappings_KustoTable
...
export default {
	...
	"accounts/shares/dataSets/KustoTable": accounts_shares_dataSets_KustoTable,
	...
	"accounts/shareSubscriptions/dataSetMappings/KustoDatabase":
		accounts_shareSubscriptions_dataSetMappings_KustoDatabase,
	"accounts/shareSubscriptions/dataSetMappings/KustoTable": accounts_shareSubscriptions_dataSetMappings_KustoTable,
