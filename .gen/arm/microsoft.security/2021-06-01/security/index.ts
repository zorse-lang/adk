...
export interface assessmentMetadataComponentInputs {
	...
	readonly properties?: SecurityAssessmentMetadataPropertiesResponse | undefined;
}
...
export interface assessmentsComponentInputs {
	readonly name: string;
	readonly properties?: SecurityAssessmentPropertiesOrSecurityAssessmentPropertiesResponse | undefined;
}
...
export interface AssessmentStatusOrAssessmentStatusResponse {
	...
	readonly firstEvaluationDate?: string | undefined;
...
export interface SecurityAssessmentMetadataPropertiesResponse {
	...
	readonly implementationEffort?: ("High" | "Low" | "Moderate") | undefined;
	readonly partnerData?: SecurityAssessmentMetadataPartnerData | undefined;
	readonly plannedDeprecationDate?: string | undefined;
	readonly policyDefinitionId?: string | undefined;
	readonly preview?: boolean | undefined;
	readonly publishDates?: SecurityAssessmentMetadataPropertiesResponsePublishDates | undefined;
	readonly remediationDescription?: string | undefined;
	readonly severity: "High" | "Low" | "Medium";
	readonly tactics?:
		| (
...
export interface SecurityAssessmentPropertiesOrSecurityAssessmentPropertiesResponse {
	readonly additionalData?: SecurityAssessmentPropertiesBaseAdditionalData | undefined;
