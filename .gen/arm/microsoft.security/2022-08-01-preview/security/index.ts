...
export interface DefenderCspmAwsOfferingVmScannersConfiguration {
	readonly cloudRoleArn?: string;
	readonly exclusionTags?: DefenderCspmAwsOfferingVmScannersConfigurationExclusionTags;
...
export interface DefenderForServersAwsOfferingVmScannersConfiguration {
	readonly cloudRoleArn?: string;
	readonly exclusionTags?: DefenderForServersAwsOfferingVmScannersConfigurationExclusionTags;
	readonly scanningMode?: "Default";
}
...
export interface SecurityConnectorProperties {
	...
	readonly environmentName?: "AWS" | "Azure" | "AzureDevOps" | "GCP" | "Github";
