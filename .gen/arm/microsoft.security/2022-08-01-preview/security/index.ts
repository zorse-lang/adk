	...
	implements securityConnectorsComponentOutputs
{
	constructor(entity: ADKEntity, options: securityConnectorsComponentInputs) {
		super(entity, options.name, "Microsoft.Security/securityConnectors", "2022-08-01-preview", options);
	}
...
export interface DefenderCspmAwsOfferingVmScanners {
	readonly configuration?: DefenderCspmAwsOfferingVmScannersConfiguration | undefined;
	readonly enabled?: boolean | undefined;
}
export interface DefenderCspmAwsOfferingVmScannersConfiguration {
	readonly cloudRoleArn?: string | undefined;
	readonly exclusionTags?: DefenderCspmAwsOfferingVmScannersConfigurationExclusionTags | undefined;
	readonly scanningMode?: "Default" | undefined;
}
export interface DefenderCspmAwsOfferingVmScannersConfigurationExclusionTags {
...
export interface DefenderForServersAwsOfferingVmScannersConfiguration {
	readonly cloudRoleArn?: string | undefined;
	readonly exclusionTags?: DefenderForServersAwsOfferingVmScannersConfigurationExclusionTags | undefined;
	readonly scanningMode?: "Default" | undefined;
}
export interface DefenderForServersAwsOfferingVmScannersConfigurationExclusionTags {
	readonly "[ key: string ]"?: string | undefined;
}
