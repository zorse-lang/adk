...
export class fleets extends ArmResource<fleetsComponentInputs> implements fleetsComponentOutputs {
	constructor(entity: ADKEntity, options: fleetsComponentInputs) {
		super(entity, options.name, "Microsoft.ContainerService/fleets", "2022-09-02-preview", options);
	}
	public readonly apiVersion: "2022-09-02-preview";
	public readonly id: string;
	public readonly type: "Microsoft.ContainerService/fleets";
}
export interface fleetsComponentOutputs {
	readonly apiVersion: "2022-09-02-preview";
	readonly id: string;
...
export class fleets_members extends ArmResource<fleets_membersComponentInputs> implements fleets_membersComponentOutputs {
	constructor(entity: ADKEntity, options: fleets_membersComponentInputs) {
		super(entity, options.name, "Microsoft.ContainerService/fleets/members", "2022-09-02-preview", options);
	}
	public readonly apiVersion: "2022-09-02-preview";
	public readonly id: string;
	...
	implements managedClustersComponentOutputs
{
	constructor(entity: ADKEntity, options: managedClustersComponentInputs) {
		super(entity, options.name, "Microsoft.ContainerService/managedClusters", "2022-09-02-preview", options);
	}
	public readonly apiVersion: "2022-09-02-preview";
	public readonly id: string;
	...
	implements managedClusters_agentPoolsComponentOutputs
{
	constructor(entity: ADKEntity, options: managedClusters_agentPoolsComponentInputs) {
		super(entity, options.name, "Microsoft.ContainerService/managedClusters/agentPools", "2022-09-02-preview", options);
	}
	public readonly apiVersion: "2022-09-02-preview";
	public readonly id: string;
	...
	implements managedclustersnapshotsComponentOutputs
{
	constructor(entity: ADKEntity, options: managedclustersnapshotsComponentInputs) {
		super(entity, options.name, "Microsoft.ContainerService/managedclustersnapshots", "2022-09-02-preview", options);
	}
	public readonly apiVersion: "2022-09-02-preview";
	public readonly id: string;
...
export class snapshots extends ArmResource<snapshotsComponentInputs> implements snapshotsComponentOutputs {
	constructor(entity: ADKEntity, options: snapshotsComponentInputs) {
		super(entity, options.name, "Microsoft.ContainerService/snapshots", "2022-09-02-preview", options);
	}
	public readonly apiVersion: "2022-09-02-preview";
	public readonly id: string;
...
export function listClusterAdminCredential(resource: managedClusters): CredentialResults {
	if (resource.apiVersion !== "2022-09-02-preview") {
...
export interface AgentPoolNetworkProfile {
	readonly allowedHostPorts?: PortRange[] | undefined;
	readonly applicationSecurityGroups?: string[] | undefined;
	readonly nodePublicIPTags?: IPTag[] | undefined;
}
export interface AgentPoolUpgradeSettings {
	readonly maxSurge?: string | undefined;
}
export interface AgentPoolWindowsProfile {
	readonly disableOutboundNat?: boolean | undefined;
}
...
export interface ContainerServiceNetworkProfile {
	...
	readonly ebpfDataplane?: "cilium" | undefined;
	readonly ipFamilies?: ("IPv4" | "IPv6"[]) | undefined;
	readonly kubeProxyConfig?: ContainerServiceNetworkProfileKubeProxyConfig | undefined;
...
export interface ContainerServiceNetworkProfileKubeProxyConfig {
	readonly enabled?: boolean | undefined;
	readonly ipvsConfig?: ContainerServiceNetworkProfileKubeProxyConfigIpvsConfig | undefined;
	readonly mode?: ("IPTABLES" | "IPVS") | undefined;
}
export interface ContainerServiceNetworkProfileKubeProxyConfigIpvsConfig {
	readonly scheduler?: ("LeastConnection" | "RoundRobin") | undefined;
	readonly tcpFinTimeoutSeconds?: number | undefined;
	readonly tcpTimeoutSeconds?: number | undefined;
	readonly udpTimeoutSeconds?: number | undefined;
}
...
export interface GuardrailsProfile {
	readonly excludedNamespaces?: string[] | undefined;
	readonly level: "Enforcement" | "Off" | "Warning";
	readonly systemExcludedNamespaces?: string[] | undefined;
...
export interface ManagedClusterAgentPoolProfile {
	...
	readonly name: string;
	readonly networkProfile?: AgentPoolNetworkProfile | undefined;
	...
	readonly osSKU?: ("CBLMariner" | "Mariner" | "Ubuntu" | "Windows2019" | "Windows2022") | undefined;
	...
	readonly windowsProfile?: AgentPoolWindowsProfile | undefined;
...
export interface ManagedClusterLoadBalancerProfile {
	...
	readonly backendPoolType?: ("NodeIP" | "NodeIPConfiguration") | undefined;
...
export interface ManagedClusterProperties {
	...
	readonly guardrailsProfile?: GuardrailsProfile | undefined;
...
export interface ManagedClusterSecurityProfile {
	...
	readonly customCATrustCertificates?: any[] | undefined;
...
export interface PortRange {
	readonly portEnd?: number | undefined;
	readonly portStart?: number | undefined;
