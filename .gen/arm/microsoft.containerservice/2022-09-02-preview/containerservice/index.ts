...
export interface fleetsComponentInputs {
	...
	readonly properties?: FleetProperties;
...
export interface fleets_membersComponentInputs {
	readonly etag?: string;
	readonly name: string;
	readonly properties?: FleetMemberProperties;
	readonly systemData?: SystemData;
}
...
export interface AgentPoolWindowsProfile {
	readonly disableOutboundNat?: boolean;
}
...
export interface ContainerServiceNetworkProfile {
	...
	readonly ebpfDataplane?: "cilium";
	readonly ipFamilies?: "IPv4" | "IPv6"[];
	readonly kubeProxyConfig?: ContainerServiceNetworkProfileKubeProxyConfig;
...
export interface ContainerServiceNetworkProfileKubeProxyConfig {
	readonly enabled?: boolean;
	readonly ipvsConfig?: ContainerServiceNetworkProfileKubeProxyConfigIpvsConfig;
	readonly mode?: "IPTABLES" | "IPVS";
}
export interface ContainerServiceNetworkProfileKubeProxyConfigIpvsConfig {
	readonly scheduler?: "LeastConnection" | "RoundRobin";
	readonly tcpFinTimeoutSeconds?: number;
...
export interface FleetMemberProperties {
	...
	readonly provisioningState?: "Canceled" | "Failed" | "Joining" | "Leaving" | "Succeeded" | "Updating";
}
export interface FleetProperties {
	readonly hubProfile?: FleetHubProfile;
...
export interface ManagedClusterAgentPoolProfile {
	...
	readonly osSKU?: "CBLMariner" | "Mariner" | "Ubuntu" | "Windows2019" | "Windows2022";
	...
	readonly windowsProfile?: AgentPoolWindowsProfile;
...
export interface ManagedClusterProperties {
	...
	readonly guardrailsProfile?: GuardrailsProfile;
...
export interface ManagedClusterWorkloadAutoScalerProfile {
	...
	readonly verticalPodAutoscaler?: ManagedClusterWorkloadAutoScalerProfileVerticalPodAutoscaler;
}
