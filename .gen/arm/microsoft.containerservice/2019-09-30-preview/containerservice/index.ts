	...
	implements openShiftManagedClustersComponentOutputs
{
	constructor(entity: ADKEntity, options: openShiftManagedClustersComponentInputs) {
		super(entity, options.name, "Microsoft.ContainerService/openShiftManagedClusters", "2019-09-30-preview", options);
	}
	public readonly apiVersion: "2019-09-30-preview";
...
export interface openShiftManagedClustersComponentOutputs {
	readonly apiVersion: "2019-09-30-preview";
	readonly id: string;
