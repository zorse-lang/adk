...
export class Spring extends ArmResource<SpringComponentInputs> implements SpringComponentOutputs {
	constructor(entity: ADKEntity, options: SpringComponentInputs) {
		super(entity, options.name, "Microsoft.AppPlatform/Spring", "2022-11-01-preview", options);
	}
	...
	implements Spring_apiPortalsComponentOutputs
{
	constructor(entity: ADKEntity, options: Spring_apiPortalsComponentInputs) {
		super(entity, options.name, "Microsoft.AppPlatform/Spring/apiPortals", "2022-11-01-preview", options);
	}
	public readonly apiVersion: "2022-11-01-preview";
	public readonly id: string;
	...
	implements Spring_apiPortals_domainsComponentOutputs
{
	constructor(entity: ADKEntity, options: Spring_apiPortals_domainsComponentInputs) {
		super(entity, options.name, "Microsoft.AppPlatform/Spring/apiPortals/domains", "2022-11-01-preview", options);
	}
	public readonly apiVersion: "2022-11-01-preview";
	public readonly id: string;
...
export class Spring_applicationAccelerators
	extends ArmResource<Spring_applicationAcceleratorsComponentInputs>
	implements Spring_applicationAcceleratorsComponentOutputs
{
	constructor(entity: ADKEntity, options: Spring_applicationAcceleratorsComponentInputs) {
		super(entity, options.name, "Microsoft.AppPlatform/Spring/applicationAccelerators", "2022-11-01-preview", options);
	}
	public readonly apiVersion: "2022-11-01-preview";
	public readonly id: string;
	public readonly type: "Microsoft.AppPlatform/Spring/applicationAccelerators";
}
export interface Spring_applicationAcceleratorsComponentOutputs {
	readonly apiVersion: "2022-11-01-preview";
	readonly id: string;
	readonly type: "Microsoft.AppPlatform/Spring/applicationAccelerators";
}
export interface Spring_applicationAcceleratorsComponentInputs {
	readonly name: string;
	readonly properties?: ApplicationAcceleratorProperties | undefined;
	readonly sku?: Sku | undefined;
	readonly systemData?: SystemData | undefined;
}
export class Spring_applicationAccelerators_customizedAccelerators
	extends ArmResource<Spring_applicationAccelerators_customizedAcceleratorsComponentInputs>
	implements Spring_applicationAccelerators_customizedAcceleratorsComponentOutputs
{
	constructor(entity: ADKEntity, options: Spring_applicationAccelerators_customizedAcceleratorsComponentInputs) {
		super(
			entity,
			options.name,
	...
	public readonly apiVersion: "2022-11-01-preview";
	public readonly id: string;
	public readonly type: "Microsoft.AppPlatform/Spring/applicationAccelerators/customizedAccelerators";
}
export interface Spring_applicationAccelerators_customizedAcceleratorsComponentOutputs {
	readonly apiVersion: "2022-11-01-preview";
	readonly id: string;
	readonly type: "Microsoft.AppPlatform/Spring/applicationAccelerators/customizedAccelerators";
}
export interface Spring_applicationAccelerators_customizedAcceleratorsComponentInputs {
	readonly name: string;
	readonly properties?: CustomizedAcceleratorProperties | undefined;
	readonly sku?: Sku | undefined;
	readonly systemData?: SystemData | undefined;
}
export class Spring_applicationAccelerators_predefinedAccelerators
	extends ArmResource<Spring_applicationAccelerators_predefinedAcceleratorsComponentInputs>
	implements Spring_applicationAccelerators_predefinedAcceleratorsComponentOutputs
{
	constructor(entity: ADKEntity, options: Spring_applicationAccelerators_predefinedAcceleratorsComponentInputs) {
		super(
			entity,
			options.name,
	...
	public readonly apiVersion: "2022-11-01-preview";
	public readonly id: string;
	public readonly type: "Microsoft.AppPlatform/Spring/applicationAccelerators/predefinedAccelerators";
}
export interface Spring_applicationAccelerators_predefinedAcceleratorsComponentOutputs {
	readonly apiVersion: "2022-11-01-preview";
	readonly id: string;
	readonly type: "Microsoft.AppPlatform/Spring/applicationAccelerators/predefinedAccelerators";
}
export interface Spring_applicationAccelerators_predefinedAcceleratorsComponentInputs {
	readonly name: string;
	readonly properties?: PredefinedAcceleratorProperties | undefined;
	readonly sku?: Sku | undefined;
	readonly systemData?: SystemData | undefined;
}
export class Spring_applicationLiveViews
	extends ArmResource<Spring_applicationLiveViewsComponentInputs>
	implements Spring_applicationLiveViewsComponentOutputs
{
	constructor(entity: ADKEntity, options: Spring_applicationLiveViewsComponentInputs) {
		super(entity, options.name, "Microsoft.AppPlatform/Spring/applicationLiveViews", "2022-11-01-preview", options);
	}
	public readonly apiVersion: "2022-11-01-preview";
	public readonly id: string;
	public readonly type: "Microsoft.AppPlatform/Spring/applicationLiveViews";
}
export interface Spring_applicationLiveViewsComponentOutputs {
	readonly apiVersion: "2022-11-01-preview";
	readonly id: string;
	readonly type: "Microsoft.AppPlatform/Spring/applicationLiveViews";
}
export interface Spring_applicationLiveViewsComponentInputs {
	readonly name: string;
	readonly properties?: ApplicationLiveViewProperties | undefined;
	readonly systemData?: SystemData | undefined;
}
export class Spring_apps extends ArmResource<Spring_appsComponentInputs> implements Spring_appsComponentOutputs {
	constructor(entity: ADKEntity, options: Spring_appsComponentInputs) {
		super(entity, options.name, "Microsoft.AppPlatform/Spring/apps", "2022-11-01-preview", options);
	}
	public readonly apiVersion: "2022-11-01-preview";
	public readonly id: string;
	...
	implements Spring_apps_bindingsComponentOutputs
{
	constructor(entity: ADKEntity, options: Spring_apps_bindingsComponentInputs) {
		super(entity, options.name, "Microsoft.AppPlatform/Spring/apps/bindings", "2022-11-01-preview", options);
	}
	public readonly apiVersion: "2022-11-01-preview";
	public readonly id: string;
	...
	implements Spring_apps_deploymentsComponentOutputs
{
	constructor(entity: ADKEntity, options: Spring_apps_deploymentsComponentInputs) {
		super(entity, options.name, "Microsoft.AppPlatform/Spring/apps/deployments", "2022-11-01-preview", options);
	}
	public readonly apiVersion: "2022-11-01-preview";
	public readonly id: string;
	...
	implements Spring_apps_domainsComponentOutputs
{
	constructor(entity: ADKEntity, options: Spring_apps_domainsComponentInputs) {
		super(entity, options.name, "Microsoft.AppPlatform/Spring/apps/domains", "2022-11-01-preview", options);
	}
	public readonly apiVersion: "2022-11-01-preview";
	public readonly id: string;
	...
	implements Spring_buildServicesComponentOutputs
{
	constructor(entity: ADKEntity, options: Spring_buildServicesComponentInputs) {
		super(entity, options.name, "Microsoft.AppPlatform/Spring/buildServices", "2022-11-01-preview", options);
	}
	public readonly apiVersion: "2022-11-01-preview";
	public readonly id: string;
	...
	implements Spring_buildServices_agentPoolsComponentOutputs
{
	constructor(entity: ADKEntity, options: Spring_buildServices_agentPoolsComponentInputs) {
		super(entity, options.name, "Microsoft.AppPlatform/Spring/buildServices/agentPools", "2022-11-01-preview", options);
	}
	public readonly apiVersion: "2022-11-01-preview";
	public readonly id: string;
	...
	implements Spring_buildServices_buildersComponentOutputs
{
	constructor(entity: ADKEntity, options: Spring_buildServices_buildersComponentInputs) {
		super(entity, options.name, "Microsoft.AppPlatform/Spring/buildServices/builders", "2022-11-01-preview", options);
	}
	public readonly apiVersion: "2022-11-01-preview";
	public readonly id: string;
	...
	implements Spring_buildServices_buildsComponentOutputs
{
	constructor(entity: ADKEntity, options: Spring_buildServices_buildsComponentInputs) {
		super(entity, options.name, "Microsoft.AppPlatform/Spring/buildServices/builds", "2022-11-01-preview", options);
	}
	public readonly apiVersion: "2022-11-01-preview";
	public readonly id: string;
	...
	implements Spring_certificatesComponentOutputs
{
	constructor(entity: ADKEntity, options: Spring_certificatesComponentInputs) {
		super(entity, options.name, "Microsoft.AppPlatform/Spring/certificates", "2022-11-01-preview", options);
	}
	public readonly apiVersion: "2022-11-01-preview";
	public readonly id: string;
	...
	implements Spring_configServersComponentOutputs
{
	constructor(entity: ADKEntity, options: Spring_configServersComponentInputs) {
		super(entity, options.name, "Microsoft.AppPlatform/Spring/configServers", "2022-11-01-preview", options);
	}
	public readonly apiVersion: "2022-11-01-preview";
	public readonly id: string;
	...
	implements Spring_configurationServicesComponentOutputs
{
	constructor(entity: ADKEntity, options: Spring_configurationServicesComponentInputs) {
		super(entity, options.name, "Microsoft.AppPlatform/Spring/configurationServices", "2022-11-01-preview", options);
	}
	public readonly apiVersion: "2022-11-01-preview";
	public readonly id: string;
...
export class Spring_DevToolPortals
	extends ArmResource<Spring_DevToolPortalsComponentInputs>
	implements Spring_DevToolPortalsComponentOutputs
{
	constructor(entity: ADKEntity, options: Spring_DevToolPortalsComponentInputs) {
		super(entity, options.name, "Microsoft.AppPlatform/Spring/DevToolPortals", "2022-11-01-preview", options);
	}
	public readonly apiVersion: "2022-11-01-preview";
	public readonly id: string;
	public readonly type: "Microsoft.AppPlatform/Spring/DevToolPortals";
}
export interface Spring_DevToolPortalsComponentOutputs {
	readonly apiVersion: "2022-11-01-preview";
	readonly id: string;
	readonly type: "Microsoft.AppPlatform/Spring/DevToolPortals";
}
export interface Spring_DevToolPortalsComponentInputs {
	readonly name: string;
	readonly properties?: DevToolPortalProperties | undefined;
	readonly systemData?: SystemData | undefined;
}
	...
	implements Spring_gatewaysComponentOutputs
{
	constructor(entity: ADKEntity, options: Spring_gatewaysComponentInputs) {
		super(entity, options.name, "Microsoft.AppPlatform/Spring/gateways", "2022-11-01-preview", options);
	}
	public readonly apiVersion: "2022-11-01-preview";
	public readonly id: string;
	...
	implements Spring_gateways_domainsComponentOutputs
{
	constructor(entity: ADKEntity, options: Spring_gateways_domainsComponentInputs) {
		super(entity, options.name, "Microsoft.AppPlatform/Spring/gateways/domains", "2022-11-01-preview", options);
	}
	public readonly apiVersion: "2022-11-01-preview";
	public readonly id: string;
	...
	implements Spring_gateways_routeConfigsComponentOutputs
{
	constructor(entity: ADKEntity, options: Spring_gateways_routeConfigsComponentInputs) {
		super(entity, options.name, "Microsoft.AppPlatform/Spring/gateways/routeConfigs", "2022-11-01-preview", options);
	}
	public readonly apiVersion: "2022-11-01-preview";
	public readonly id: string;
	...
	implements Spring_monitoringSettingsComponentOutputs
{
	constructor(entity: ADKEntity, options: Spring_monitoringSettingsComponentInputs) {
		super(entity, options.name, "Microsoft.AppPlatform/Spring/monitoringSettings", "2022-11-01-preview", options);
	}
	public readonly apiVersion: "2022-11-01-preview";
	public readonly id: string;
	...
	implements Spring_serviceRegistriesComponentOutputs
{
	constructor(entity: ADKEntity, options: Spring_serviceRegistriesComponentInputs) {
		super(entity, options.name, "Microsoft.AppPlatform/Spring/serviceRegistries", "2022-11-01-preview", options);
	}
	public readonly apiVersion: "2022-11-01-preview";
	public readonly id: string;
	...
	implements Spring_storagesComponentOutputs
{
	constructor(entity: ADKEntity, options: Spring_storagesComponentInputs) {
		super(entity, options.name, "Microsoft.AppPlatform/Spring/storages", "2022-11-01-preview", options);
	}
	public readonly apiVersion: "2022-11-01-preview";
	public readonly id: string;
...
export function listEnvSecrets(resource: Spring_gateways): GatewayEnvSecrets {
	if (resource.apiVersion !== "2022-11-01-preview") {
		throw new Error(`listEnvSecrets is not available for api version ${resource.apiVersion}`);
	}
	if (resource.type !== "Microsoft.AppPlatform/Spring/gateways") {
		throw new Error(`listEnvSecrets is not available for resource type ${resource.type}`);
	}
...
export function listUsingDeployments(resource: Spring_buildServices_builders): DeploymentList {
	if (resource.apiVersion !== "2022-11-01-preview") {
		throw new Error(`listUsingDeployments is not available for api version ${resource.apiVersion}`);
	}
	if (resource.type !== "Microsoft.AppPlatform/Spring/buildServices/builders") {
		throw new Error(`listUsingDeployments is not available for resource type ${resource.type}`);
	}
	throw new Error("not implemented");
}
...
export interface ApplicationAcceleratorComponent {
	readonly instances?: ApplicationAcceleratorInstance[] | undefined;
	readonly name?: string | undefined;
	readonly resourceRequests?: ApplicationAcceleratorResourceRequests | undefined;
}
...
export interface ApplicationAcceleratorProperties {
	readonly components?: ApplicationAcceleratorComponent[] | undefined;
	readonly provisioningState?: ("Creating" | "Deleting" | "Failed" | "Succeeded" | "Updating") | undefined;
}
...
export interface ApplicationLiveViewComponent {
	readonly instances?: ApplicationLiveViewInstance[] | undefined;
	readonly name?: any | undefined;
	readonly resourceRequests?: ApplicationLiveViewResourceRequests | undefined;
}
...
export interface ApplicationLiveViewProperties {
	readonly components?: ApplicationLiveViewComponent[] | undefined;
...
export interface AppResourceProperties {
	...
	readonly httpsOnly?: boolean | undefined;
	readonly ingressSettings?: IngressSettings | undefined;
	...
	readonly url?: string | undefined;
	readonly vnetAddons?: AppVNetAddons | undefined;
}
...
export interface AppVNetAddons {
	readonly publicEndpoint?: boolean | undefined;
	readonly publicEndpointUrl?: string | undefined;
}
...
export interface BuildProperties {
	...
	readonly resourceRequests?: BuildResourceRequests | undefined;
...
export interface ClusterResourceProperties {
	readonly fqdn?: string | undefined;
	readonly marketplaceResource?: MarketplaceResource | undefined;
	...
	readonly vnetAddons?: ServiceVNetAddons | undefined;
...
export interface CustomContainer {
	...
	readonly languageFramework?: string | undefined;
...
export interface CustomizedAcceleratorProperties {
	readonly acceleratorTags?: string[] | undefined;
...
export interface DeploymentSettings {
	...
	readonly livenessProbe?: Probe | undefined;
	readonly readinessProbe?: Probe | undefined;
	readonly resourceRequests?: ResourceRequests | undefined;
	readonly startupProbe?: Probe | undefined;
...
export interface DevToolPortalFeatureSettings {
	readonly applicationAccelerator?: DevToolPortalFeatureDetail | undefined;
	readonly applicationLiveView?: DevToolPortalFeatureDetail | undefined;
}
...
export interface DevToolPortalProperties {
	readonly features?: DevToolPortalFeatureSettings | undefined;
	readonly instances?: DevToolPortalInstance[] | undefined;
	readonly provisioningState?: ("Canceled" | "Creating" | "Deleting" | "Failed" | "Succeeded" | "Updating") | undefined;
	readonly public?: boolean | undefined;
	readonly resourceRequests?: DevToolPortalResourceRequests | undefined;
	readonly ssoProperties?: DevToolPortalSsoProperties | undefined;
	readonly url?: string | undefined;
}
...
export interface GatewayProperties {
	...
	readonly apmTypes?: ("AppDynamics" | "ApplicationInsights" | "Dynatrace" | "ElasticAPM" | "NewRelic"[]) | undefined;
	readonly corsProperties?: GatewayCorsProperties | undefined;
	readonly environmentVariables?: GatewayPropertiesEnvironmentVariables | undefined;
	readonly httpsOnly?: boolean | undefined;
	readonly instances?: GatewayInstance[] | undefined;
...
export interface GatewayPropertiesEnvironmentVariables {
	readonly properties?: GatewayPropertiesEnvironmentVariablesProperties | undefined;
	readonly secrets?: GatewayPropertiesEnvironmentVariablesSecrets | undefined;
}
export interface GatewayPropertiesEnvironmentVariablesProperties {
	readonly "[ key: string ]"?: string | undefined;
}
export interface GatewayPropertiesEnvironmentVariablesSecrets {
	readonly "[ key: string ]"?: string | undefined;
}
...
export interface GatewayRouteConfigProperties {
	...
	readonly filters?: string[] | undefined;
	readonly openApi?: GatewayRouteConfigOpenApiProperties | undefined;
	readonly predicates?: string[] | undefined;
...
export interface IngressConfig {
	readonly readTimeoutInSeconds?: number | undefined;
}
export interface IngressSettings {
	readonly backendProtocol?: ("Default" | "GRPC") | undefined;
	readonly clientAuth?: IngressSettingsClientAuth | undefined;
	readonly readTimeoutInSeconds?: number | undefined;
	readonly sendTimeoutInSeconds?: number | undefined;
	readonly sessionAffinity?: ("Cookie" | "None") | undefined;
	readonly sessionCookieMaxAge?: number | undefined;
}
export interface IngressSettingsClientAuth {
	readonly certificates?: string[] | undefined;
}
...
export interface NetworkProfile {
	...
	readonly outboundType?: string | undefined;
...
export interface Probe {
	...
	readonly probeAction?: ProbeAction | undefined;
...
export interface ServiceVNetAddons {
	readonly logStreamPublicEndpoint?: boolean | undefined;
}
...
export default {
	...
	"Spring/applicationAccelerators": Spring_applicationAccelerators,
	"Spring/applicationAccelerators/customizedAccelerators": Spring_applicationAccelerators_customizedAccelerators,
	"Spring/applicationAccelerators/predefinedAccelerators": Spring_applicationAccelerators_predefinedAccelerators,
	"Spring/applicationLiveViews": Spring_applicationLiveViews,
	...
	"Spring/DevToolPortals": Spring_DevToolPortals,
