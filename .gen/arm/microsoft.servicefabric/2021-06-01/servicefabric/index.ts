...
export class clusters extends ArmResource<clustersComponentInputs> implements clustersComponentOutputs {
	constructor(entity: ADKEntity, options: clustersComponentInputs) {
		super(entity, options.name, "Microsoft.ServiceFabric/clusters", "2021-06-01", options);
	}
	...
	implements clusters_applicationsComponentOutputs
{
	constructor(entity: ADKEntity, options: clusters_applicationsComponentInputs) {
		super(entity, options.name, "Microsoft.ServiceFabric/clusters/applications", "2021-06-01", options);
	}
	public readonly apiVersion: "2021-06-01";
	public readonly id: string;
	...
	implements clusters_applications_servicesComponentOutputs
{
	constructor(entity: ADKEntity, options: clusters_applications_servicesComponentInputs) {
		super(entity, options.name, "Microsoft.ServiceFabric/clusters/applications/services", "2021-06-01", options);
	}
	public readonly apiVersion: "2021-06-01";
	public readonly id: string;
	...
	implements clusters_applicationTypesComponentOutputs
{
	constructor(entity: ADKEntity, options: clusters_applicationTypesComponentInputs) {
		super(entity, options.name, "Microsoft.ServiceFabric/clusters/applicationTypes", "2021-06-01", options);
	}
	public readonly apiVersion: "2021-06-01";
	public readonly id: string;
	...
	implements clusters_applicationTypes_versionsComponentOutputs
{
	constructor(entity: ADKEntity, options: clusters_applicationTypes_versionsComponentInputs) {
		super(entity, options.name, "Microsoft.ServiceFabric/clusters/applicationTypes/versions", "2021-06-01", options);
	}
	public readonly apiVersion: "2021-06-01";
	public readonly id: string;
...
export interface ClusterProperties {
	...
	readonly infrastructureServiceManager?: boolean | undefined;
	...
	readonly sfZonalUpgradeMode?: ("Hierarchical" | "Parallel") | undefined;
	readonly upgradeDescription?: ClusterUpgradePolicy | undefined;
	readonly upgradeMode?: ("Automatic" | "Manual") | undefined;
	readonly upgradePauseEndTimestampUtc?: string | undefined;
	readonly upgradePauseStartTimestampUtc?: string | undefined;
	readonly upgradeWave?: ("Wave0" | "Wave1" | "Wave2") | undefined;
	readonly vmImage?: string | undefined;
	readonly vmssZonalUpgradeMode?: ("Hierarchical" | "Parallel") | undefined;
	readonly waveUpgradePaused?: boolean | undefined;
}
...
export interface NodeTypeDescription {
	...
	readonly multipleAvailabilityZones?: boolean | undefined;
	readonly name: string;
...
export interface UpgradableVersionPathResult {
	readonly supportedPath?: string[] | undefined;
}
