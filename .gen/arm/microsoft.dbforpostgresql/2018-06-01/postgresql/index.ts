	...
	implements servers_advisorsComponentOutputs
{
	constructor(entity: ADKEntity, options: servers_advisorsComponentInputs) {
		super(entity, options.name, "Microsoft.DBforPostgreSQL/servers/advisors", "2018-06-01", options);
	}
	public readonly apiVersion: "2018-06-01";
	public readonly id: string;
	public readonly type: "Microsoft.DBforPostgreSQL/servers/advisors";
}
export interface servers_advisorsComponentOutputs {
	readonly apiVersion: "2018-06-01";
	readonly id: string;
	readonly type: "Microsoft.DBforPostgreSQL/servers/advisors";
}
	...
	implements servers_advisors_recommendedActionsComponentOutputs
{
	constructor(entity: ADKEntity, options: servers_advisors_recommendedActionsComponentInputs) {
		super(entity, options.name, "Microsoft.DBforPostgreSQL/servers/advisors/recommendedActions", "2018-06-01", options);
	}
	public readonly apiVersion: "2018-06-01";
	public readonly id: string;
	public readonly type: "Microsoft.DBforPostgreSQL/servers/advisors/recommendedActions";
}
export interface servers_advisors_recommendedActionsComponentOutputs {
	readonly apiVersion: "2018-06-01";
	readonly id: string;
	readonly type: "Microsoft.DBforPostgreSQL/servers/advisors/recommendedActions";
}
	...
	implements servers_privateEndpointConnectionsComponentOutputs
{
	constructor(entity: ADKEntity, options: servers_privateEndpointConnectionsComponentInputs) {
		super(entity, options.name, "Microsoft.DBforPostgreSQL/servers/privateEndpointConnections", "2018-06-01", options);
	}
	public readonly apiVersion: "2018-06-01";
	public readonly id: string;
	public readonly type: "Microsoft.DBforPostgreSQL/servers/privateEndpointConnections";
}
export interface servers_privateEndpointConnectionsComponentOutputs {
	readonly apiVersion: "2018-06-01";
	readonly id: string;
	readonly type: "Microsoft.DBforPostgreSQL/servers/privateEndpointConnections";
}
	...
	implements servers_privateLinkResourcesComponentOutputs
{
	constructor(entity: ADKEntity, options: servers_privateLinkResourcesComponentInputs) {
		super(entity, options.name, "Microsoft.DBforPostgreSQL/servers/privateLinkResources", "2018-06-01", options);
	}
	public readonly apiVersion: "2018-06-01";
	public readonly id: string;
	public readonly type: "Microsoft.DBforPostgreSQL/servers/privateLinkResources";
}
export interface servers_privateLinkResourcesComponentOutputs {
	readonly apiVersion: "2018-06-01";
	readonly id: string;
	readonly type: "Microsoft.DBforPostgreSQL/servers/privateLinkResources";
}
	...
	implements servers_queryTextsComponentOutputs
{
	constructor(entity: ADKEntity, options: servers_queryTextsComponentInputs) {
		super(entity, options.name, "Microsoft.DBforPostgreSQL/servers/queryTexts", "2018-06-01", options);
	}
	public readonly apiVersion: "2018-06-01";
	public readonly id: string;
	public readonly type: "Microsoft.DBforPostgreSQL/servers/queryTexts";
}
export interface servers_queryTextsComponentOutputs {
	readonly apiVersion: "2018-06-01";
	readonly id: string;
	readonly type: "Microsoft.DBforPostgreSQL/servers/queryTexts";
}
	...
	implements servers_topQueryStatisticsComponentOutputs
{
	constructor(entity: ADKEntity, options: servers_topQueryStatisticsComponentInputs) {
		super(entity, options.name, "Microsoft.DBforPostgreSQL/servers/topQueryStatistics", "2018-06-01", options);
	}
	public readonly apiVersion: "2018-06-01";
	public readonly id: string;
	public readonly type: "Microsoft.DBforPostgreSQL/servers/topQueryStatistics";
}
export interface servers_topQueryStatisticsComponentOutputs {
	readonly apiVersion: "2018-06-01";
	readonly id: string;
	readonly type: "Microsoft.DBforPostgreSQL/servers/topQueryStatistics";
}
	...
	implements servers_waitStatisticsComponentOutputs
{
	constructor(entity: ADKEntity, options: servers_waitStatisticsComponentInputs) {
		super(entity, options.name, "Microsoft.DBforPostgreSQL/servers/waitStatistics", "2018-06-01", options);
	}
	public readonly apiVersion: "2018-06-01";
	public readonly id: string;
	public readonly type: "Microsoft.DBforPostgreSQL/servers/waitStatistics";
}
export interface servers_waitStatisticsComponentOutputs {
	readonly apiVersion: "2018-06-01";
	readonly id: string;
	readonly type: "Microsoft.DBforPostgreSQL/servers/waitStatistics";
}
