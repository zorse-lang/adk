...
export class backupVaults extends ArmResource<backupVaultsComponentInputs> implements backupVaultsComponentOutputs {
	constructor(entity: ADKEntity, options: backupVaultsComponentInputs) {
		super(entity, options.name, "Microsoft.DataProtection/backupVaults", "2022-10-01-preview", options);
	}
	...
	implements backupVaults_backupInstancesComponentOutputs
{
	constructor(entity: ADKEntity, options: backupVaults_backupInstancesComponentInputs) {
		super(entity, options.name, "Microsoft.DataProtection/backupVaults/backupInstances", "2022-10-01-preview", options);
	}
	public readonly apiVersion: "2022-10-01-preview";
	public readonly id: string;
...
export interface backupVaults_backupInstancesComponentInputs {
	...
	readonly systemData?: SystemData | undefined;
	readonly tags?: DppProxyResourceTags | undefined;
}
	...
	implements backupVaults_backupJobsComponentOutputs
{
	constructor(entity: ADKEntity, options: backupVaults_backupJobsComponentInputs) {
		super(entity, options.name, "Microsoft.DataProtection/backupVaults/backupJobs", "2022-10-01-preview", options);
	}
	public readonly apiVersion: "2022-10-01-preview";
	public readonly id: string;
	...
	implements backupVaults_backupPoliciesComponentOutputs
{
	constructor(entity: ADKEntity, options: backupVaults_backupPoliciesComponentInputs) {
		super(entity, options.name, "Microsoft.DataProtection/backupVaults/backupPolicies", "2022-10-01-preview", options);
	}
	public readonly apiVersion: "2022-10-01-preview";
	public readonly id: string;
...
export interface backupVaults_deletedBackupInstancesComponentInputs {
	readonly name: string;
	readonly properties?: DeletedBackupInstance | undefined;
	readonly systemData?: SystemData | undefined;
}
...
export class resourceGuards extends ArmResource<resourceGuardsComponentInputs> implements resourceGuardsComponentOutputs {
	constructor(entity: ADKEntity, options: resourceGuardsComponentInputs) {
		super(entity, options.name, "Microsoft.DataProtection/resourceGuards", "2022-10-01-preview", options);
	}
	public readonly apiVersion: "2022-10-01-preview";
	public readonly id: string;
...
export interface BackupVault {
	readonly isVaultProtectedByResourceGuard?: boolean | undefined;
...
export interface DeletedBackupInstance {
	...
	readonly dataSourceInfo: Datasource;
	readonly dataSourceSetInfo?: DatasourceSet | undefined;
	readonly deletionInfo?: DeletionInfo | undefined;
	readonly friendlyName?: string | undefined;
	readonly objectType: string;
	readonly policyInfo: PolicyInfo;
	readonly protectionErrorDetails?: UserFacingError | undefined;
...
export interface DeletionInfo {
	readonly billingEndDate?: string | undefined;
	readonly deleteActivityID?: string | undefined;
	readonly deletionTime?: string | undefined;
	readonly scheduledPurgeTime?: string | undefined;
}
...
export interface PolicyParameters {
	readonly backupDatasourceParametersList?: BackupDatasourceParameters[] | undefined;
...
export interface SecuritySettings {
	...
	readonly softDeleteSettings?: SoftDeleteSettings | undefined;
}
export interface SoftDeleteSettings {
	readonly retentionDurationInDays?: number | undefined;
	readonly state?: ("AlwaysOn" | "Off" | "On") | undefined;
}
...
export interface StorageSetting {
	...
	readonly type?: ("GeoRedundant" | "LocallyRedundant" | "ZoneRedundant") | undefined;
}
