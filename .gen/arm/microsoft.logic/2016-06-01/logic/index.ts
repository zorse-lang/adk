	...
	implements integrationAccountsComponentOutputs
{
	constructor(entity: ADKEntity, options: integrationAccountsComponentInputs) {
		super(entity, options.name, "Microsoft.Logic/integrationAccounts", "2016-06-01", options);
	}
	...
	implements integrationAccounts_agreementsComponentOutputs
{
	constructor(entity: ADKEntity, options: integrationAccounts_agreementsComponentInputs) {
		super(entity, options.name, "Microsoft.Logic/integrationAccounts/agreements", "2016-06-01", options);
	}
	public readonly apiVersion: "2016-06-01";
	public readonly id: string;
	...
	implements integrationAccounts_assembliesComponentOutputs
{
	constructor(entity: ADKEntity, options: integrationAccounts_assembliesComponentInputs) {
		super(entity, options.name, "Microsoft.Logic/integrationAccounts/assemblies", "2016-06-01", options);
	}
	public readonly apiVersion: "2016-06-01";
	public readonly id: string;
	...
	implements integrationAccounts_batchConfigurationsComponentOutputs
{
	constructor(entity: ADKEntity, options: integrationAccounts_batchConfigurationsComponentInputs) {
		super(entity, options.name, "Microsoft.Logic/integrationAccounts/batchConfigurations", "2016-06-01", options);
	}
	public readonly apiVersion: "2016-06-01";
	public readonly id: string;
	...
	implements integrationAccounts_certificatesComponentOutputs
{
	constructor(entity: ADKEntity, options: integrationAccounts_certificatesComponentInputs) {
		super(entity, options.name, "Microsoft.Logic/integrationAccounts/certificates", "2016-06-01", options);
	}
	public readonly apiVersion: "2016-06-01";
	public readonly id: string;
	...
	implements integrationAccounts_mapsComponentOutputs
{
	constructor(entity: ADKEntity, options: integrationAccounts_mapsComponentInputs) {
		super(entity, options.name, "Microsoft.Logic/integrationAccounts/maps", "2016-06-01", options);
	}
	public readonly apiVersion: "2016-06-01";
	public readonly id: string;
	...
	implements integrationAccounts_partnersComponentOutputs
{
	constructor(entity: ADKEntity, options: integrationAccounts_partnersComponentInputs) {
		super(entity, options.name, "Microsoft.Logic/integrationAccounts/partners", "2016-06-01", options);
	}
	public readonly apiVersion: "2016-06-01";
	public readonly id: string;
...
export class integrationAccounts_rosettanetprocessconfigurations
	...
	implements integrationAccounts_rosettanetprocessconfigurationsComponentOutputs
{
	constructor(entity: ADKEntity, options: integrationAccounts_rosettanetprocessconfigurationsComponentInputs) {
		super(
			entity,
			options.name,
	...
	public readonly apiVersion: "2016-06-01";
	public readonly id: string;
	public readonly type: "Microsoft.Logic/integrationAccounts/rosettanetprocessconfigurations";
}
export interface integrationAccounts_rosettanetprocessconfigurationsComponentOutputs {
	readonly apiVersion: "2016-06-01";
	readonly id: string;
	...
	implements integrationAccounts_schemasComponentOutputs
{
	constructor(entity: ADKEntity, options: integrationAccounts_schemasComponentInputs) {
		super(entity, options.name, "Microsoft.Logic/integrationAccounts/schemas", "2016-06-01", options);
	}
	public readonly apiVersion: "2016-06-01";
	public readonly id: string;
	...
	implements integrationAccounts_sessionsComponentOutputs
{
	constructor(entity: ADKEntity, options: integrationAccounts_sessionsComponentInputs) {
		super(entity, options.name, "Microsoft.Logic/integrationAccounts/sessions", "2016-06-01", options);
	}
	public readonly apiVersion: "2016-06-01";
	public readonly id: string;
...
export class workflows extends ArmResource<workflowsComponentInputs> implements workflowsComponentOutputs {
	constructor(entity: ADKEntity, options: workflowsComponentInputs) {
		super(entity, options.name, "Microsoft.Logic/workflows", "2016-06-01", options);
	}
	public readonly apiVersion: "2016-06-01";
	public readonly id: string;
...
export class workflows_runs extends ArmResource<workflows_runsComponentInputs> implements workflows_runsComponentOutputs {
	constructor(entity: ADKEntity, options: workflows_runsComponentInputs) {
		super(entity, options.name, "Microsoft.Logic/workflows/runs", "2016-06-01", options);
	}
	public readonly apiVersion: "2016-06-01";
	public readonly id: string;
	...
	implements workflows_runs_actionsComponentOutputs
{
	constructor(entity: ADKEntity, options: workflows_runs_actionsComponentInputs) {
		super(entity, options.name, "Microsoft.Logic/workflows/runs/actions", "2016-06-01", options);
	}
	public readonly apiVersion: "2016-06-01";
	public readonly id: string;
	...
	implements workflows_runs_actions_repetitionsComponentOutputs
{
	constructor(entity: ADKEntity, options: workflows_runs_actions_repetitionsComponentInputs) {
		super(entity, options.name, "Microsoft.Logic/workflows/runs/actions/repetitions", "2016-06-01", options);
	}
	public readonly apiVersion: "2016-06-01";
	public readonly id: string;
	...
	implements workflows_runs_actions_requestHistoriesComponentOutputs
{
	constructor(entity: ADKEntity, options: workflows_runs_actions_requestHistoriesComponentInputs) {
		super(entity, options.name, "Microsoft.Logic/workflows/runs/actions/requestHistories", "2016-06-01", options);
	}
	public readonly apiVersion: "2016-06-01";
	public readonly id: string;
	...
	implements workflows_runs_actions_scopeRepetitionsComponentOutputs
{
	constructor(entity: ADKEntity, options: workflows_runs_actions_scopeRepetitionsComponentInputs) {
		super(entity, options.name, "Microsoft.Logic/workflows/runs/actions/scopeRepetitions", "2016-06-01", options);
	}
	public readonly apiVersion: "2016-06-01";
	public readonly id: string;
	...
	implements workflows_runs_operationsComponentOutputs
{
	constructor(entity: ADKEntity, options: workflows_runs_operationsComponentInputs) {
		super(entity, options.name, "Microsoft.Logic/workflows/runs/operations", "2016-06-01", options);
	}
	public readonly apiVersion: "2016-06-01";
	public readonly id: string;
	...
	implements workflows_triggersComponentOutputs
{
	constructor(entity: ADKEntity, options: workflows_triggersComponentInputs) {
		super(entity, options.name, "Microsoft.Logic/workflows/triggers", "2016-06-01", options);
	}
	public readonly apiVersion: "2016-06-01";
	public readonly id: string;
	...
	implements workflows_triggers_historiesComponentOutputs
{
	constructor(entity: ADKEntity, options: workflows_triggers_historiesComponentInputs) {
		super(entity, options.name, "Microsoft.Logic/workflows/triggers/histories", "2016-06-01", options);
	}
	public readonly apiVersion: "2016-06-01";
	public readonly id: string;
	...
	implements workflows_versionsComponentOutputs
{
	constructor(entity: ADKEntity, options: workflows_versionsComponentInputs) {
		super(entity, options.name, "Microsoft.Logic/workflows/versions", "2016-06-01", options);
	}
	public readonly apiVersion: "2016-06-01";
	public readonly id: string;
...
export interface RosettaNetPipActivityBehavior {
	readonly actionType: "DoubleAction" | "NotSpecified";
	readonly isAuthorizationRequired: boolean;
	readonly isSecuredTransportRequired: boolean;
	readonly nonRepudiationOfOriginAndContent: boolean;
	readonly persistentConfidentialityScope: "None" | "NotSpecified" | "Payload";
	readonly responseType: "Async" | "NotSpecified";
	readonly retryCount: number;
	readonly timeToPerformInSeconds: number;
}
export interface RosettaNetPipActivitySettings {
...
export default {
	...
	"integrationAccounts/rosettanetprocessconfigurations": integrationAccounts_rosettanetprocessconfigurations,
