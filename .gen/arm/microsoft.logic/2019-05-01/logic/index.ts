	...
	implements integrationAccountsComponentOutputs
{
	constructor(entity: ADKEntity, options: integrationAccountsComponentInputs) {
		super(entity, options.name, "Microsoft.Logic/integrationAccounts", "2019-05-01", options);
	}
...
export interface integrationAccountsComponentInputs {
	...
	readonly properties?: IntegrationAccountProperties | undefined;
	...
	implements integrationAccounts_agreementsComponentOutputs
{
	constructor(entity: ADKEntity, options: integrationAccounts_agreementsComponentInputs) {
		super(entity, options.name, "Microsoft.Logic/integrationAccounts/agreements", "2019-05-01", options);
	}
	public readonly apiVersion: "2019-05-01";
	public readonly id: string;
	...
	implements integrationAccounts_assembliesComponentOutputs
{
	constructor(entity: ADKEntity, options: integrationAccounts_assembliesComponentInputs) {
		super(entity, options.name, "Microsoft.Logic/integrationAccounts/assemblies", "2019-05-01", options);
	}
	public readonly apiVersion: "2019-05-01";
	public readonly id: string;
	...
	implements integrationAccounts_batchConfigurationsComponentOutputs
{
	constructor(entity: ADKEntity, options: integrationAccounts_batchConfigurationsComponentInputs) {
		super(entity, options.name, "Microsoft.Logic/integrationAccounts/batchConfigurations", "2019-05-01", options);
	}
	public readonly apiVersion: "2019-05-01";
	public readonly id: string;
	...
	implements integrationAccounts_certificatesComponentOutputs
{
	constructor(entity: ADKEntity, options: integrationAccounts_certificatesComponentInputs) {
		super(entity, options.name, "Microsoft.Logic/integrationAccounts/certificates", "2019-05-01", options);
	}
	public readonly apiVersion: "2019-05-01";
	public readonly id: string;
	...
	implements integrationAccounts_mapsComponentOutputs
{
	constructor(entity: ADKEntity, options: integrationAccounts_mapsComponentInputs) {
		super(entity, options.name, "Microsoft.Logic/integrationAccounts/maps", "2019-05-01", options);
	}
	public readonly apiVersion: "2019-05-01";
	public readonly id: string;
	...
	implements integrationAccounts_partnersComponentOutputs
{
	constructor(entity: ADKEntity, options: integrationAccounts_partnersComponentInputs) {
		super(entity, options.name, "Microsoft.Logic/integrationAccounts/partners", "2019-05-01", options);
	}
	public readonly apiVersion: "2019-05-01";
	public readonly id: string;
	...
	implements integrationAccounts_schemasComponentOutputs
{
	constructor(entity: ADKEntity, options: integrationAccounts_schemasComponentInputs) {
		super(entity, options.name, "Microsoft.Logic/integrationAccounts/schemas", "2019-05-01", options);
	}
	public readonly apiVersion: "2019-05-01";
	public readonly id: string;
	...
	implements integrationAccounts_sessionsComponentOutputs
{
	constructor(entity: ADKEntity, options: integrationAccounts_sessionsComponentInputs) {
		super(entity, options.name, "Microsoft.Logic/integrationAccounts/sessions", "2019-05-01", options);
	}
	public readonly apiVersion: "2019-05-01";
	public readonly id: string;
...
export class integrationServiceEnvironments
	extends ArmResource<integrationServiceEnvironmentsComponentInputs>
	implements integrationServiceEnvironmentsComponentOutputs
{
	constructor(entity: ADKEntity, options: integrationServiceEnvironmentsComponentInputs) {
		super(entity, options.name, "Microsoft.Logic/integrationServiceEnvironments", "2019-05-01", options);
	}
	public readonly apiVersion: "2019-05-01";
	public readonly id: string;
	public readonly type: "Microsoft.Logic/integrationServiceEnvironments";
}
export interface integrationServiceEnvironmentsComponentOutputs {
	readonly apiVersion: "2019-05-01";
	readonly id: string;
	readonly type: "Microsoft.Logic/integrationServiceEnvironments";
}
export interface integrationServiceEnvironmentsComponentInputs {
	readonly identity?: ManagedServiceIdentity | undefined;
	readonly location?: string | undefined;
	readonly name: string;
	readonly properties?: IntegrationServiceEnvironmentProperties | undefined;
	readonly sku?: IntegrationServiceEnvironmentSku | undefined;
	readonly tags?: ResourceTags | undefined;
}
export class integrationServiceEnvironments_managedApis
	extends ArmResource<integrationServiceEnvironments_managedApisComponentInputs>
	implements integrationServiceEnvironments_managedApisComponentOutputs
{
	constructor(entity: ADKEntity, options: integrationServiceEnvironments_managedApisComponentInputs) {
		super(entity, options.name, "Microsoft.Logic/integrationServiceEnvironments/managedApis", "2019-05-01", options);
	}
	public readonly apiVersion: "2019-05-01";
	public readonly id: string;
	public readonly type: "Microsoft.Logic/integrationServiceEnvironments/managedApis";
}
export interface integrationServiceEnvironments_managedApisComponentOutputs {
	readonly apiVersion: "2019-05-01";
	readonly id: string;
	readonly type: "Microsoft.Logic/integrationServiceEnvironments/managedApis";
}
export interface integrationServiceEnvironments_managedApisComponentInputs {
	readonly location?: string | undefined;
	readonly name: string;
	readonly properties?: IntegrationServiceEnvironmentManagedApiProperties | undefined;
	readonly tags?: ResourceTags | undefined;
}
export class workflows extends ArmResource<workflowsComponentInputs> implements workflowsComponentOutputs {
	constructor(entity: ADKEntity, options: workflowsComponentInputs) {
		super(entity, options.name, "Microsoft.Logic/workflows", "2019-05-01", options);
	}
	public readonly apiVersion: "2019-05-01";
	public readonly id: string;
...
export class workflows_runs extends ArmResource<workflows_runsComponentInputs> implements workflows_runsComponentOutputs {
	constructor(entity: ADKEntity, options: workflows_runsComponentInputs) {
		super(entity, options.name, "Microsoft.Logic/workflows/runs", "2019-05-01", options);
	}
	public readonly apiVersion: "2019-05-01";
	public readonly id: string;
	...
	implements workflows_runs_actionsComponentOutputs
{
	constructor(entity: ADKEntity, options: workflows_runs_actionsComponentInputs) {
		super(entity, options.name, "Microsoft.Logic/workflows/runs/actions", "2019-05-01", options);
	}
	public readonly apiVersion: "2019-05-01";
	public readonly id: string;
	...
	implements workflows_runs_actions_repetitionsComponentOutputs
{
	constructor(entity: ADKEntity, options: workflows_runs_actions_repetitionsComponentInputs) {
		super(entity, options.name, "Microsoft.Logic/workflows/runs/actions/repetitions", "2019-05-01", options);
	}
	public readonly apiVersion: "2019-05-01";
	public readonly id: string;
	...
	implements workflows_runs_actions_requestHistoriesComponentOutputs
{
	constructor(entity: ADKEntity, options: workflows_runs_actions_requestHistoriesComponentInputs) {
		super(entity, options.name, "Microsoft.Logic/workflows/runs/actions/requestHistories", "2019-05-01", options);
	}
	public readonly apiVersion: "2019-05-01";
	public readonly id: string;
	...
	implements workflows_runs_actions_scopeRepetitionsComponentOutputs
{
	constructor(entity: ADKEntity, options: workflows_runs_actions_scopeRepetitionsComponentInputs) {
		super(entity, options.name, "Microsoft.Logic/workflows/runs/actions/scopeRepetitions", "2019-05-01", options);
	}
	public readonly apiVersion: "2019-05-01";
	public readonly id: string;
	...
	implements workflows_runs_operationsComponentOutputs
{
	constructor(entity: ADKEntity, options: workflows_runs_operationsComponentInputs) {
		super(entity, options.name, "Microsoft.Logic/workflows/runs/operations", "2019-05-01", options);
	}
	public readonly apiVersion: "2019-05-01";
	public readonly id: string;
	...
	implements workflows_triggersComponentOutputs
{
	constructor(entity: ADKEntity, options: workflows_triggersComponentInputs) {
		super(entity, options.name, "Microsoft.Logic/workflows/triggers", "2019-05-01", options);
	}
	public readonly apiVersion: "2019-05-01";
	public readonly id: string;
	...
	implements workflows_triggers_historiesComponentOutputs
{
	constructor(entity: ADKEntity, options: workflows_triggers_historiesComponentInputs) {
		super(entity, options.name, "Microsoft.Logic/workflows/triggers/histories", "2019-05-01", options);
	}
	public readonly apiVersion: "2019-05-01";
	public readonly id: string;
	...
	implements workflows_versionsComponentOutputs
{
	constructor(entity: ADKEntity, options: workflows_versionsComponentInputs) {
		super(entity, options.name, "Microsoft.Logic/workflows/versions", "2019-05-01", options);
	}
	public readonly apiVersion: "2019-05-01";
	public readonly id: string;
...
export interface ApiDeploymentParameterMetadata {
	...
	readonly visibility?: ("Default" | "Internal" | "NotSpecified") | undefined;
}
export interface ApiDeploymentParameterMetadataSet {
	readonly packageContentLink?: ApiDeploymentParameterMetadata | undefined;
	readonly redisCacheConnectionString?: ApiDeploymentParameterMetadata | undefined;
}
...
export interface ApiResourceGeneralInformation {
	...
	readonly tier?: ("Enterprise" | "NotSpecified" | "Premium" | "Standard") | undefined;
}
export interface ApiResourceMetadata {
	...
	readonly deploymentParameters?: ApiDeploymentParameterMetadataSet | undefined;
...
export interface IntegrationAccountProperties {
	readonly integrationServiceEnvironment?: ResourceReference | undefined;
...
export interface IntegrationServiceEnvironmentManagedApiProperties {
	...
	readonly category?: ("Enterprise" | "NotSpecified" | "Premium" | "Standard") | undefined;
	readonly connectionParameters?: ApiResourcePropertiesConnectionParameters | undefined;
	readonly deploymentParameters?: IntegrationServiceEnvironmentManagedApiDeploymentParameters | undefined;
...
export interface IntegrationServiceEnvironmentProperties {
	readonly encryptionConfiguration?: IntegrationServiceEnvironmenEncryptionConfiguration | undefined;
	readonly endpointsConfiguration?: FlowEndpointsConfiguration | undefined;
	readonly integrationServiceEnvironmentId?: string | undefined;
...
export interface IntegrationServiceEnvironmentSku {
	...
	readonly name?: ("Developer" | "NotSpecified" | "Premium") | undefined;
}
...
export interface NetworkConfiguration {
	readonly accessEndpoint?: IntegrationServiceEnvironmentAccessEndpoint | undefined;
	readonly subnets?: ResourceReference[] | undefined;
	readonly virtualNetworkAddressSpace?: string | undefined;
}
...
export default {
	...
	"integrationServiceEnvironments/managedApis": integrationServiceEnvironments_managedApis,
	workflows: workflows,
