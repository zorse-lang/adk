...
export interface locations_managedDatabaseMoveOperationResultsComponentInputs {
	readonly name: string;
	readonly properties?: ManagedDatabaseMoveOperationResultProperties;
}
...
export interface managedInstances_dtcComponentInputs {
	readonly name: string;
	readonly properties?: ManagedInstanceDtcProperties;
}
...
export interface servers_databases_sqlVulnerabilityAssessmentsComponentInputs {
	readonly name: string;
	readonly properties?: SqlVulnerabilityAssessmentPolicyProperties;
	readonly systemData?: SystemData;
}
...
export interface servers_databases_sqlVulnerabilityAssessments_baselinesComponentInputs {
	readonly name: string;
	readonly properties?: DatabaseSqlVulnerabilityAssessmentRuleBaselineListInputPropertiesOrDatabaseSqlVulnerabilityAssessmentBaselineSetProperties;
	readonly systemData?: SystemData;
}
...
export interface servers_databases_sqlVulnerabilityAssessments_baselines_rulesComponentInputs {
	readonly name: string;
	readonly properties?: DatabaseSqlVulnerabilityAssessmentRuleBaselineInputPropertiesOrDatabaseSqlVulnerabilityAssessmentRuleBaselineProperties;
	readonly systemData?: SystemData;
}
...
export interface servers_databases_sqlVulnerabilityAssessments_scansComponentInputs {
	readonly name: string;
	readonly properties?: SqlVulnerabilityAssessmentScanRecordProperties;
	readonly systemData?: SystemData;
}
...
export interface servers_databases_sqlVulnerabilityAssessments_scans_scanResultsComponentInputs {
	readonly name: string;
	readonly properties?: SqlVulnerabilityAssessmentScanResultProperties;
	readonly systemData?: SystemData;
}
...
export interface BaselineAdjustedResult {
	...
	readonly status?: "Finding" | "InternalError" | "NonFinding";
}
...
export interface ManagedDatabaseMoveOperationResultProperties {
	...
	readonly operationMode?: "Copy" | "Move";
...
export interface ManagedDatabaseRestoreDetailsBackupSetProperties {
	...
	readonly restoreFinishedTimestampUtc?: string;
	readonly restoreStartedTimestampUtc?: string;
...
export interface ManagedInstanceDtcSecuritySettings {
	readonly snaLu6point2TransactionsEnabled?: boolean;
	readonly transactionManagerCommunicationSettings?: ManagedInstanceDtcTransactionManagerCommunicationSettings;
	readonly xaTransactionsDefaultTimeout?: number;
	readonly xaTransactionsEnabled?: boolean;
	readonly xaTransactionsMaximumTimeout?: number;
}
export interface ManagedInstanceDtcTransactionManagerCommunicationSettings {
	readonly allowInboundEnabled?: boolean;
	readonly allowOutboundEnabled?: boolean;
...
export interface VaRule {
	...
	readonly ruleId?: string;
	readonly ruleType?: "BaselineExpected" | "Binary" | "NegativeList" | "PositiveList";
	readonly severity?: "High" | "Informational" | "Low" | "Medium" | "Obsolete";
