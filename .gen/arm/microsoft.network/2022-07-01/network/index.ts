...
export interface cloudServiceSlotsComponentInputs {
	readonly name: string;
	readonly properties?: SwapResourceProperties;
}
...
export interface expressRoutePorts_authorizationsComponentInputs {
	readonly etag?: string;
	readonly name: string;
	readonly properties?: ExpressRoutePortAuthorizationPropertiesFormat;
}
...
export interface expressRouteProviderPortsComponentInputs {
	...
	readonly location?: string;
	readonly name: string;
	readonly properties?: ExpressRouteProviderPortProperties;
	readonly tags?: ResourceTags;
}
...
export interface firewallPolicies_signatureOverridesComponentInputs {
	readonly name: string;
	readonly properties?: SignaturesOverridesProperties;
}
...
export interface virtualHubs_routeMapsComponentInputs {
	readonly etag?: string;
	readonly name: string;
	readonly properties?: RouteMapProperties;
}
...
export interface virtualHubs_routingIntentComponentInputs {
	readonly etag?: string;
	readonly name: string;
	readonly properties?: RoutingIntentProperties;
}
...
export interface virtualNetworkGateways_natRulesComponentInputs {
	readonly etag?: string;
	readonly name: string;
	readonly properties?: VirtualNetworkGatewayNatRuleProperties;
}
...
export interface vpnGateways_natRulesComponentInputs {
	readonly etag?: string;
	readonly name: string;
	readonly properties?: VpnGatewayNatRuleProperties;
}
...
export interface vpnServerConfigurations_configurationPolicyGroupsComponentInputs {
	readonly etag?: string;
	readonly name: string;
	readonly properties?: VpnServerConfigurationPolicyGroupProperties;
}
...
export interface ApplicationGatewayAvailableSslOptionsPropertiesFormat {
	...
	readonly availableProtocols?: "TLSv1_0" | "TLSv1_1" | "TLSv1_2" | "TLSv1_3"[];
...
export interface ApplicationGatewayBackendSettings {
	...
	readonly id?: string;
	readonly name?: string;
	readonly properties?: ApplicationGatewayBackendSettingsPropertiesFormat;
	readonly type?: string;
}
...
export interface ApplicationGatewayGlobalConfiguration {
	readonly enableRequestBuffering?: boolean;
	readonly enableResponseBuffering?: boolean;
}
...
export interface ApplicationGatewayListener {
	...
	readonly id?: string;
	readonly name?: string;
	readonly properties?: ApplicationGatewayListenerPropertiesFormat;
	readonly type?: string;
}
...
export interface ApplicationGatewayLoadDistributionPolicy {
	...
	readonly id?: string;
	readonly name?: string;
	readonly properties?: ApplicationGatewayLoadDistributionPolicyPropertiesFormat;
	readonly type?: string;
}
...
export interface ApplicationGatewayLoadDistributionTarget {
	...
	readonly id?: string;
	readonly name?: string;
	readonly properties?: ApplicationGatewayLoadDistributionTargetPropertiesFormat;
	readonly type?: string;
}
...
export interface ApplicationGatewayProbePropertiesFormat {
	...
	readonly pickHostNameFromBackendSettings?: boolean;
	readonly port?: number;
	readonly protocol?: "Http" | "Https" | "Tcp" | "Tls";
	readonly provisioningState?: "Deleting" | "Failed" | "Succeeded" | "Updating";
	readonly timeout?: number;
...
export interface ApplicationGatewayRoutingRule {
	...
	readonly id?: string;
	readonly name?: string;
	readonly properties?: ApplicationGatewayRoutingRulePropertiesFormat;
	readonly type?: string;
}
...
export interface ApplicationGatewaySslPolicy {
	readonly cipherSuites?:
		...
		| "TLS_RSA_WITH_AES_256_CBC_SHA256"
		| "TLS_RSA_WITH_AES_256_GCM_SHA384"[];
	readonly disabledSslProtocols?: "TLSv1_0" | "TLSv1_1" | "TLSv1_2" | "TLSv1_3"[];
...
export interface ExplicitProxy {
	readonly enableExplicitProxy?: boolean;
	readonly enablePacFile?: boolean;
...
export interface ExpressRouteProviderPortProperties {
	readonly overprovisionFactor?: number;
	readonly peeringLocation?: string;
	readonly portBandwidthInMbps?: number;
	readonly portPairDescriptor?: string;
	readonly primaryAzurePort?: string;
	readonly remainingBandwidthInMbps?: number;
	readonly secondaryAzurePort?: string;
	readonly usedBandwidthInMbps?: number;
}
...
export interface FirewallPolicyIntrusionDetectionConfiguration {
	readonly bypassTrafficSettings?: FirewallPolicyIntrusionDetectionBypassTrafficSpecifications[];
	readonly privateRanges?: string[];
	readonly signatureOverrides?: FirewallPolicyIntrusionDetectionSignatureSpecification[];
}
...
export interface FirewallPolicySQL {
	readonly allowSqlRedirect?: boolean;
}
...
export interface LoadBalancerBackendAddressPropertiesFormat {
	readonly adminState?: "Down" | "Drain" | "None" | "Up";
...
export interface LoadBalancerSku {
	readonly name?: "Basic" | "Gateway" | "Standard";
...
export interface NetworkInterfacePropertiesFormat {
	readonly auxiliaryMode?: "Floating" | "MaxConnections" | "None";
...
export interface NetworkManagerDeploymentStatus {
	...
	readonly deploymentType?: "Connectivity" | "SecurityAdmin";
...
export interface NetworkManagerDeploymentStatusParameter {
	readonly deploymentTypes?: "Connectivity" | "SecurityAdmin"[];
	readonly regions?: string[];
	readonly skipToken?: string;
}
...
export interface QueryResults {
	...
	readonly signatures?: SingleQueryResult[];
}
...
export interface SecurityAdminConfigurationPropertiesFormat {
	readonly applyOnNetworkIntentPolicyBasedServices?: "All" | "AllowRulesOnly" | "None"[];
	readonly description?: string;
	readonly provisioningState?: "Deleting" | "Failed" | "Succeeded" | "Updating";
}
...
export interface SingleQueryResult {
	...
	readonly inheritedFromParentPolicy?: boolean;
...
export interface VirtualNetworkGatewayPolicyGroup {
	...
	readonly id?: string;
	readonly name?: string;
	readonly properties?: VirtualNetworkGatewayPolicyGroupProperties;
}
...
export interface VngClientConnectionConfiguration {
	...
	readonly id?: string;
	readonly name?: string;
	readonly properties?: VngClientConnectionConfigurationProperties;
}
