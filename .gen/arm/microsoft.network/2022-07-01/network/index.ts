	...
	implements applicationGatewayAvailableSslOptionsComponentOutputs
{
	constructor(entity: ADKEntity, options: applicationGatewayAvailableSslOptionsComponentInputs) {
		super(entity, options.name, "Microsoft.Network/applicationGatewayAvailableSslOptions", "2022-07-01", options);
	}
	...
	implements applicationGatewaysComponentOutputs
{
	constructor(entity: ADKEntity, options: applicationGatewaysComponentInputs) {
		super(entity, options.name, "Microsoft.Network/applicationGateways", "2022-07-01", options);
	}
	public readonly apiVersion: "2022-07-01";
	public readonly id: string;
	...
	implements applicationSecurityGroupsComponentOutputs
{
	constructor(entity: ADKEntity, options: applicationSecurityGroupsComponentInputs) {
		super(entity, options.name, "Microsoft.Network/applicationSecurityGroups", "2022-07-01", options);
	}
	public readonly apiVersion: "2022-07-01";
	public readonly id: string;
...
export class azureFirewalls extends ArmResource<azureFirewallsComponentInputs> implements azureFirewallsComponentOutputs {
	constructor(entity: ADKEntity, options: azureFirewallsComponentInputs) {
		super(entity, options.name, "Microsoft.Network/azureFirewalls", "2022-07-01", options);
	}
	public readonly apiVersion: "2022-07-01";
	public readonly id: string;
...
export class bastionHosts extends ArmResource<bastionHostsComponentInputs> implements bastionHostsComponentOutputs {
	constructor(entity: ADKEntity, options: bastionHostsComponentInputs) {
		super(entity, options.name, "Microsoft.Network/bastionHosts", "2022-07-01", options);
	}
	public readonly apiVersion: "2022-07-01";
	public readonly id: string;
...
export class cloudServiceSlots
	extends ArmResource<cloudServiceSlotsComponentInputs>
	implements cloudServiceSlotsComponentOutputs
{
	constructor(entity: ADKEntity, options: cloudServiceSlotsComponentInputs) {
		super(entity, options.name, "Microsoft.Network/cloudServiceSlots", "2022-07-01", options);
	}
	public readonly apiVersion: "2022-07-01";
	public readonly id: string;
	public readonly type: "Microsoft.Network/cloudServiceSlots";
}
export interface cloudServiceSlotsComponentOutputs {
	readonly apiVersion: "2022-07-01";
	readonly id: string;
	readonly type: "Microsoft.Network/cloudServiceSlots";
}
export interface cloudServiceSlotsComponentInputs {
	readonly name: string;
	readonly properties?: SwapResourceProperties | undefined;
}
export class connections extends ArmResource<connectionsComponentInputs> implements connectionsComponentOutputs {
	constructor(entity: ADKEntity, options: connectionsComponentInputs) {
		super(entity, options.name, "Microsoft.Network/connections", "2022-07-01", options);
	}
	public readonly apiVersion: "2022-07-01";
	public readonly id: string;
	...
	implements customIpPrefixesComponentOutputs
{
	constructor(entity: ADKEntity, options: customIpPrefixesComponentInputs) {
		super(entity, options.name, "Microsoft.Network/customIpPrefixes", "2022-07-01", options);
	}
	public readonly apiVersion: "2022-07-01";
	public readonly id: string;
	...
	implements ddosCustomPoliciesComponentOutputs
{
	constructor(entity: ADKEntity, options: ddosCustomPoliciesComponentInputs) {
		super(entity, options.name, "Microsoft.Network/ddosCustomPolicies", "2022-07-01", options);
	}
	public readonly apiVersion: "2022-07-01";
	public readonly id: string;
	...
	implements ddosProtectionPlansComponentOutputs
{
	constructor(entity: ADKEntity, options: ddosProtectionPlansComponentInputs) {
		super(entity, options.name, "Microsoft.Network/ddosProtectionPlans", "2022-07-01", options);
	}
	public readonly apiVersion: "2022-07-01";
	public readonly id: string;
	...
	implements dscpConfigurationsComponentOutputs
{
	constructor(entity: ADKEntity, options: dscpConfigurationsComponentInputs) {
		super(entity, options.name, "Microsoft.Network/dscpConfigurations", "2022-07-01", options);
	}
	public readonly apiVersion: "2022-07-01";
	public readonly id: string;
	...
	implements expressRouteCircuitsComponentOutputs
{
	constructor(entity: ADKEntity, options: expressRouteCircuitsComponentInputs) {
		super(entity, options.name, "Microsoft.Network/expressRouteCircuits", "2022-07-01", options);
	}
	public readonly apiVersion: "2022-07-01";
	public readonly id: string;
	...
	implements expressRouteCircuits_authorizationsComponentOutputs
{
	constructor(entity: ADKEntity, options: expressRouteCircuits_authorizationsComponentInputs) {
		super(entity, options.name, "Microsoft.Network/expressRouteCircuits/authorizations", "2022-07-01", options);
	}
	public readonly apiVersion: "2022-07-01";
	public readonly id: string;
	...
	implements expressRouteCircuits_peeringsComponentOutputs
{
	constructor(entity: ADKEntity, options: expressRouteCircuits_peeringsComponentInputs) {
		super(entity, options.name, "Microsoft.Network/expressRouteCircuits/peerings", "2022-07-01", options);
	}
	public readonly apiVersion: "2022-07-01";
	public readonly id: string;
	...
	implements expressRouteCircuits_peerings_connectionsComponentOutputs
{
	constructor(entity: ADKEntity, options: expressRouteCircuits_peerings_connectionsComponentInputs) {
		super(entity, options.name, "Microsoft.Network/expressRouteCircuits/peerings/connections", "2022-07-01", options);
	}
	public readonly apiVersion: "2022-07-01";
	public readonly id: string;
	...
	implements expressRouteCrossConnectionsComponentOutputs
{
	constructor(entity: ADKEntity, options: expressRouteCrossConnectionsComponentInputs) {
		super(entity, options.name, "Microsoft.Network/expressRouteCrossConnections", "2022-07-01", options);
	}
	public readonly apiVersion: "2022-07-01";
	public readonly id: string;
	...
	implements expressRouteCrossConnections_peeringsComponentOutputs
{
	constructor(entity: ADKEntity, options: expressRouteCrossConnections_peeringsComponentInputs) {
		super(entity, options.name, "Microsoft.Network/expressRouteCrossConnections/peerings", "2022-07-01", options);
	}
	public readonly apiVersion: "2022-07-01";
	public readonly id: string;
	...
	implements expressRouteGatewaysComponentOutputs
{
	constructor(entity: ADKEntity, options: expressRouteGatewaysComponentInputs) {
		super(entity, options.name, "Microsoft.Network/expressRouteGateways", "2022-07-01", options);
	}
	public readonly apiVersion: "2022-07-01";
	public readonly id: string;
	...
	implements ExpressRoutePortsComponentOutputs
{
	constructor(entity: ADKEntity, options: ExpressRoutePortsComponentInputs) {
		super(entity, options.name, "Microsoft.Network/ExpressRoutePorts", "2022-07-01", options);
	}
	public readonly apiVersion: "2022-07-01";
	public readonly id: string;
...
export class expressRoutePorts_authorizations
	extends ArmResource<expressRoutePorts_authorizationsComponentInputs>
	implements expressRoutePorts_authorizationsComponentOutputs
{
	constructor(entity: ADKEntity, options: expressRoutePorts_authorizationsComponentInputs) {
		super(entity, options.name, "Microsoft.Network/expressRoutePorts/authorizations", "2022-07-01", options);
	}
	public readonly apiVersion: "2022-07-01";
	public readonly id: string;
	public readonly type: "Microsoft.Network/expressRoutePorts/authorizations";
}
export interface expressRoutePorts_authorizationsComponentOutputs {
	readonly apiVersion: "2022-07-01";
	readonly id: string;
	readonly type: "Microsoft.Network/expressRoutePorts/authorizations";
}
export interface expressRoutePorts_authorizationsComponentInputs {
	readonly etag?: string | undefined;
	readonly name: string;
	readonly properties?: ExpressRoutePortAuthorizationPropertiesFormat | undefined;
}
	...
	implements ExpressRoutePorts_linksComponentOutputs
{
	constructor(entity: ADKEntity, options: ExpressRoutePorts_linksComponentInputs) {
		super(entity, options.name, "Microsoft.Network/ExpressRoutePorts/links", "2022-07-01", options);
	}
	public readonly apiVersion: "2022-07-01";
	public readonly id: string;
	...
	implements ExpressRoutePortsLocationsComponentOutputs
{
	constructor(entity: ADKEntity, options: ExpressRoutePortsLocationsComponentInputs) {
		super(entity, options.name, "Microsoft.Network/ExpressRoutePortsLocations", "2022-07-01", options);
	}
	public readonly apiVersion: "2022-07-01";
	public readonly id: string;
...
export class expressRouteProviderPorts
	extends ArmResource<expressRouteProviderPortsComponentInputs>
	implements expressRouteProviderPortsComponentOutputs
{
	constructor(entity: ADKEntity, options: expressRouteProviderPortsComponentInputs) {
		super(entity, options.name, "Microsoft.Network/expressRouteProviderPorts", "2022-07-01", options);
	}
	public readonly apiVersion: "2022-07-01";
	public readonly id: string;
	public readonly type: "Microsoft.Network/expressRouteProviderPorts";
}
export interface expressRouteProviderPortsComponentOutputs {
	readonly apiVersion: "2022-07-01";
	readonly id: string;
	readonly type: "Microsoft.Network/expressRouteProviderPorts";
}
export interface expressRouteProviderPortsComponentInputs {
	readonly etag?: string | undefined;
	readonly location?: string | undefined;
	readonly name: string;
	readonly properties?: ExpressRouteProviderPortProperties | undefined;
	readonly tags?: ResourceTags | undefined;
}
	...
	implements firewallPoliciesComponentOutputs
{
	constructor(entity: ADKEntity, options: firewallPoliciesComponentInputs) {
		super(entity, options.name, "Microsoft.Network/firewallPolicies", "2022-07-01", options);
	}
	public readonly apiVersion: "2022-07-01";
	public readonly id: string;
	...
	implements firewallPolicies_ruleCollectionGroupsComponentOutputs
{
	constructor(entity: ADKEntity, options: firewallPolicies_ruleCollectionGroupsComponentInputs) {
		super(entity, options.name, "Microsoft.Network/firewallPolicies/ruleCollectionGroups", "2022-07-01", options);
	}
	public readonly apiVersion: "2022-07-01";
	public readonly id: string;
	...
	implements firewallPolicies_signatureOverridesComponentOutputs
{
	constructor(entity: ADKEntity, options: firewallPolicies_signatureOverridesComponentInputs) {
		super(entity, options.name, "Microsoft.Network/firewallPolicies/signatureOverrides", "2022-07-01", options);
	}
	public readonly apiVersion: "2022-07-01";
	public readonly id: string;
...
export class IpAllocations extends ArmResource<IpAllocationsComponentInputs> implements IpAllocationsComponentOutputs {
	constructor(entity: ADKEntity, options: IpAllocationsComponentInputs) {
		super(entity, options.name, "Microsoft.Network/IpAllocations", "2022-07-01", options);
	}
	public readonly apiVersion: "2022-07-01";
	public readonly id: string;
...
export class ipGroups extends ArmResource<ipGroupsComponentInputs> implements ipGroupsComponentOutputs {
	constructor(entity: ADKEntity, options: ipGroupsComponentInputs) {
		super(entity, options.name, "Microsoft.Network/ipGroups", "2022-07-01", options);
	}
	public readonly apiVersion: "2022-07-01";
	public readonly id: string;
...
export class loadBalancers extends ArmResource<loadBalancersComponentInputs> implements loadBalancersComponentOutputs {
	constructor(entity: ADKEntity, options: loadBalancersComponentInputs) {
		super(entity, options.name, "Microsoft.Network/loadBalancers", "2022-07-01", options);
	}
	public readonly apiVersion: "2022-07-01";
	public readonly id: string;
	...
	implements loadBalancers_backendAddressPoolsComponentOutputs
{
	constructor(entity: ADKEntity, options: loadBalancers_backendAddressPoolsComponentInputs) {
		super(entity, options.name, "Microsoft.Network/loadBalancers/backendAddressPools", "2022-07-01", options);
	}
	public readonly apiVersion: "2022-07-01";
	public readonly id: string;
	...
	implements loadBalancers_frontendIPConfigurationsComponentOutputs
{
	constructor(entity: ADKEntity, options: loadBalancers_frontendIPConfigurationsComponentInputs) {
		super(entity, options.name, "Microsoft.Network/loadBalancers/frontendIPConfigurations", "2022-07-01", options);
	}
	public readonly apiVersion: "2022-07-01";
	public readonly id: string;
	...
	implements loadBalancers_inboundNatRulesComponentOutputs
{
	constructor(entity: ADKEntity, options: loadBalancers_inboundNatRulesComponentInputs) {
		super(entity, options.name, "Microsoft.Network/loadBalancers/inboundNatRules", "2022-07-01", options);
	}
	public readonly apiVersion: "2022-07-01";
	public readonly id: string;
	...
	implements loadBalancers_loadBalancingRulesComponentOutputs
{
	constructor(entity: ADKEntity, options: loadBalancers_loadBalancingRulesComponentInputs) {
		super(entity, options.name, "Microsoft.Network/loadBalancers/loadBalancingRules", "2022-07-01", options);
	}
	public readonly apiVersion: "2022-07-01";
	public readonly id: string;
	...
	implements loadBalancers_outboundRulesComponentOutputs
{
	constructor(entity: ADKEntity, options: loadBalancers_outboundRulesComponentInputs) {
		super(entity, options.name, "Microsoft.Network/loadBalancers/outboundRules", "2022-07-01", options);
	}
	public readonly apiVersion: "2022-07-01";
	public readonly id: string;
	...
	implements loadBalancers_probesComponentOutputs
{
	constructor(entity: ADKEntity, options: loadBalancers_probesComponentInputs) {
		super(entity, options.name, "Microsoft.Network/loadBalancers/probes", "2022-07-01", options);
	}
	public readonly apiVersion: "2022-07-01";
	public readonly id: string;
	...
	implements localNetworkGatewaysComponentOutputs
{
	constructor(entity: ADKEntity, options: localNetworkGatewaysComponentInputs) {
		super(entity, options.name, "Microsoft.Network/localNetworkGateways", "2022-07-01", options);
	}
	public readonly apiVersion: "2022-07-01";
	public readonly id: string;
...
export class natGateways extends ArmResource<natGatewaysComponentInputs> implements natGatewaysComponentOutputs {
	constructor(entity: ADKEntity, options: natGatewaysComponentInputs) {
		super(entity, options.name, "Microsoft.Network/natGateways", "2022-07-01", options);
	}
	public readonly apiVersion: "2022-07-01";
	public readonly id: string;
	...
	implements networkInterfacesComponentOutputs
{
	constructor(entity: ADKEntity, options: networkInterfacesComponentInputs) {
		super(entity, options.name, "Microsoft.Network/networkInterfaces", "2022-07-01", options);
	}
	public readonly apiVersion: "2022-07-01";
	public readonly id: string;
	...
	implements networkInterfaces_ipConfigurationsComponentOutputs
{
	constructor(entity: ADKEntity, options: networkInterfaces_ipConfigurationsComponentInputs) {
		super(entity, options.name, "Microsoft.Network/networkInterfaces/ipConfigurations", "2022-07-01", options);
	}
	public readonly apiVersion: "2022-07-01";
	public readonly id: string;
	...
	implements networkInterfaces_tapConfigurationsComponentOutputs
{
	constructor(entity: ADKEntity, options: networkInterfaces_tapConfigurationsComponentInputs) {
		super(entity, options.name, "Microsoft.Network/networkInterfaces/tapConfigurations", "2022-07-01", options);
	}
	public readonly apiVersion: "2022-07-01";
	public readonly id: string;
	...
	implements networkManagerConnectionsComponentOutputs
{
	constructor(entity: ADKEntity, options: networkManagerConnectionsComponentInputs) {
		super(entity, options.name, "Microsoft.Network/networkManagerConnections", "2022-07-01", options);
	}
	public readonly apiVersion: "2022-07-01";
	public readonly id: string;
	...
	implements networkManagersComponentOutputs
{
	constructor(entity: ADKEntity, options: networkManagersComponentInputs) {
		super(entity, options.name, "Microsoft.Network/networkManagers", "2022-07-01", options);
	}
	public readonly apiVersion: "2022-07-01";
	public readonly id: string;
	...
	implements networkManagers_connectivityConfigurationsComponentOutputs
{
	constructor(entity: ADKEntity, options: networkManagers_connectivityConfigurationsComponentInputs) {
		super(entity, options.name, "Microsoft.Network/networkManagers/connectivityConfigurations", "2022-07-01", options);
	}
	public readonly apiVersion: "2022-07-01";
	public readonly id: string;
	...
	implements networkManagers_networkGroupsComponentOutputs
{
	constructor(entity: ADKEntity, options: networkManagers_networkGroupsComponentInputs) {
		super(entity, options.name, "Microsoft.Network/networkManagers/networkGroups", "2022-07-01", options);
	}
	public readonly apiVersion: "2022-07-01";
	public readonly id: string;
	...
	implements networkManagers_networkGroups_staticMembersComponentOutputs
{
	constructor(entity: ADKEntity, options: networkManagers_networkGroups_staticMembersComponentInputs) {
		super(entity, options.name, "Microsoft.Network/networkManagers/networkGroups/staticMembers", "2022-07-01", options);
	}
	public readonly apiVersion: "2022-07-01";
	public readonly id: string;
	...
	implements networkManagers_scopeConnectionsComponentOutputs
{
	constructor(entity: ADKEntity, options: networkManagers_scopeConnectionsComponentInputs) {
		super(entity, options.name, "Microsoft.Network/networkManagers/scopeConnections", "2022-07-01", options);
	}
	public readonly apiVersion: "2022-07-01";
	public readonly id: string;
	...
	implements networkManagers_securityAdminConfigurationsComponentOutputs
{
	constructor(entity: ADKEntity, options: networkManagers_securityAdminConfigurationsComponentInputs) {
		super(entity, options.name, "Microsoft.Network/networkManagers/securityAdminConfigurations", "2022-07-01", options);
	}
	public readonly apiVersion: "2022-07-01";
	public readonly id: string;
	...
	implements networkProfilesComponentOutputs
{
	constructor(entity: ADKEntity, options: networkProfilesComponentInputs) {
		super(entity, options.name, "Microsoft.Network/networkProfiles", "2022-07-01", options);
	}
	public readonly apiVersion: "2022-07-01";
	public readonly id: string;
	...
	implements networkSecurityGroupsComponentOutputs
{
	constructor(entity: ADKEntity, options: networkSecurityGroupsComponentInputs) {
		super(entity, options.name, "Microsoft.Network/networkSecurityGroups", "2022-07-01", options);
	}
	public readonly apiVersion: "2022-07-01";
	public readonly id: string;
	...
	implements networkSecurityGroups_defaultSecurityRulesComponentOutputs
{
	constructor(entity: ADKEntity, options: networkSecurityGroups_defaultSecurityRulesComponentInputs) {
		super(entity, options.name, "Microsoft.Network/networkSecurityGroups/defaultSecurityRules", "2022-07-01", options);
	}
	public readonly apiVersion: "2022-07-01";
	public readonly id: string;
	...
	implements networkSecurityGroups_securityRulesComponentOutputs
{
	constructor(entity: ADKEntity, options: networkSecurityGroups_securityRulesComponentInputs) {
		super(entity, options.name, "Microsoft.Network/networkSecurityGroups/securityRules", "2022-07-01", options);
	}
	public readonly apiVersion: "2022-07-01";
	public readonly id: string;
	...
	implements networkVirtualAppliancesComponentOutputs
{
	constructor(entity: ADKEntity, options: networkVirtualAppliancesComponentInputs) {
		super(entity, options.name, "Microsoft.Network/networkVirtualAppliances", "2022-07-01", options);
	}
	public readonly apiVersion: "2022-07-01";
	public readonly id: string;
	...
	implements networkVirtualApplianceSkusComponentOutputs
{
	constructor(entity: ADKEntity, options: networkVirtualApplianceSkusComponentInputs) {
		super(entity, options.name, "Microsoft.Network/networkVirtualApplianceSkus", "2022-07-01", options);
	}
	public readonly apiVersion: "2022-07-01";
	public readonly id: string;
	...
	implements networkWatchersComponentOutputs
{
	constructor(entity: ADKEntity, options: networkWatchersComponentInputs) {
		super(entity, options.name, "Microsoft.Network/networkWatchers", "2022-07-01", options);
	}
	public readonly apiVersion: "2022-07-01";
	public readonly id: string;
	...
	implements networkWatchers_connectionMonitorsComponentOutputs
{
	constructor(entity: ADKEntity, options: networkWatchers_connectionMonitorsComponentInputs) {
		super(entity, options.name, "Microsoft.Network/networkWatchers/connectionMonitors", "2022-07-01", options);
	}
	public readonly apiVersion: "2022-07-01";
	public readonly id: string;
	...
	implements networkWatchers_flowLogsComponentOutputs
{
	constructor(entity: ADKEntity, options: networkWatchers_flowLogsComponentInputs) {
		super(entity, options.name, "Microsoft.Network/networkWatchers/flowLogs", "2022-07-01", options);
	}
	public readonly apiVersion: "2022-07-01";
	public readonly id: string;
	...
	implements networkWatchers_packetCapturesComponentOutputs
{
	constructor(entity: ADKEntity, options: networkWatchers_packetCapturesComponentInputs) {
		super(entity, options.name, "Microsoft.Network/networkWatchers/packetCaptures", "2022-07-01", options);
	}
	public readonly apiVersion: "2022-07-01";
	public readonly id: string;
...
export class p2svpnGateways extends ArmResource<p2svpnGatewaysComponentInputs> implements p2svpnGatewaysComponentOutputs {
	constructor(entity: ADKEntity, options: p2svpnGatewaysComponentInputs) {
		super(entity, options.name, "Microsoft.Network/p2svpnGateways", "2022-07-01", options);
	}
	public readonly apiVersion: "2022-07-01";
	public readonly id: string;
	...
	implements privateEndpointsComponentOutputs
{
	constructor(entity: ADKEntity, options: privateEndpointsComponentInputs) {
		super(entity, options.name, "Microsoft.Network/privateEndpoints", "2022-07-01", options);
	}
	public readonly apiVersion: "2022-07-01";
	public readonly id: string;
	...
	implements privateEndpoints_privateDnsZoneGroupsComponentOutputs
{
	constructor(entity: ADKEntity, options: privateEndpoints_privateDnsZoneGroupsComponentInputs) {
		super(entity, options.name, "Microsoft.Network/privateEndpoints/privateDnsZoneGroups", "2022-07-01", options);
	}
	public readonly apiVersion: "2022-07-01";
	public readonly id: string;
	...
	implements privateLinkServicesComponentOutputs
{
	constructor(entity: ADKEntity, options: privateLinkServicesComponentInputs) {
		super(entity, options.name, "Microsoft.Network/privateLinkServices", "2022-07-01", options);
	}
	public readonly apiVersion: "2022-07-01";
	public readonly id: string;
	...
	implements publicIPAddressesComponentOutputs
{
	constructor(entity: ADKEntity, options: publicIPAddressesComponentInputs) {
		super(entity, options.name, "Microsoft.Network/publicIPAddresses", "2022-07-01", options);
	}
	public readonly apiVersion: "2022-07-01";
	public readonly id: string;
	...
	implements publicIPPrefixesComponentOutputs
{
	constructor(entity: ADKEntity, options: publicIPPrefixesComponentInputs) {
		super(entity, options.name, "Microsoft.Network/publicIPPrefixes", "2022-07-01", options);
	}
	public readonly apiVersion: "2022-07-01";
	public readonly id: string;
...
export class routeFilters extends ArmResource<routeFiltersComponentInputs> implements routeFiltersComponentOutputs {
	constructor(entity: ADKEntity, options: routeFiltersComponentInputs) {
		super(entity, options.name, "Microsoft.Network/routeFilters", "2022-07-01", options);
	}
	public readonly apiVersion: "2022-07-01";
	public readonly id: string;
	...
	implements routeFilters_routeFilterRulesComponentOutputs
{
	constructor(entity: ADKEntity, options: routeFilters_routeFilterRulesComponentInputs) {
		super(entity, options.name, "Microsoft.Network/routeFilters/routeFilterRules", "2022-07-01", options);
	}
	public readonly apiVersion: "2022-07-01";
	public readonly id: string;
...
export class routeTables extends ArmResource<routeTablesComponentInputs> implements routeTablesComponentOutputs {
	constructor(entity: ADKEntity, options: routeTablesComponentInputs) {
		super(entity, options.name, "Microsoft.Network/routeTables", "2022-07-01", options);
	}
	public readonly apiVersion: "2022-07-01";
	public readonly id: string;
	...
	implements routeTables_routesComponentOutputs
{
	constructor(entity: ADKEntity, options: routeTables_routesComponentInputs) {
		super(entity, options.name, "Microsoft.Network/routeTables/routes", "2022-07-01", options);
	}
	public readonly apiVersion: "2022-07-01";
	public readonly id: string;
	...
	implements securityPartnerProvidersComponentOutputs
{
	constructor(entity: ADKEntity, options: securityPartnerProvidersComponentInputs) {
		super(entity, options.name, "Microsoft.Network/securityPartnerProviders", "2022-07-01", options);
	}
	public readonly apiVersion: "2022-07-01";
	public readonly id: string;
	...
	implements serviceEndpointPoliciesComponentOutputs
{
	constructor(entity: ADKEntity, options: serviceEndpointPoliciesComponentInputs) {
		super(entity, options.name, "Microsoft.Network/serviceEndpointPolicies", "2022-07-01", options);
	}
	public readonly apiVersion: "2022-07-01";
	public readonly id: string;
...
export class virtualHubs extends ArmResource<virtualHubsComponentInputs> implements virtualHubsComponentOutputs {
	constructor(entity: ADKEntity, options: virtualHubsComponentInputs) {
		super(entity, options.name, "Microsoft.Network/virtualHubs", "2022-07-01", options);
	}
	public readonly apiVersion: "2022-07-01";
	public readonly id: string;
	...
	implements virtualHubs_bgpConnectionsComponentOutputs
{
	constructor(entity: ADKEntity, options: virtualHubs_bgpConnectionsComponentInputs) {
		super(entity, options.name, "Microsoft.Network/virtualHubs/bgpConnections", "2022-07-01", options);
	}
	public readonly apiVersion: "2022-07-01";
	public readonly id: string;
	...
	implements virtualHubs_hubRouteTablesComponentOutputs
{
	constructor(entity: ADKEntity, options: virtualHubs_hubRouteTablesComponentInputs) {
		super(entity, options.name, "Microsoft.Network/virtualHubs/hubRouteTables", "2022-07-01", options);
	}
	public readonly apiVersion: "2022-07-01";
	public readonly id: string;
	...
	implements virtualHubs_hubVirtualNetworkConnectionsComponentOutputs
{
	constructor(entity: ADKEntity, options: virtualHubs_hubVirtualNetworkConnectionsComponentInputs) {
		super(entity, options.name, "Microsoft.Network/virtualHubs/hubVirtualNetworkConnections", "2022-07-01", options);
	}
	public readonly apiVersion: "2022-07-01";
	public readonly id: string;
	...
	implements virtualHubs_ipConfigurationsComponentOutputs
{
	constructor(entity: ADKEntity, options: virtualHubs_ipConfigurationsComponentInputs) {
		super(entity, options.name, "Microsoft.Network/virtualHubs/ipConfigurations", "2022-07-01", options);
	}
	public readonly apiVersion: "2022-07-01";
	public readonly id: string;
...
export class virtualHubs_routeMaps
	extends ArmResource<virtualHubs_routeMapsComponentInputs>
	implements virtualHubs_routeMapsComponentOutputs
{
	constructor(entity: ADKEntity, options: virtualHubs_routeMapsComponentInputs) {
		super(entity, options.name, "Microsoft.Network/virtualHubs/routeMaps", "2022-07-01", options);
	}
	public readonly apiVersion: "2022-07-01";
	public readonly id: string;
	public readonly type: "Microsoft.Network/virtualHubs/routeMaps";
}
export interface virtualHubs_routeMapsComponentOutputs {
	readonly apiVersion: "2022-07-01";
	readonly id: string;
	readonly type: "Microsoft.Network/virtualHubs/routeMaps";
}
export interface virtualHubs_routeMapsComponentInputs {
	readonly etag?: string | undefined;
	readonly name: string;
	readonly properties?: RouteMapProperties | undefined;
}
	...
	implements virtualHubs_routeTablesComponentOutputs
{
	constructor(entity: ADKEntity, options: virtualHubs_routeTablesComponentInputs) {
		super(entity, options.name, "Microsoft.Network/virtualHubs/routeTables", "2022-07-01", options);
	}
	public readonly apiVersion: "2022-07-01";
	public readonly id: string;
	...
	implements virtualHubs_routingIntentComponentOutputs
{
	constructor(entity: ADKEntity, options: virtualHubs_routingIntentComponentInputs) {
		super(entity, options.name, "Microsoft.Network/virtualHubs/routingIntent", "2022-07-01", options);
	}
	public readonly apiVersion: "2022-07-01";
	public readonly id: string;
	...
	implements virtualNetworkGatewaysComponentOutputs
{
	constructor(entity: ADKEntity, options: virtualNetworkGatewaysComponentInputs) {
		super(entity, options.name, "Microsoft.Network/virtualNetworkGateways", "2022-07-01", options);
	}
	public readonly apiVersion: "2022-07-01";
	public readonly id: string;
	...
	implements virtualNetworkGateways_natRulesComponentOutputs
{
	constructor(entity: ADKEntity, options: virtualNetworkGateways_natRulesComponentInputs) {
		super(entity, options.name, "Microsoft.Network/virtualNetworkGateways/natRules", "2022-07-01", options);
	}
	public readonly apiVersion: "2022-07-01";
	public readonly id: string;
	...
	implements virtualNetworksComponentOutputs
{
	constructor(entity: ADKEntity, options: virtualNetworksComponentInputs) {
		super(entity, options.name, "Microsoft.Network/virtualNetworks", "2022-07-01", options);
	}
	public readonly apiVersion: "2022-07-01";
	public readonly id: string;
	...
	implements virtualNetworks_subnetsComponentOutputs
{
	constructor(entity: ADKEntity, options: virtualNetworks_subnetsComponentInputs) {
		super(entity, options.name, "Microsoft.Network/virtualNetworks/subnets", "2022-07-01", options);
	}
	public readonly apiVersion: "2022-07-01";
	public readonly id: string;
	...
	implements virtualNetworks_virtualNetworkPeeringsComponentOutputs
{
	constructor(entity: ADKEntity, options: virtualNetworks_virtualNetworkPeeringsComponentInputs) {
		super(entity, options.name, "Microsoft.Network/virtualNetworks/virtualNetworkPeerings", "2022-07-01", options);
	}
	public readonly apiVersion: "2022-07-01";
	public readonly id: string;
	...
	implements virtualNetworkTapsComponentOutputs
{
	constructor(entity: ADKEntity, options: virtualNetworkTapsComponentInputs) {
		super(entity, options.name, "Microsoft.Network/virtualNetworkTaps", "2022-07-01", options);
	}
	public readonly apiVersion: "2022-07-01";
	public readonly id: string;
...
export class virtualRouters extends ArmResource<virtualRoutersComponentInputs> implements virtualRoutersComponentOutputs {
	constructor(entity: ADKEntity, options: virtualRoutersComponentInputs) {
		super(entity, options.name, "Microsoft.Network/virtualRouters", "2022-07-01", options);
	}
	public readonly apiVersion: "2022-07-01";
	public readonly id: string;
	...
	implements virtualRouters_peeringsComponentOutputs
{
	constructor(entity: ADKEntity, options: virtualRouters_peeringsComponentInputs) {
		super(entity, options.name, "Microsoft.Network/virtualRouters/peerings", "2022-07-01", options);
	}
	public readonly apiVersion: "2022-07-01";
	public readonly id: string;
...
export class virtualWans extends ArmResource<virtualWansComponentInputs> implements virtualWansComponentOutputs {
	constructor(entity: ADKEntity, options: virtualWansComponentInputs) {
		super(entity, options.name, "Microsoft.Network/virtualWans", "2022-07-01", options);
	}
	public readonly apiVersion: "2022-07-01";
	public readonly id: string;
...
export class vpnGateways extends ArmResource<vpnGatewaysComponentInputs> implements vpnGatewaysComponentOutputs {
	constructor(entity: ADKEntity, options: vpnGatewaysComponentInputs) {
		super(entity, options.name, "Microsoft.Network/vpnGateways", "2022-07-01", options);
	}
	public readonly apiVersion: "2022-07-01";
	public readonly id: string;
	...
	implements vpnGateways_natRulesComponentOutputs
{
	constructor(entity: ADKEntity, options: vpnGateways_natRulesComponentInputs) {
		super(entity, options.name, "Microsoft.Network/vpnGateways/natRules", "2022-07-01", options);
	}
	public readonly apiVersion: "2022-07-01";
	public readonly id: string;
	...
	implements vpnGateways_vpnConnectionsComponentOutputs
{
	constructor(entity: ADKEntity, options: vpnGateways_vpnConnectionsComponentInputs) {
		super(entity, options.name, "Microsoft.Network/vpnGateways/vpnConnections", "2022-07-01", options);
	}
	public readonly apiVersion: "2022-07-01";
	public readonly id: string;
	...
	implements vpnServerConfigurationsComponentOutputs
{
	constructor(entity: ADKEntity, options: vpnServerConfigurationsComponentInputs) {
		super(entity, options.name, "Microsoft.Network/vpnServerConfigurations", "2022-07-01", options);
	}
	public readonly apiVersion: "2022-07-01";
	public readonly id: string;
...
export class vpnServerConfigurations_configurationPolicyGroups
	extends ArmResource<vpnServerConfigurations_configurationPolicyGroupsComponentInputs>
	implements vpnServerConfigurations_configurationPolicyGroupsComponentOutputs
{
	constructor(entity: ADKEntity, options: vpnServerConfigurations_configurationPolicyGroupsComponentInputs) {
		super(
			entity,
			options.name,
	...
	public readonly apiVersion: "2022-07-01";
	public readonly id: string;
	public readonly type: "Microsoft.Network/vpnServerConfigurations/configurationPolicyGroups";
}
export interface vpnServerConfigurations_configurationPolicyGroupsComponentOutputs {
	readonly apiVersion: "2022-07-01";
	readonly id: string;
	readonly type: "Microsoft.Network/vpnServerConfigurations/configurationPolicyGroups";
}
export interface vpnServerConfigurations_configurationPolicyGroupsComponentInputs {
	readonly etag?: string | undefined;
	readonly name: string;
	readonly properties?: VpnServerConfigurationPolicyGroupProperties | undefined;
}
export class vpnSites extends ArmResource<vpnSitesComponentInputs> implements vpnSitesComponentOutputs {
	constructor(entity: ADKEntity, options: vpnSitesComponentInputs) {
		super(entity, options.name, "Microsoft.Network/vpnSites", "2022-07-01", options);
	}
	public readonly apiVersion: "2022-07-01";
	public readonly id: string;
	...
	implements vpnSites_vpnSiteLinksComponentOutputs
{
	constructor(entity: ADKEntity, options: vpnSites_vpnSiteLinksComponentInputs) {
		super(entity, options.name, "Microsoft.Network/vpnSites/vpnSiteLinks", "2022-07-01", options);
	}
	public readonly apiVersion: "2022-07-01";
	public readonly id: string;
...
export interface Action {
	...
	readonly type?: ("Add" | "Drop" | "Remove" | "Replace" | "Unknown") | undefined;
}
...
export interface ApplicationGatewayAvailableSslOptionsPropertiesFormat {
	readonly availableCipherSuites?:
		...
		| undefined;
	readonly availableProtocols?: ("TLSv1_0" | "TLSv1_1" | "TLSv1_2" | "TLSv1_3"[]) | undefined;
...
export interface ApplicationGatewayBackendHttpSettingsPropertiesFormat {
	...
	readonly protocol?: ("Http" | "Https" | "Tcp" | "Tls") | undefined;
	readonly provisioningState?: ("Deleting" | "Failed" | "Succeeded" | "Updating") | undefined;
...
export interface ApplicationGatewayBackendSettings {
	...
	readonly id?: string | undefined;
	readonly name?: string | undefined;
	readonly properties?: ApplicationGatewayBackendSettingsPropertiesFormat | undefined;
	readonly type?: string | undefined;
}
...
export interface ApplicationGatewayClientAuthConfiguration {
	...
	readonly verifyClientRevocation?: ("None" | "OCSP") | undefined;
}
...
export interface ApplicationGatewayListener {
	...
	readonly id?: string | undefined;
	readonly name?: string | undefined;
	readonly properties?: ApplicationGatewayListenerPropertiesFormat | undefined;
	readonly type?: string | undefined;
}
...
export interface ApplicationGatewayProbePropertiesFormat {
	...
	readonly pickHostNameFromBackendSettings?: boolean | undefined;
	readonly port?: number | undefined;
	readonly protocol?: ("Http" | "Https" | "Tcp" | "Tls") | undefined;
	readonly provisioningState?: ("Deleting" | "Failed" | "Succeeded" | "Updating") | undefined;
	readonly timeout?: number | undefined;
...
export interface ApplicationGatewayPropertiesFormat {
	...
	readonly backendSettingsCollection?: ApplicationGatewayBackendSettings[] | undefined;
	readonly customErrorConfigurations?: ApplicationGatewayCustomError[] | undefined;
	...
	readonly listeners?: ApplicationGatewayListener[] | undefined;
	...
	readonly routingRules?: ApplicationGatewayRoutingRule[] | undefined;
...
export interface ApplicationGatewayRoutingRule {
	...
	readonly id?: string | undefined;
	readonly name?: string | undefined;
	readonly properties?: ApplicationGatewayRoutingRulePropertiesFormat | undefined;
	readonly type?: string | undefined;
}
export interface ApplicationGatewayRoutingRulePropertiesFormat {
	readonly backendAddressPool?: SubResource | undefined;
	readonly backendSettings?: SubResource | undefined;
	readonly listener?: SubResource | undefined;
	readonly priority: number;
	readonly provisioningState?: ("Deleting" | "Failed" | "Succeeded" | "Updating") | undefined;
	readonly ruleType?: ("Basic" | "PathBasedRouting") | undefined;
}
...
export interface ApplicationGatewaySslPolicy {
	readonly cipherSuites?:
		...
		| undefined;
	readonly disabledSslProtocols?: ("TLSv1_0" | "TLSv1_1" | "TLSv1_2" | "TLSv1_3"[]) | undefined;
	readonly minProtocolVersion?: ("TLSv1_0" | "TLSv1_1" | "TLSv1_2" | "TLSv1_3") | undefined;
	readonly policyName?:
		| (
				| "AppGwSslPolicy20150501"
				| "AppGwSslPolicy20170401"
		...
		| undefined;
	readonly policyType?: ("Custom" | "CustomV2" | "Predefined") | undefined;
}
...
export interface BackendAddressPoolPropertiesFormat {
	readonly backendIPConfigurations?: NetworkInterfaceIPConfiguration[] | undefined;
	readonly drainPeriodInSeconds?: number | undefined;
...
export interface Criterion {
	readonly asPath?: string[] | undefined;
	readonly community?: string[] | undefined;
	readonly matchCondition?: ("Contains" | "Equals" | "NotContains" | "NotEquals" | "Unknown") | undefined;
...
export interface CustomIpPrefixPropertiesFormat {
	...
	readonly expressRouteAdvertise?: boolean | undefined;
	readonly failedReason?: string | undefined;
	readonly geo?: ("AFRI" | "APAC" | "AQ" | "EURO" | "GLOBAL" | "LATAM" | "ME" | "NAM" | "OCEANIA") | undefined;
	readonly noInternetAdvertise?: boolean | undefined;
	readonly prefixType?: ("Child" | "Parent" | "Singular") | undefined;
	readonly provisioningState?: ("Deleting" | "Failed" | "Succeeded" | "Updating") | undefined;
...
export interface DdosSettings {
	...
	readonly protectionMode?: ("Disabled" | "Enabled" | "VirtualNetworkInherited") | undefined;
}
...
export interface ExplicitProxy {
	...
	readonly enablePacFile?: boolean | undefined;
...
export interface ExpressRouteConnectionProperties {
	...
	readonly enablePrivateLinkFastPath?: boolean | undefined;
...
export interface ExpressRouteGatewayProperties {
	readonly allowNonVirtualWanTraffic?: boolean | undefined;
...
export interface ExpressRouteLinkPropertiesFormat {
	...
	readonly coloLocation?: string | undefined;
...
export interface ExpressRoutePortAuthorizationPropertiesFormat {
	readonly authorizationKey?: string | undefined;
	readonly authorizationUseStatus?: ("Available" | "InUse") | undefined;
	readonly circuitResourceUri?: string | undefined;
	readonly provisioningState?: ("Deleting" | "Failed" | "Succeeded" | "Updating") | undefined;
}
export interface ExpressRoutePortPropertiesFormat {
	readonly allocationDate?: string | undefined;
	readonly bandwidthInGbps?: number | undefined;
	readonly billingType?: ("MeteredData" | "UnlimitedData") | undefined;
...
export interface ExpressRouteProviderPortProperties {
	readonly overprovisionFactor?: number | undefined;
	readonly peeringLocation?: string | undefined;
	readonly portBandwidthInMbps?: number | undefined;
	readonly portPairDescriptor?: string | undefined;
	readonly primaryAzurePort?: string | undefined;
	readonly remainingBandwidthInMbps?: number | undefined;
	readonly secondaryAzurePort?: string | undefined;
	readonly usedBandwidthInMbps?: number | undefined;
}
...
export interface FirewallPolicyPropertiesFormat {
	...
	readonly explicitProxy?: ExplicitProxy | undefined;
...
export interface FirewallPolicySnat {
	readonly autoLearnPrivateRanges?: ("Disabled" | "Enabled") | undefined;
	readonly privateRanges?: string[] | undefined;
}
...
export interface LoadBalancerBackendAddressPropertiesFormat {
	readonly adminState?: ("Down" | "Drain" | "None" | "Up") | undefined;
...
export interface ManagedRuleOverride {
	readonly action?: ("Allow" | "AnomalyScoring" | "Block" | "Log") | undefined;
	readonly ruleId: string;
	readonly state?: ("Disabled" | "Enabled") | undefined;
}
...
export interface NetworkInterfacePropertiesFormat {
	readonly auxiliaryMode?: ("Floating" | "MaxConnections" | "None") | undefined;
	readonly disableTcpStateTracking?: boolean | undefined;
...
export interface NetworkManagerDeploymentStatus {
	...
	readonly deploymentType?: ("Connectivity" | "SecurityAdmin") | undefined;
...
export interface NetworkManagerDeploymentStatusParameter {
	readonly deploymentTypes?: ("Connectivity" | "SecurityAdmin"[]) | undefined;
	readonly regions?: string[] | undefined;
	readonly skipToken?: string | undefined;
}
...
export interface NetworkManagerProperties {
	readonly description?: string | undefined;
	readonly networkManagerScopeAccesses: "Connectivity" | "SecurityAdmin"[];
...
export interface NetworkSecurityGroupPropertiesFormat {
	...
	readonly flushConnection?: boolean | undefined;
...
export interface NetworkVirtualAppliancePropertiesFormat {
	...
	readonly delegation?: DelegationProperties | undefined;
	...
	readonly partnerManagedResource?: PartnerManagedResourceProperties | undefined;
	readonly provisioningState?: ("Deleting" | "Failed" | "Succeeded" | "Updating") | undefined;
...
export interface P2SConnectionConfigurationProperties {
	readonly configurationPolicyGroupAssociations?: SubResource[] | undefined;
	readonly enableInternetSecurity?: boolean | undefined;
	readonly previousConfigurationPolicyGroupAssociations?: VpnServerConfigurationPolicyGroup[] | undefined;
	readonly provisioningState?: ("Deleting" | "Failed" | "Succeeded" | "Updating") | undefined;
	readonly routingConfiguration?: RoutingConfiguration | undefined;
...
export interface PacketCaptureParametersOrPacketCaptureResultProperties {
	...
	readonly provisioningState?: ("Deleting" | "Failed" | "Succeeded" | "Updating") | undefined;
	readonly scope?: PacketCaptureMachineScope | undefined;
	readonly storageLocation: PacketCaptureStorageLocation;
	readonly target: string;
	readonly targetType?: "AzureVM" | undefined;
...
export interface PartnerManagedResourceProperties {
	readonly id?: string | undefined;
	readonly internalLoadBalancerId?: string | undefined;
	readonly standardLoadBalancerId?: string | undefined;
}
...
export interface ProbePropertiesFormat {
	...
	readonly probeThreshold?: number | undefined;
...
export interface RouteMapProperties {
	readonly associatedInboundConnections?: string[] | undefined;
	readonly associatedOutboundConnections?: string[] | undefined;
	readonly provisioningState?: ("Deleting" | "Failed" | "Succeeded" | "Updating") | undefined;
	readonly rules?: RouteMapRule[] | undefined;
}
export interface RouteMapRule {
	readonly actions?: Action[] | undefined;
	readonly matchCriteria?: Criterion[] | undefined;
	readonly name?: string | undefined;
	readonly nextStepIfMatched?: ("Continue" | "Terminate" | "Unknown") | undefined;
}
...
export interface RoutingConfiguration {
	...
	readonly inboundRouteMap?: SubResource | undefined;
	readonly outboundRouteMap?: SubResource | undefined;
...
export interface SecurityAdminConfigurationPropertiesFormat {
	readonly applyOnNetworkIntentPolicyBasedServices?: ("All" | "AllowRulesOnly" | "None"[]) | undefined;
	readonly description?: string | undefined;
	readonly provisioningState?: ("Deleting" | "Failed" | "Succeeded" | "Updating") | undefined;
}
...
export interface StaticRoutesConfig {
	readonly propagateStaticRoutes?: boolean | undefined;
	readonly vnetLocalRouteOverrideCriteria?: ("Contains" | "Equal") | undefined;
}
...
export interface SwapResourceProperties {
	readonly slotType?: "Production" | undefined;
}
...
export interface VirtualHubProperties {
	...
	readonly hubRoutingPreference?: ("ASPath" | "ExpressRoute" | "VpnGateway") | undefined;
	...
	readonly provisioningState?: ("Deleting" | "Failed" | "Succeeded" | "Updating") | undefined;
	readonly routeMaps?: SubResource[] | undefined;
	...
	readonly virtualRouterAutoScaleConfiguration?: VirtualRouterAutoScaleConfiguration | undefined;
...
export interface VirtualNetworkGatewayConnectionPropertiesFormat {
	...
	readonly enablePrivateLinkFastPath?: boolean | undefined;
	readonly expressRouteGatewayBypass?: boolean | undefined;
	readonly gatewayCustomBgpIpAddresses?: GatewayCustomBgpIpAddressIpConfiguration[] | undefined;
	readonly ingressBytesTransferred?: number | undefined;
...
export interface VirtualNetworkGatewayPolicyGroup {
	...
	readonly id?: string | undefined;
	readonly name?: string | undefined;
	readonly properties?: VirtualNetworkGatewayPolicyGroupProperties | undefined;
}
export interface VirtualNetworkGatewayPolicyGroupMember {
	readonly attributeType?: ("AADGroupId" | "CertificateGroupId" | "RadiusAzureGroupId") | undefined;
...
export interface VirtualNetworkGatewayPolicyGroupProperties {
	...
	readonly priority: number;
	readonly provisioningState?: ("Deleting" | "Failed" | "Succeeded" | "Updating") | undefined;
	readonly vngClientConnectionConfigurations?: SubResource[] | undefined;
}
export interface VirtualNetworkGatewayPropertiesFormat {
	readonly activeActive?: boolean | undefined;
	readonly allowRemoteVnetTraffic?: boolean | undefined;
	readonly allowVirtualWanTraffic?: boolean | undefined;
	readonly bgpSettings?: BgpSettings | undefined;
	...
	readonly virtualNetworkGatewayPolicyGroups?: VirtualNetworkGatewayPolicyGroup[] | undefined;
...
export interface VnetRoute {
	...
	readonly staticRoutesConfig?: StaticRoutesConfig | undefined;
}
export interface VngClientConnectionConfiguration {
	readonly etag?: string | undefined;
	readonly id?: string | undefined;
	readonly name?: string | undefined;
	readonly properties?: VngClientConnectionConfigurationProperties | undefined;
}
...
export interface VpnClientConfiguration {
	...
	readonly radiusServerSecret?: string | undefined;
	readonly vngClientConnectionConfigurations?: VngClientConnectionConfiguration[] | undefined;
...
export interface VpnServerConfigurationPolicyGroupProperties {
	...
	readonly p2SConnectionConfigurations?: SubResource[] | undefined;
	readonly policyMembers?: VpnServerConfigurationPolicyGroupMember[] | undefined;
	readonly priority?: number | undefined;
	readonly provisioningState?: ("Deleting" | "Failed" | "Succeeded" | "Updating") | undefined;
}
export interface VpnServerConfigurationProperties {
	...
	readonly configurationPolicyGroups?: VpnServerConfigurationPolicyGroup[] | undefined;
	readonly etag?: string | undefined;
	readonly name?: string | undefined;
...
export interface VpnSiteLinkConnectionProperties {
	...
	readonly usePolicyBasedTrafficSelectors?: boolean | undefined;
	readonly vpnConnectionProtocolType?: ("IKEv1" | "IKEv2") | undefined;
	readonly vpnGatewayCustomBgpAddresses?: GatewayCustomBgpIpAddressIpConfiguration[] | undefined;
...
export default {
	...
	cloudServiceSlots: cloudServiceSlots,
	...
	"expressRoutePorts/authorizations": expressRoutePorts_authorizations,
	"ExpressRoutePorts/links": ExpressRoutePorts_links,
	ExpressRoutePortsLocations: ExpressRoutePortsLocations,
	expressRouteProviderPorts: expressRouteProviderPorts,
	...
	"virtualHubs/routeMaps": virtualHubs_routeMaps,
	...
	"vpnServerConfigurations/configurationPolicyGroups": vpnServerConfigurations_configurationPolicyGroups,
	vpnSites: vpnSites,
