...
export class managementGroups_networkManagerConnections
	extends ArmResource<managementGroups_networkManagerConnectionsComponentInputs>
	implements managementGroups_networkManagerConnectionsComponentOutputs
{
	constructor(entity: ADKEntity, options: managementGroups_networkManagerConnectionsComponentInputs) {
		super(
			entity,
			options.name,
	...
	public readonly type: "Microsoft.Network/managementGroups/networkManagerConnections";
}
export interface managementGroups_networkManagerConnectionsComponentOutputs {
	readonly apiVersion: "2021-05-01-preview";
	readonly id: string;
	readonly type: "Microsoft.Network/managementGroups/networkManagerConnections";
}
export interface managementGroups_networkManagerConnectionsComponentInputs {
	...
	implements networkManagerConnectionsComponentOutputs
{
	constructor(entity: ADKEntity, options: networkManagerConnectionsComponentInputs) {
		super(entity, options.name, "Microsoft.Network/networkManagerConnections", "2021-05-01-preview", options);
	}
	public readonly apiVersion: "2021-05-01-preview";
	public readonly id: string;
	...
	implements networkManagersComponentOutputs
{
	constructor(entity: ADKEntity, options: networkManagersComponentInputs) {
		super(entity, options.name, "Microsoft.Network/networkManagers", "2021-05-01-preview", options);
	}
	public readonly apiVersion: "2021-05-01-preview";
	public readonly id: string;
	...
	implements networkManagers_networkGroupsComponentOutputs
{
	constructor(entity: ADKEntity, options: networkManagers_networkGroupsComponentInputs) {
		super(entity, options.name, "Microsoft.Network/networkManagers/networkGroups", "2021-05-01-preview", options);
	}
	public readonly apiVersion: "2021-05-01-preview";
	public readonly id: string;
	...
	implements networkManagers_scopeConnectionsComponentOutputs
{
	constructor(entity: ADKEntity, options: networkManagers_scopeConnectionsComponentInputs) {
		super(entity, options.name, "Microsoft.Network/networkManagers/scopeConnections", "2021-05-01-preview", options);
	}
	public readonly apiVersion: "2021-05-01-preview";
	public readonly id: string;
...
export default {
	"managementGroups/networkManagerConnections": managementGroups_networkManagerConnections,
