...
export interface virtualMachines_extensionsComponentInputs {
	...
	readonly tags?: ResourceWithOptionalLocationTags;
}
...
export interface DiskRestorePointInstanceView {
	readonly id?: string;
	readonly replicationStatus?: DiskRestorePointReplicationStatus;
}
...
export interface RestorePointInstanceView {
	readonly diskRestorePoints?: DiskRestorePointInstanceView[];
	readonly statuses?: InstanceViewStatus[];
}
