	...
	implements redisEnterpriseComponentOutputs
{
	constructor(entity: ADKEntity, options: redisEnterpriseComponentInputs) {
		super(entity, options.name, "Microsoft.Cache/redisEnterprise", "2021-02-01-preview", options);
	}
	...
	implements redisEnterprise_databasesComponentOutputs
{
	constructor(entity: ADKEntity, options: redisEnterprise_databasesComponentInputs) {
		super(entity, options.name, "Microsoft.Cache/redisEnterprise/databases", "2021-02-01-preview", options);
	}
	public readonly apiVersion: "2021-02-01-preview";
	public readonly id: string;
...
export interface DatabaseProperties {
	...
	readonly evictionPolicy?:
		...
		| undefined;
	readonly geoReplication?: DatabasePropertiesGeoReplication | undefined;
...
export interface DatabasePropertiesGeoReplication {
	readonly groupNickname?: string | undefined;
	readonly linkedDatabases?: LinkedDatabase[] | undefined;
}
export interface LinkedDatabase {
	readonly id?: string | undefined;
	readonly state?: ("LinkFailed" | "Linked" | "Linking" | "UnlinkFailed" | "Unlinking") | undefined;
}
