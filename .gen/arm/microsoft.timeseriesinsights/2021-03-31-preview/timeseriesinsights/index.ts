	...
	implements environments_Gen1ComponentOutputs
{
	constructor(entity: ADKEntity, options: environments_Gen1ComponentInputs) {
		super(entity, options.name, "Microsoft.TimeSeriesInsights/environments", "2021-03-31-preview", options);
	}
	public readonly apiVersion: "2021-03-31-preview";
	public readonly id: string;
	public readonly type: "Microsoft.TimeSeriesInsights/environments";
}
export interface environments_Gen1ComponentOutputs {
	readonly apiVersion: "2021-03-31-preview";
	readonly id: string;
...
export class environments_privateEndpointConnections
	extends ArmResource<environments_privateEndpointConnectionsComponentInputs>
	implements environments_privateEndpointConnectionsComponentOutputs
{
	constructor(entity: ADKEntity, options: environments_privateEndpointConnectionsComponentInputs) {
		super(
			entity,
			options.name,
	...
	public readonly apiVersion: "2021-03-31-preview";
	public readonly id: string;
	public readonly type: "Microsoft.TimeSeriesInsights/environments/privateEndpointConnections";
}
export interface environments_privateEndpointConnectionsComponentOutputs {
	readonly apiVersion: "2021-03-31-preview";
	readonly id: string;
	readonly type: "Microsoft.TimeSeriesInsights/environments/privateEndpointConnections";
}
export interface environments_privateEndpointConnectionsComponentInputs {
	readonly name: string;
...
export default {
	...
	"environments/privateEndpointConnections": environments_privateEndpointConnections,
