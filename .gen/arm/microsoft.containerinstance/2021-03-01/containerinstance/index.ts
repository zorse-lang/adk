	...
	implements containerGroupsComponentOutputs
{
	constructor(entity: ADKEntity, options: containerGroupsComponentInputs) {
		super(entity, options.name, "Microsoft.ContainerInstance/containerGroups", "2021-03-01", options);
	}
...
export interface ContainerGroupProperties {
	...
	readonly networkProfile?: ContainerGroupNetworkProfile | undefined;
...
export interface LogAnalytics {
	...
	readonly workspaceResourceId?: LogAnalyticsWorkspaceResourceId | undefined;
}
