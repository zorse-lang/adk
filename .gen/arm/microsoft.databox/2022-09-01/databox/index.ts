...
export class jobs extends ArmResource<jobsComponentInputs> implements jobsComponentOutputs {
	constructor(entity: ADKEntity, options: jobsComponentInputs) {
		super(entity, options.name, "Microsoft.DataBox/jobs", "2022-09-01", options);
	}
...
export interface JobProperties {
	...
	readonly reverseShippingDetailsUpdate?: ("Disabled" | "Enabled") | undefined;
	readonly reverseTransportPreferenceUpdate?: ("Disabled" | "Enabled") | undefined;
...
export interface Preferences {
	...
	readonly reverseTransportPreferences?: TransportPreferences | undefined;
