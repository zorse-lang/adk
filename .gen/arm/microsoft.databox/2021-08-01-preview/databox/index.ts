...
export class jobs extends ArmResource<jobsComponentInputs> implements jobsComponentOutputs {
	constructor(entity: ADKEntity, options: jobsComponentInputs) {
		super(entity, options.name, "Microsoft.DataBox/jobs", "2021-08-01-preview", options);
	}
...
export interface JobDetails {
	readonly actions?: ("MoveToCleanUpDevice" | "None"[]) | undefined;
...
export interface LastMitigationActionOnJob {
	...
	readonly customerResolution?: ("MoveToCleanUpDevice" | "None") | undefined;
