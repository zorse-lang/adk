...
export class locations_publishers_extensionTypes_versions
	extends ArmResource<locations_publishers_extensionTypes_versionsComponentInputs>
	implements locations_publishers_extensionTypes_versionsComponentOutputs
{
	constructor(entity: ADKEntity, options: locations_publishers_extensionTypes_versionsComponentInputs) {
		super(
			entity,
			options.name,
	...
	public readonly apiVersion: "2022-08-11-preview";
	public readonly id: string;
	public readonly type: "Microsoft.HybridCompute/locations/publishers/extensionTypes/versions";
}
export interface locations_publishers_extensionTypes_versionsComponentOutputs {
	readonly apiVersion: "2022-08-11-preview";
	readonly id: string;
	readonly type: "Microsoft.HybridCompute/locations/publishers/extensionTypes/versions";
}
export interface locations_publishers_extensionTypes_versionsComponentInputs {
	readonly name: string;
	readonly properties?: ExtensionValueProperties | undefined;
...
export class machines extends ArmResource<machinesComponentInputs> implements machinesComponentOutputs {
	constructor(entity: ADKEntity, options: machinesComponentInputs) {
		super(entity, options.name, "Microsoft.HybridCompute/machines", "2022-08-11-preview", options);
	}
	public readonly apiVersion: "2022-08-11-preview";
	public readonly id: string;
...
export interface machinesComponentInputs {
	...
	readonly resources?: MachineExtension[] | undefined;
	readonly systemData?: SystemData | undefined;
	...
	implements machines_extensionsComponentOutputs
{
	constructor(entity: ADKEntity, options: machines_extensionsComponentInputs) {
		super(entity, options.name, "Microsoft.HybridCompute/machines/extensions", "2022-08-11-preview", options);
	}
	public readonly apiVersion: "2022-08-11-preview";
	public readonly id: string;
	...
	implements privateLinkScopesComponentOutputs
{
	constructor(entity: ADKEntity, options: privateLinkScopesComponentInputs) {
		super(entity, options.name, "Microsoft.HybridCompute/privateLinkScopes", "2022-08-11-preview", options);
	}
	public readonly apiVersion: "2022-08-11-preview";
	public readonly id: string;
...
export interface AgentConfiguration {
	readonly configMode?: ("full" | "monitor") | undefined;
	readonly extensionsAllowList?: ConfigurationExtension[] | undefined;
	readonly extensionsBlockList?: ConfigurationExtension[] | undefined;
	readonly extensionsEnabled?: string | undefined;
	readonly guestConfigurationEnabled?: string | undefined;
...
export interface MachineExtensionProperties {
	...
	readonly protectedSettings?: MachineExtensionPropertiesProtectedSettings | undefined;
	readonly provisioningState?: string | undefined;
	readonly publisher?: string | undefined;
	readonly settings?: MachineExtensionPropertiesSettings | undefined;
	readonly type?: string | undefined;
	readonly typeHandlerVersion?: string | undefined;
}
...
export interface MachineProperties {
	...
	readonly provisioningState?: string | undefined;
	readonly serviceStatuses?: ServiceStatuses | undefined;
...
export interface PatchSettings {
	...
	readonly patchMode?: ("AutomaticByOS" | "AutomaticByPlatform" | "ImageDefault" | "Manual") | undefined;
}
...
export interface ServiceStatus {
	readonly startupType?: string | undefined;
	readonly status?: string | undefined;
}
export interface ServiceStatuses {
	readonly extensionService?: ServiceStatus | undefined;
	readonly guestConfigurationService?: ServiceStatus | undefined;
}
...
export default {
	"locations/publishers/extensionTypes/versions": locations_publishers_extensionTypes_versions,
	machines: machines,
